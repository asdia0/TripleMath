...
\begin{document}
    ...
    \solution
        \part
            ...
            \subpart
                 ...
                 Since $a_3 = 2 = a\left(-\dfrac13\right)^2$, we have $a = 18$. Let the $n$th term of $H$ be $b_n = \abs{a_n} = \abs{18 \left(-\dfrac13\right)^{n-1}} = 18 \left(\dfrac13\right)^{n-1}$. Hence, the sum to infinity of $H$ is given by
                \begin{equation*}
    ...
    \solution
        ...
        \part
            ...
            \boxt{$\der{y}{x} \in \left(\dfrac1{5\sqrt{3}}, \infty\right)$}
    ...
    \solution
        ...
        \part
            ...
            \begin{alignat*}{2}
                ...
                \implies&&\Big[\oa{OF} - \cveciii{-15}{17}5\Big] \cdot \cveciii111 &= \l\cveciii111 \cdot \cveciii111\\
    ...
    \solution
        ...
        \part
            \begin{align*}
                \der{\t}{x} &= \dfrac1{1+\left(\frac{x}8\right)^2}\cdot\dfrac18 + \dfrac1{1+\left(\frac{20-x}{13}\right)^2} \cdot \left(-\dfrac1{13}\right)\\
        ...
        \part
            ...
            \begin{align*}
                \left.\der{\t}{t}\right|_{x=10} &= \left.\der{\t}{x} \cdot \der{x}{t}\right|_{x=10}\\
