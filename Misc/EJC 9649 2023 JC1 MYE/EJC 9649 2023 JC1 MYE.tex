...
\begin{document}
    ...
    \solution
        \part
            \begin{alignat*}{2}
                ...
                \implies&&r^2 \left(\cos^2\t + (\sin\t - \cos\t)^2\right) &= 9\\
                \implies&&r^2\left(2\cos^2\t - 2\cos\t\sin\t + \sin^2\t\right) &= 9\\
    ...
    \solution
        \part
            ...
            \boxt{$r$ is undefined for $\t \in \left(-\pi, -\dfrac23\pi\right] \cup \left[-\dfrac13\pi, 0\right] \cup \left[\dfrac13\pi, \dfrac23\pi\right] \cup \bc{\pi}$.}
    ...
    \solution
        ...
        \part
            ...
            \boxt{$x_n =  8 + \dfrac{15}{k-1}\left(k^{n-1} - 1\right)$}
