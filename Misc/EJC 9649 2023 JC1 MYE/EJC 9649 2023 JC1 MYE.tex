...
\begin{document}
    ...
    \solution
        ...
        \part
            \textbf{Base Case.} $n = 1 : f^1(x) = 2 - \dfrac1x = \dfrac{2x - 1}{x - 0}$. 
            
            \noindent \textbf{Inductive Hypothesis.} For some $k \in \mathbb{N}$, $f^k(x) = \dfrac{(k+1)x - k}{kx - (k-1)}$.
            ...
            \noindent Thus, $f^n(x) = \dfrac{(n+1)x - n}{nx - (n-1)}$ for all $n \in \mathbb{N}$.
    ...
    \solution
        ...
        \part
            ...
            \end{alignat*}
            \boxt{
                Alert Orange will be triggered in week 14.
            }
\end{document}