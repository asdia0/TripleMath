...
\begin{document}
    ...
    \solution
        \part
            ...
            \boxt{$r$ is undefined for $\t \in \bp{-\pi, -\dfrac23\pi\right] \cup \left[-\dfrac13\pi, 0\right] \cup \left[\dfrac13\pi, \dfrac23\pi\right] \cup \bc{\pi}$.}
    ...
    \solution
        ...
        \part
            Suppose $k > 1$. Then
            \begin{align*}
                \lim_{n \to \infty} x_n &= \lim_{n \to \infty} \left[8 + \dfrac{15}{k-1}\bp{k^{n-1} - 1}\right] \to \infty
            \end{align*}
            ...
            \medskip
             ...
             Suppose $0 < k < 1$. Then
            \begin{align*}
                \lim_{n \to \infty} x_n &= \lim_{n \to \infty} \left[8 + \dfrac{15}{k-1}\bp{k^{n-1} - 1}\right] = 8 - \dfrac{15}{k-1} = 8 + \dfrac{15}{1-k}
            \end{align*}
