...
\begin{document}
    \problem{}
        \begin{enumerate}
            \item Find, in terms of $n$, $\displaystyle\sum\limits_{r=2}^n \bp{\dfrac1{2^r} + \dfrac1{r^2 - 1}}$.
            \item Give a reason why the series $\displaystyle\sum\limits_{r=2}^\infty \bp{\dfrac1{2^r} + \dfrac1{r^2 - 1}}$ converges, and write down its value.
        \end{enumerate}

    \solution
        \part
            \begin{align*}
                \sum_{r=2}^n \bp{\dfrac1{2^r} + \dfrac1{r^2 - 1}} &= \sum_{r=2}^n \left[\bp{\dfrac12}^r + \dfrac12 \bp{\dfrac1{r-1} - \dfrac1{r+1}}\right]\\
                &= \dfrac14 \cdot \dfrac{1 - (1/2)^{n-1}}{1 - 1/2} + \dfrac12 \bp{\sum_{r=2}^n \dfrac1{r-1} - \sum_{r=2}^n \dfrac1{r+1}}\\
                &= \dfrac12 - \dfrac1{2^n} + \dfrac12\bp{\sum_{r=1}^{n-1} \dfrac1r - \sum_{r=3}^{n+1} \dfrac1r}\\
                &= \dfrac12 - \dfrac1{2^n} + \dfrac12\left[\bp{\dfrac11 + \dfrac12 + \sum_{r=3}^{n-1} \dfrac1r} - \bp{\sum_{r=3}^{n-1} \dfrac1r + \dfrac1n + \dfrac1{n+1}}\right]\\
                &= \dfrac12 - \dfrac1{2^n} + \dfrac12\bp{\dfrac11 + \dfrac12 - \dfrac1n - \dfrac1{n+1}}\\
                &= \dfrac54 - \dfrac1{2^n} - \dfrac1{2n} - \dfrac1{2n + 2}
            \end{align*}

            \boxt{$\displaystyle\sum\limits_{r=2}^n \bp{\dfrac1{2^r} + \dfrac1{r^2 - 1}} = \dfrac54 - \dfrac1{2^n} - \dfrac1{2n} - \dfrac1{2n + 2}$}

        \part
            \begin{align*}
                \sum_{r=2}^n \bp{\dfrac1{2^r} + \dfrac1{r^2 - 1}} &= \lim_{n \to \infty}\sum_{r=2}^n \bp{\dfrac1{2^r} + \dfrac1{r^2 - 1}}\\
                &= \lim_{n \to \infty} \bp{\dfrac54 - \dfrac1{2^n} - \dfrac1{2n} - \dfrac1{2n + 2}}\\
                &= \dfrac54
            \end{align*}

            \boxt{$\displaystyle\sum\limits_{r=2}^n \bp{\dfrac1{2^r} + \dfrac1{r^2 - 1}} = \dfrac54$}
    ...
    \solution
        ...
        \boxt{$y$ can take on values in $\R \setminus \bp{3a - 2a\sqrt2, 3a + 2a\sqrt2}$.}
    ...
    \solution
        \part
            \begin{align*}
                &(9 - x)^{5/2}\bp{1 + 3x^2}^{5/2}\\
                &= 9^{5/2}\bp{1 - \dfrac19 x}^{5/2}\bp{1 + 3x^2}^{5/2}\\
                &= 3^5 \left[1 + \dfrac{5/2}{1!} \bp{-\dfrac{x}9}^1 + \dfrac{5/2 \cdot 3/2}{2!} \bp{-\dfrac{x}9}^2 + \dfrac{5/2 \cdot 3.2 \cdot 1/2}{3!} \bp{-\dfrac{x}9}^3 + \ldots\right]\\
                &\hspace{2.25em}\left[1 + \dfrac{5/2}{1!}\bp{3x^2}^1 + \ldots\right]\\
                &= \bp{243 - \dfrac{135}2 x + \dfrac{45}8 x^2 - \dfrac5{48} x^3 + \ldots}\bp{1 + \dfrac{15}2 x^2 + \ldots}\\
                &= \bp{243 - \dfrac{135}2 x + \dfrac{45}8 x^2 - \dfrac5{48} x^3} + \bp{243\cdot\dfrac{15}2 x^2 - \dfrac{135}2 \cdot \dfrac{15}2 x^3} + \ldots\\
                &= 243 - \dfrac{135}2 x + \bp{\dfrac{45}8 + 243\cdot\dfrac{15}2} x^2 - \bp{\dfrac5{48} + \dfrac{135}2 \cdot \dfrac{15}2} x^3 + \ldots\\
                &= 243 - \dfrac{135}2 x + \dfrac{14625}{8} x^2 + \dfrac{24305}{48} x^3 + \ldots
            \end{align*}

            \boxt{$(9 - x)^{5/2}\bp{1 + 3x^2}^{5/2} = 243 - \dfrac{135}2 x + \dfrac{14625}{8} x^2 + \dfrac{24305}{48} x^3 + \ldots$}

        \part
            Note that the expansion of $\bp{1 - \dfrac19 x}^{5/2}$ is valid for $\abs{-\dfrac19 x} < 1 \implies x < 9$, while the expansion of $\bp{1 + 3x^2}^{5/2}$ is valid for $\abs{3x^2} < 1 \implies x^2 < \dfrac13 \implies -\dfrac1{\sqrt3} < x < \dfrac1{\sqrt3}$. Putting both inequalities together, we have $x \in \bp{-\dfrac1{\sqrt3}, \dfrac1{\sqrt3}}$.

            \boxt{The expression is valid for $x \in \bp{-\dfrac1{\sqrt3}, \dfrac1{\sqrt3}}$}
    ...
    \problem{}
        \begin{enumerate}
            \item Given that $u_1 = \dfrac72$ and $u_n = \dfrac12 u_{n-1} + n^2$ for $n \geq 2$, prove by mathematical induction that $u_n = 2n^2 - 4n + 6 - \bp{\dfrac12}^n$ for all positive integers $n$.
            \item \textbf{Omitted.}
        \end{enumerate}

    \solution
        \part
            Let $P_n$ be the statement that $u_n = 2n^2 - 4n + 6 - \bp{\dfrac12}^n$, where $n \in \N$.

             \textbf{Base Case.} $n = 1: u_1 = 2\cdot1^2 - 4\cdot1 + 6 - \bp{\dfrac12}^1 = \dfrac72$. Hence, $P_1$ is true.
            ...
            \begin{align*}
                ...
                &= \dfrac12 \left[2k^2 -4k + 6 - \bp{\dfrac12}^k\right] + (k+1)^2\\
                &= k^2 - 2k + 3 - \bp{\dfrac12}^{k+1} + (k+1)^2\\
                &= \Big[\bp{k^2 + 2k + 1} - 2k - 1\Big] -2k + 3 - \bp{\dfrac12}^{k+1} + (k+1)^2\\
                &= 2(k+1)^2 - 4k + 2 - \bp{\dfrac12}^{k+1}\\
                &= 2(k+1)^2 - \Big[(4k + 4) - 4\Big] + 2 - \bp{\dfrac12}^{k+1}\\
                &= 2(k+1)^2 - 4(k+1) + 6 - \bp{\dfrac12}^{k+1}
            \end{align*}
        ...
        \part
            ...
            \subpart
                ...
                \begin{alignat*}{2}
                    ...
                    && &= \bp{\dfrac7{10}}^{n-1} (u_1 - 500)\\
                    && &= 1500\bp{\dfrac7{10}}^{n-1}\\
                    \implies&&u_n &= 1500\bp{\dfrac7{10}}^{n-1} + 500
                \end{alignat*}

                \boxt{$u_n = 1500\bp{\dfrac7{10}}^{n-1} + 500$}

            \subpart

                 With the new information, we have the following revised recurrence relation for $u_n$:
                \[
                    u_n = \bp{1 - \dfrac{p}{100}} \cdot \dfrac{75}{100} \cdot u_{n-1} + 150
                \]
                We also have $\lim_{n \to \infty} u_n = 375$. Hence,
                \begin{alignat*}{2}
                    &&u_n &= \bp{1 - \dfrac{p}{100}} \cdot \dfrac{75}{100} \cdot u_{n-1} + 150\\
                    \implies&&\lim_{n \to \infty} u_n &= \lim_{n \to \infty} \left[\bp{1 - \dfrac{p}{100}} \cdot \dfrac{75}{100} \cdot u_{n-1} + 150\right]\\
                    \implies&&375 &= \bp{1 - \dfrac{p}{100}} \cdot \dfrac{75}{100} \cdot 375 + 150\\
