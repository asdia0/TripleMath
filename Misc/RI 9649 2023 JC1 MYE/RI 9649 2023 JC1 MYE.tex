...
\begin{document}
    ...
    \solution
        \part
            ...
            \boxt{
                $\displaystyle\sum\limits_{r=2}^n \left(\dfrac1{2^r} + \dfrac1{r^2 - 1}\right) = \dfrac54 - \dfrac1{2^n} - \dfrac1{2n} - \dfrac1{2n + 2}$
            }
        ...
        \part
            ...
            \boxt{
                $\displaystyle\sum\limits_{r=2}^n \left(\dfrac1{2^r} + \dfrac1{r^2 - 1}\right) = \dfrac54$
            }
    ...
    \solution
        ...
        \noindent \textbf{Axial Intercepts.} When $x = 0$, we have $y = 0$. Consider $y = 0$.
        \begin{alignat*}{2}
            &&\dfrac{x^2 + ax}{x-a} &= 0\\
            \implies&&x^2 + ax &= 0\\
            \implies&&x(x + a) &= 0
        \end{alignat*}
        Hence, $x = 0$ or $x = -a$. Thus, $C$ intercepts the axes at $\coord00$ and $\coord{-a}0$.
        ...
        \begin{center}
            \begin{tikzpicture}[trim axis left, trim axis right]
                \begin{axis}[
                    ...
                    \fill (-0.414, 0.172) circle[radius=2.5pt] node[anchor=south] {$\coord{a - a\sqrt2}{3a - 2a\sqrt2}$};
                    \fill (2.414, 5.83) circle[radius=2.5pt];

                    \node[anchor=north] at (2.614, 5.83) {$\coord{a + a\sqrt2}{3a + 2a\sqrt2}$};
        ...
        \boxt{
            $y$ can take on values in $\mathbb{R} \setminus \left(3a - 2a\sqrt2, 3a + 2a\sqrt2\right)$.
        }
    ...
    \problem{}
        ...
        \noindent Use differentiation to find the area of the largest rectangle that can be inscribed in the region $R$.

    \solution
        Observe that $4x^2 + y^2 = 1$ describes an ellipse centered at the origin with horizontal radius $\dfrac12$ and vertical radius 1.
        ...
        \boxt{
            The area of the largest rectangle is $\dfrac12$ units$^2$.
        }
    ...
    \solution
        \part
            ...
            \boxt{
                $(9 - x)^{5/2}\left(1 + 3x^2\right)^{5/2} = 243 - \dfrac{135}2 x + \dfrac{14625}{8} x^2 + \dfrac{24305}{48} x^3 + \ldots$
            }
        ...
        \part
            ...
            \boxt{
                The expression is valid for $x \in \left(-\dfrac1{\sqrt3}, \dfrac1{\sqrt3}\right)$
            }
    ...
    \solution
        \part
            Let $P_n$ be the statement that $u_n = 2n^2 - 4n + 6 - \left(\dfrac12\right)^n$, where $n \in \mathbb{N}$.

            \noindent \textbf{Base Case.} $n = 1: u_1 = 2\cdot1^2 - 4\cdot1 + 6 - \left(\dfrac12\right)^1 = \dfrac72$. Hence, $P_1$ is true.

            \noindent \textbf{Inductive Hypothesis.} Assume $P_k$ is true for some $k \in \mathbb{N}$.

            \noindent \textbf{Inductive Step.} Consider $u_{n+1}$.
            \begin{align*}
            ...
            \end{align*}
            Hence $P_k \implies P_{k+1}$. Since $P_1$ is true, by induction, $P_n$ is true for all $n \in \mathbb{N}$.
    ...
    \solution
        \part
            \subpart
                \boxt{
                    $u_n = \dfrac7{10} u_{n-1} + 150$, $u_1 = 2000$
                }

            \subpart
            
                \noindent Let $k$ be the constant such that $u_n + k = \dfrac7{10} (u_{n-1} + k)$. Then $-\dfrac3{10} k = 150 \implies k = -500$.
                \begin{alignat*}{2}
                ...
                \boxt{
                    $u_n = 1500\left(\dfrac7{10}\right)^{n-1} + 500$
                }

            \subpart

                \noindent With the new information, we have the following revised recurrence relation for $u_n$:
                \begin{equation*}
        ...
        \part
            ...
            \begin{alignat*}{2}
                ...
                && &= 6.8 \tosf{2}
            \end{alignat*}
            Since $n \in \mathbb{N}$, the least $n$ is $7$. Hence, Mr Sia will sell his prawns in August 2023.

            \boxt{
                Mr Sia will sell his prawns in August 2023.
            }
