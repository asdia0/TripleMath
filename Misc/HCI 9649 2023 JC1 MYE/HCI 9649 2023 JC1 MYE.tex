...
\begin{document}
    ...
    \solution
        ...
        \part
            When the gear has rotated $\pi$ radians, $P$ ends up at $\coord{-3a}0$. This is the reflection of $P'$ in the $y$-axis. Indeed, $P'$ also ends up at $\coord{-a}0$, which is the reflection of $P$ in the $y$-axis. Hence, the path taken by $P'$ is excatly the path taken by $P$ in the $y$-axis, but reflected in the $y$-axis. Hence, the total length travelled by $P$ and $P'$ are equal. Thus, the comment is incorrect.
