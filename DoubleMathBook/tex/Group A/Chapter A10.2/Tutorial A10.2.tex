...
\begin{solution}
    ...
    Let $A(x + \i y)$. Since $AB \perp AD$, we have $b - a = \i(d - a)$.
    \begin{gather*}
        b - a = \i(d - a) \implies (1 + 5\i) - (x + \i y) = i\bs{(5 + 3\i) - (x + \i y)}\\
        \implies (1 - x) + (5 - y)\i = (-3 + y) + (5 - x)\i \implies (x + y) + (y - x)\i = 4.
    \end{gather*}
    Comparing real and imaginary parts, we obtain $x = y = 2$. Hence, $A(2 + 2\i)$.

    Let $C(u + \i v)$. Since $CB \perp CD$, we have $d - c = \i(b - c)$.
    \begin{gather*}
        d - c = \i(b - c) \implies (5 + 3\i) - (u + \i v) = \i\bs{(1 + 5\i) - (u + \i v)}\\
        \implies (5 - u) + (3 - v)\i = (-5 + v) + (1 - u)\i \implies (u + v) + (v - u)\i = 10 + 2\i.
    \end{gather*}
    Comparing real and imaginary parts, we obtain $u = 4$ and $v = 6$. Hence, $C(4 + 6\i)$.
\end{solution}
