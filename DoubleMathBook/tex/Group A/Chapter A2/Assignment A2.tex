...
\end{problem}
\begin{solution}
    For stationary points, $y' = 0$. \[y' = 0 \implies 3x^2 + 2x = 0 \implies x(3x+2) = 0.\] Hence, $x = 0$ or $x = -\frac23$. When $x = 0$, $y = 0$. When $x = -\frac23$, $y = \frac4{27}$. Thus, the coordinates of the stationary points of $y = x^3 + x^2$ are $(0, 0)$ and $\bp{-\frac23, \frac4{27}}$.
    ...
    Therefore, $k \in \bp{0, \frac4{27}}$. The solution set of $k$ is thus $\bc{k \in \RR : 0 < k < \frac4{27}}$.

    \begin{ppart}
        Let $f(x) = x^2 + x^2 - 0.1$. Using linear interpolation on the interval $[0, 1]$, \[\a = \frac{0f(1) - 1f(0)}{f(1)-f(0)} = \frac1{20}.\]
    \end{ppart}
    \clearpage
    \begin{ppart}
        \begin{center}
