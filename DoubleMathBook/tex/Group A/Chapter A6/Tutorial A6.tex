...
\begin{solution}
    ...
    \end{ppart}
    \begin{ppart}
        For tangents at the pole, \[r = 0 \implies 1 + 2\cos2\t = 0 \implies \cos2\t = -\frac12.\] Note that $0 \leq 2\t \leq 2\pi$. Hence, $2\t = \frac23 \pi, \frac43\pi$, whence $\t = \frac13\pi, \frac23\pi$. For full lines, we also have $\t = \frac23 \pi$ and $\t = \frac53 \pi$.
    \end{ppart}
    \begin{ppart}
    ...
    \begin{ppart}
        ...
        \case{1}[$\t = \frac\pi6$] Substituting $\t = \frac\pi6$ into the equation of $C_1$, we obtain $r = \sqrt2 a$. Hence, $C_1$ and $C_2$ intersect at $\bp{\sqrt2a, \frac16 \pi}$ and, by symmetry, at $\bp{\sqrt2a, \frac76 \pi}$.

        \case[2]{$\t = \frac{4\pi}6$} Substituting $\t = \frac{4\pi}{6}$ into the equation of $C_1$, we obtain $r = 0$. Hence, $C_1$ and $C_2$ intersect at $(0, 0)$.
    \end{ppart}
    \begin{ppart}
