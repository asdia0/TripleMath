...
\begin{document}
    ...
    \solution
        ...
        \part
            ...
            \end{equation*}
             \textbf{Scalar Product.} Note that $\vec n = \cveciii11{-1} \times \cveciii{-1}30 = \cveciii314 \implies d = \cveciii201 \cdot \vec n = \cveciii201 \cdot \cveciii314 = 10$. Thus, the plane has scalar product form
            \begin{equation*}
        ...
        \part
            ...
            \end{equation*}
             \textbf{Scalar Product.} Note that $\vec n = \cveciii{-1}10 \times \cveciii13{-3} = \cveciii{-3}{-3}{-4} = -\cveciii334 \implies d = \cveciii700 \cdot \vec n = \cveciii700 \cdot -\cveciii334 = -21$. Thus, the plane has scalar product form $\vec r \cdot -\cveciii334 = -21$, which simplifies to
            \begin{equation*}
        ...
        \part
            ...
            \end{equation*}
             \textbf{Scalar Product.} Note that $\vec n = \cveciii212 \times \cveciii745 = \cveciii{-3}41 \implies d = \cveciii{-2}5{-3} \cdot \vec n = \cveciii{-2}5{-3} \cdot \cveciii{-3}41 = 23$. Thus, the plane has scalar product form
            \begin{equation*}
    ...
    \solution
        ...
        \part
            ...
            \begin{alignat*}{2}
                &&l &= p\\
                \implies&&\left[\cveciii124 + \l\cveciii3{-1}3\right] \cdot \cveciii3{-1}2 &= 17\\
                \implies&&\cveciii124 \cdot \cveciii3{-1}2 + \l\cveciii3{-1}3 \cdot \cveciii3{-1}2 &= 17\\
                \implies&&9 + 16\l &= 17\\
                \implies&&\l &= \dfrac12
            \end{alignat*}
        ...
        \part
            ...
            \begin{alignat*}{2}
                &&\sin\t &= \dfrac{\abs{\cveciii3{-1}3 \cdot \cveciii3{-1}2}}{\abs{\cveciii3{-1}3} \abs{\cveciii3{-1}2}}\\
                && &= \dfrac{16}{\sqrt{266}}\\
                \implies&&\t &= 1.38 \tosf{3}
            \end{alignat*}
        ...
        \part
            ...
            \begin{align*}
                \text{Perpendicular distance} &= \abs{\oa{AP} \cdot \hat{\vec n}}\\
        ...
        \part
            Let $F$ be the foot of the perpendicular from $B$ to $p$. Since $F$ is on $p$, we have $\oa{OF} \cdot \cveciii3{-1}2 = 17$. Furthermore, since $BF$ is perpendicular to $p$, we have $\oa{BF} = \l \vec n = \l \cveciii3{-1}2$ for some $\l \in \R$. We hence have $\oa{OF} = \oa{OB} + \oa{BF} = \cveciii{-2}31 + \l \cveciii3{-1}2$.

            \begin{alignat*}{2}
                &&\oa{OF} \cdot \cveciii3{-1}2 &= 17\\
                \implies&&\left[\cveciii{-2}31 + \l \cveciii3{-1}2\right] \cdot \cveciii3{-1}2 &= 17\\
                \implies&&\cveciii{-2}31 \cdot \cveciii3{-1}2 + \l\cveciii3{-1}2 \cdot \cveciii3{-1}2 &= 17\\
                \implies&&-7 + 14\l &= 17\\
        ...
        \part
            ...
            \begin{align*}
                m \cdot \vec n &= \left[\cveciii610 + \l \cveciii021\right] \cdot \cveciii3{-1}2\\
                &= \cveciii610 \cdot \cveciii3{-1}2 + \l\cveciii021 \cdot \cveciii3{-1}2\\
                &= 17 + 0\l\\
                &= 17
            \end{align*}

            Since $m \cdot \vec n = 17$ for all $\l \in \R$, $m$ lies in $p$.
    ...
    \solution
        ...
        \part
            ...
            \end{alignat*}
             ...
             $\vec a + \dfrac{d - \vec a \cdot \vec n}{\vec b \cdot \vec n} \, \vec b$ is the position vector of the point of intersection of the line and plane.
    ...
    \solution
        \part
            ...
            \begin{alignat*}{2}
                &&\cos\t &= \dfrac{\abs{\cveciii2{-2}1 \cdot \cveciii{-6}32}}{\abs{\cveciii2{-2}1} \abs{\cveciii{-6}32}}\\
                && &= \dfrac{16}{21}\\
                \implies&&\t &= 0.705 \tosf{3}
            \end{alignat*}
        ...
        \part
            ...
            \begin{alignat*}{2}
                &&\dfrac{\abs{\oa{AQ} \cdot \cveciii2{-2}1}}{\abs{\cveciii2{-2}1}} &= \dfrac{\abs{\oa{AQ} \cdot \cveciii{-6}32}}{\abs{\cveciii{-6}32}}\\
    ...
    \problem{}
        ...
        \end{enumerate}
         ...
         The plane $\Pi'$ has equation $\vec r \cdot (\vec i + \vec j + \vec k) = 5$.
    ...
    \solution
        ...
        \part
            Since $Q$ is on $\Pi$, $\oa{OQ} \cdot \cveciii230 = -6$. Furthermore, observe that $Q$ is also on the line $l$. Thus, $\oa{OQ} = \cveciii214 + \l\cveciii230$ for some $\l \in \R$.
            {\allowdisplaybreaks
            \begin{alignat*}{2}
                &&\oa{OQ} \cdot \cveciii230 &= -6\\
                \implies&&\left[\cveciii214 + \l\cveciii230\right] \cdot \cveciii230 &= -6\\
                \implies&&\cveciii214 \cdot \cveciii230 + \l\cveciii230 \cdot \cveciii230 &= -6\\
                \implies&&7 + 13\l &= -6\\
                \implies&&\l &= -1
            \end{alignat*}}
        ...
        \part
            ...
            \begin{align*}
                \sin\t &= \dfrac{\abs{\cveciii0{-2}4 \cdot \cveciii230}}{\abs{\cveciii0{-2}4} \abs{\cveciii230}}\\
                &= \dfrac{3}{\sqrt{65}}
            \end{align*}
    ...
    \solution
        \part
            ...
            Consider $\oa{AB} \cdot \cveciii{22}{33}{-12}$, $\oa{AD} \cdot \cveciii{22}{33}{-12}$ and $\oa{AM} \cdot \cveciii{22}{33}{-12}$.

            \begin{alignat*}{2}
                \oa{AB} \cdot \cveciii{22}{33}{-12} &= \cveciii300 \cdot \cveciii{22}{33}{-12} &= 66\\
                \oa{AD} \cdot \cveciii{22}{33}{-12} &= \cveciii020 \cdot \cveciii{22}{33}{-12} &= 66\\
                \oa{AM} \cdot \cveciii{22}{33}{-12} &= \dfrac14\cveciii{12}4{11} \cdot \cveciii{22}{33}{-12} &= 66
            \end{alignat*}
            
            Since $\oa{AB}$, $\oa{AD}$ and $\oa{AM}$ satisfy the equation $\vec r \cdot \cveciii{22}{33}{-12} = 66$, they all lie on the plane with said equation.

        \part
            \begin{align*}
                \text{Perpendicular distance} &= \abs{\oa{AB} \cdot \hat{\vec n}}\\
        ...
        \part
            ...
            \begin{align*}
                \text{Perpendicular distance} &= \dfrac{\abs{\oa{EC} \times \cveciii{12}43}}{\abs{\cveciii{12}43}}\\
    ...
    \solution
        ...
        \part
            ...
            \boxt{$\vec r \cdot \cveciii112 = 15$}

        \part
            Since $\cveciii044 \cdot \cveciii11{-1} = 0$ and $\cveciii044 \cdot \cveciii2{-4}1 = -12$, $(0, 4, 4)$ satisfies the vector equation of both $\pi_1$ and $\pi_2$ and thus lies on both planes.
        ...
        \part
            ...
            \begin{alignat*}{2}
                &&l_{OP} &= \pi_2\\
                \implies&&\m\cveciii382 \cdot \cveciii2{-4}1 &= -12\\
                \implies&&-24\m &= -12\\
                \implies&&\m &= \dfrac12
            \end{alignat*}
        ...
        \part
            \begin{align*}
                \text{Length of projection} &= \dfrac{\oa{OP} \times \cveciii11{-1}}{\abs{\cveciii11{-1}}}\\
    ...
    \problem{}
        ...
        \begin{enumerate}
            ...
            \item Find the equation of $\Pi$ in the forms $\vec r = \vec a + \l \vec b + \m \vec c$, $\l, \m \in \R$ and $\vec r \cdot \vec n = D$.
    ...
    \solution
        ...
        \part
            ...
            \boxt{$\Pi: \vec r \cdot \cveciii81{-14} = 75$}
        ...
        \part
            ...
            \begin{alignat*}{2}
                &&\sin\t &= \dfrac{\abs{\cveciii1{-1}{-4} \cdot \cveciii81{-14}}}{\abs{\cveciii1{-1}{-4}} \abs{\cveciii81{-14}}}\\
                && &= \dfrac{7}{\sqrt{58}}\\
                \implies&&\t &= 1.17 \tosf{3}
            \end{alignat*}
        ...
        \part
            ...
            \begin{align*}
                \oa{PQ} &= \oa{OQ} - \oa{OP}\\
                &= \left[\cveciii235 + \m\cveciii1{-1}4\right] - \left[\cveciii3{-5}{-4} + \l\cveciii342\right]\\
    ...
    \solution
        ...
        \part
            ...
            \begin{equation*}
                ...
                \end{cases}
            \end{equation*}
            which the unique solution $\l = -22$ and $\m = 17$.
    ...
    \problem{}
        ...
        A point light source for this shadow display is placed at the point $P(20, -4, 0)$ and a screen of height 35 units is placed with its base on the ground such that the screen lies on a plane with vector equation $\vec r \cdot \cveciii100 = \a$, where $\a < -4$.
    ...
    \solution
        ...
        \part
            ...
            \begin{alignat*}{2}
                &&\left[\cveciii{20}{-4}0 + \l\cveciii{-10}2h\right] \cdot \cveciii100 &= \a\\
                \implies&&\cveciii{20}{-4}0 \cdot \cveciii100 + \l\cveciii{-10}2h \cdot \cveciii100 &= \a\\
                \implies&&20-10\l &= \a\\
        ...
        \part
            Note that $\oa{BV} = 4\cveciii{-1}15$ and $\oa{BC} = 8\cveciii010$. Hence, the plane $VBC$ is parallel to $\cveciii{-1}15$ and $\cveciii010$. Note that $\cveciii{-1}15 \times \cveciii010 = -\cveciii501$. Thus, $\vec n = \cveciii501$, whence $d = \cveciii00{20} \cdot \vec n = \cveciii00{20} \cdot \cveciii501 = 20$. Thus, the plane $VBC$ has vector equation
            
            \boxt{$\vec r \cdot \cveciii501 = 20$}
            ...
            \begin{alignat*}{2}
                &&\cos\t &= \dfrac{\cveciii501 \cdot \cveciii001}{\abs{\cveciii501}\abs{\cveciii001}}\\
                && &= \dfrac1{\sqrt{26}}\\
                \implies&&\t &= 1.37 \tosf{3}
            \end{alignat*}
