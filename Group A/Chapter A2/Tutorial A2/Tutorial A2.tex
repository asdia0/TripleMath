...
\begin{document}
    ...
    \solution
        ...
        \part
            Let $g_2(x) = \dfrac{15}{x^2 + 3}$. Then $g'_2(x) = \dfrac{-30x}{\left(x^2 + 3\right)^2}$. For values of $x$ near 2, $\abs{g'_2(x)} > 1$. Hence, the iterative formula $x_{n+1} = g_2(x_n)$ will diverge. Thus, $g_2(x)$ is unsuitable.
