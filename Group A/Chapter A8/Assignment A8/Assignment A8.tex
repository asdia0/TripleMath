...
\begin{document}
    ...
    \solution
        ...
        \boxt{$\oa{OF} = \vec a + \dfrac{(\vec c - \vec a) \dotp \vec b}{\abs{\vec b}^2} \, \vec b$}
    ...
    \solution
        ...
        \part
            ...
            \begin{alignat*}{2}
                ...
                && &= \dfrac13 \bs{2\cveciii030 + \cveciii600}\\
                && &= \cveciii220\\
        ...
        \part
            Since $CP$ is perpendicular to $BQ$, we have $\oa{CP} \dotp \oa{BQ} = 0$.
            \begin{alignat*}{2}
                &&\oa{CP} \dotp \oa{BQ} &= 0\\
                \implies&&2\cveciii11{-2} \dotp \cveciii{q}{-3}0 &= 0\\
                \implies&&q - 3 + 0 &= 0\\
                \implies&&q &= 3
            \end{alignat*}
        ...
        \part
            ...
            {\allowdisplaybreaks
            \begin{alignat*}{2}
                &&\abs{\cveciii11{-2} \crossp \cveciii{q}{-3}0} &= \abs{\cveciii11{-2}} \abs{\cveciii{q}{-3}0} \sin \t\\
    ...
    \solution
        ...
        \part
            ...
            \[
                \systeme[\l\m]{2\l+2\m=2,{-4\l}+{\m}=0,{\l}+{\m}=1}
            \]
        ...
        \part
            ...
            \begin{alignat*}{2}
                &&\cos\t &= \dfrac{\abs{\cveciii{-2}4{-1} \dotp \cveciii211}}{\abs{\cveciii{-2}4{-1}} \abs{\cveciii211}}\\
        ...
        \part
            ...
            \begin{alignat*}{2}
                &&\oa{AN} \dotp \cveciii211 &= 0\\
                \implies&&\bp{\oa{ON} - \oa{OA}} \dotp \cvecii211 &= 0\\
                \implies&&\bs{\cveciii10{-3} + \m\cveciii211 - \cveciii30{-2}} \dotp \cveciii211 &= 0\\
                \implies&&\cveciii{-2+2\m}{\m}{-1+\m} \dotp \cveciii211 &= 0\\
