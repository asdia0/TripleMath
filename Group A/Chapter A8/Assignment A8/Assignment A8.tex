...
\begin{document}
    ...
    \solution
        ...
        \boxt{
            $\overrightarrow{OF} = \vec a + \left((\vec c - \vec a) \cdot \hat{\vec b}\right) \hat{\vec b}$
        }
    ...
    \solution
        ...
        \part
            ...
            \begin{equation*}
                ...
                \end{cases}
            \end{equation*}
            \noindent which has the unique solution $\mu = \dfrac45$ and $\lambda = -\dfrac15$. Thus, the intersection point $P$ has position vector $\cveciii30{-2} - \dfrac15\cveciii{-2}4{-1} = \dfrac15\cveciii{17}{-4}{-4}$ and thus has coordinates $\coordiii{\dfrac{17}5}{-\dfrac45}{-\dfrac95}$.

            \boxt{
                $\coordiii{\dfrac{17}5}{-\dfrac45}{-\dfrac95}$
            }

        \part
            Let $\theta$ be the acute angle between $l_1$ and $l_2$.
            \begin{alignat*}{2}
                &&\cos\theta &= \dfrac{\abs{\cveciii{-2}41 \cdot \cveciii211}}{\abs{\cveciii{-2}41} \abs{\cveciii211}}\\
