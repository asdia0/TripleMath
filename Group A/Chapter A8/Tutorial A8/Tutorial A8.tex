...
\begin{document}
    ...
    \solution
        ...
        \part
            ...
            \begin{alignat*}{2}
                &&\cos\t &= \dfrac{\abs{\cveciii4{-2}{-3} \cdot \cveciii381}}{\abs{\cveciii4{-2}{-3}} \abs{\cveciii381}}\\
                && &= \dfrac{7}{\sqrt{2146}}\\
                \implies&&\t &= 1.42 \tosf{3}
            \end{alignat*}

            \boxt{Skew lines. $\t = 1.42$.}
        ...
        \part
            ...
            Let $\t$ be the acute angle between $l_1$ and $l_2$.
            \begin{alignat*}{2}
                &&\cos\t &= \dfrac{\abs{\cveciii1{-1}1 \cdot \cveciii5{-4}{-1}}}{\abs{\cveciii1{-1}1} \abs{\cveciii5{-4}{-1}}}\\
                && &= \dfrac8{3\sqrt{14}}\\
                \implies&&\t &= 0.777 \tosf{3}
            \end{alignat*}

            \boxt{Intersecting lines. $\cveciii6{-5}0$. $\t = 0.777$.}
    ...
    \solution
        \part
            ...
            \begin{align*}
                \text{Shortest distance} &= \abs{\cveciii{-2}0{-1} \times \cveciii122} \Bigg/ \abs{\cveciii122}\\
        ...
        \part
            ...
            \begin{align*}
                \text{Length of projection} &= \abs{\cveciii4{-5}6 \cdot \cveciii86{-1}} \Bigg/ \abs{\cveciii86{-1}}\\
                &= \dfrac{4}{\sqrt{101}}
            \end{align*}
        ...
        \part
            \begin{align*}
                \text{Projection} &= \bs{\cveciii4{-5}6 \cdot \cveciii86{-1} \Bigg/ \abs{\cveciii86{-1}}} \cdot \bs{\cveciii86{-1} \Bigg/ \abs{\cveciii86{-1}}}\\
    ...
    \solution
        ...
        \part
            ...
            \begin{alignat*}{2}
                &&\oa{PF} \cdot \cveciii2{-1}0 &= 0\\
                \implies&&\bp{\oa{OF} - \oa{OP}} \cdot \cveciii2{-1}0 &= 0\\
                \implies&&\bs{\cveciii{-3}31 + \m\cveciii2{-1}0 - \cveciii0{-1}{-1}} \cdot \cveciii2{-1}0 &= 0\\
                \implies&&\bs{\cveciii{-3}42 + \m\cveciii2{-1}0} \cdot \cveciii2{-1}0 &= 0\\
                \implies&&\cveciii{-3}42 \cdot \cveciii2{-1}0 + \m\cveciii2{-1}0 \cdot \cveciii2{-1}0 &= 0\\
                \implies&&-10 + 5m &= 0\\
                \implies&&m &= 2
            \end{alignat*}
        ...
        \part
            ...
            {\allowdisplaybreaks
            \begin{align*}
                \text{Length of projection} &= \abs{\cveciii312 \cdot \cveciii2{-1}0} \Bigg/ \abs{\cveciii2{-1}0}\\
    ...
    \solution
        ...
        \part
            ...
            \begin{align*}
                \text{Length of projection} &= \abs{\oa{AC} \cdot \oa{AB}} \Big/ \abs{\oa{AB}}\\
    ...
    \solution
        ...
        \part
            ...
            Let $F$ be the foot of the perpendicular from $A$ to $l$. We have that $\oa{OF} = \cveciii{-3}15 + \l\cveciii{-1}43$ for some real $\l$. We also have that $\oa{AF} \cdot \cveciii{-1}43 = 0$.
            \begin{alignat*}{2}
                &&\oa{AF} \cdot \cveciii{-1}43 &= 0\\
                \implies&&\bp{\oa{OF} - \oa{OA}} \cdot \cveciii{-1}43 &= 0\\
                \implies&&\bs{\cveciii{-3}15 + \l\cveciii{-1}43 - \cveciii094} \cdot \cveciii{-1}43 &= 0\\
                \implies&&\bs{\cveciii{-3}{-8}1 + \l\cveciii{-1}43} \cdot \cveciii{-1}43 &= 0\\
                \implies&&\cveciii{-3}{-8}1 \cdot \cveciii{-1}43 + \l\cveciii{-1}43 \cdot \cveciii{-1}43 &= 0\\
                \implies&&-26 + 26\l&= 0\\
                \implies&&\l &= 1
            \end{alignat*}
        ...
        \part
            ...
            \begin{align*}
                \text{Shortest distance between $AB$ and $l$} &= \abs{\cveciii{-1}43 \times \bp{\cveciii15{-2} - \cveciii{-3}15}} \Bigg/ \abs{\cveciii{-1}43}\\
    ...
    \solution
        \part
            ...
            \begin{alignat*}{2}
                &&\cos\t &= \dfrac{\abs{\cveciii2{-1}5 \cdot \cveciii468}}{\abs{\cveciii2{-1}5} \abs{\cveciii468}}\\
                && &= \dfrac{42}{\sqrt{30} \sqrt{116}}\\
                \implies&&\t &= \arccos \dfrac{42}{\sqrt{30} \sqrt{116}}\\
                && &= 44.6^{\circ} \todp{1}
            \end{alignat*}

            \boxt{$\t = 44.6^{\circ} \todp{1}$}
        
        \part
            Since $Q$ is on $L$, we have that $\oa{OQ} = \cveciii137 + t\cveciii2{-1}5$ for some real $t$. Further, since $\oa{CQ} \perp L$, we have that $\oa{CQ} \cdot \cveciii2{-1}5 = 0$.
            \begin{alignat*}{2}
                &&\oa{CQ} \cdot \cveciii2{-1}5 &= 0\\
                \implies&&\bp{\oa{OQ} - \oa{OC}} \cdot \cveciii2{-1}5 &= 0\\
                \implies&&\bs{\cveciii137 + t\cveciii2{-1}5 - \cveciii251} \cdot \cveciii2{-1}5 &= 0\\
                \implies&&\bs{\cveciii{-1}{-2}6 + t\cveciii2{-1}5} \cdot \cveciii2{-1}5 &= 0\\
    ...
    \solution
        ...
        \part
            Note that $\oa{OB} = \cveciii2{-2}6$, whence $\oa{VB} = \oa{OB} - \oa{OV} = \cveciii2{-2}{-2h}$. Since $OX$ is perpendicular to $VB$, we have that $\oa{OX} \cdot \oa{VB} = 0$.
            \begin{alignat*}{2}
                &&\oa{OX} \cdot \oa{VB} &= 0\\
