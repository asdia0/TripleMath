...
\begin{document}
    ...
    \solution
        ...
        \part
            ...
            \begin{alignat*}{2}
                &&\oa{BC} &= \l \oa{CD}\\
                \implies&&\cvecii11 &= \l\left(\oa{OD} - \oa{OC}\right)\\
                && &= \l\left(\cvecii3d - \cvecii24\right)\\
                && &= \cvecii{\l}{\l(d-4)}
            \end{alignat*}
    ...
    \solution
        \part
            ...
            \begin{alignat*}{2}
                ...
                \implies&&\t &= \arccos \left(\dfrac{8}{\sqrt 3 \cdot \sqrt{62}}\right)\\
                && &= 54.1^\circ \todp{1}
            \end{alignat*}
        ...
        \part
            ...
            \begin{alignat*}{2}
                ...
                \implies&&\t &= \arccos \left(\dfrac{-8}{\sqrt{13} \cdot \sqrt{54}}\right)\\
                && &= 107.6^\circ \todp{1}
            \end{alignat*}
    ...
    \solution
        ...
        \part
            ...
            \begin{align*}
                ...
                &= k \left(\cveciii{11}{\l}{14} - \cveciii5{-1}2\right)\\
                &= k \cveciii6{\l + 1}{12}
            \end{align*}
    ...
    \solution
        Let $ABCD$ be a square with side length $2k$ with $A$ at the origin. Then $\vec p = \oa{AM} = k\cvecii2{-1}$ and $\vec q = \oa{AN} = k\cvecii1{-2}$. Hence, $\vec p + \vec q = k\cvecii3{-3}$. Thus, $\oa{AC} = k\cvecii2{-2} = \dfrac23 \cdot k\cvecii3{-3} = \dfrac23 \left(\vec p + \vec q\right)$.

        \boxt{$\oa{AC} = \dfrac23\left(\vec p + \vec q\right)$.}
    ...
    \solution
        ...
        \part
            ...
            Thus, $\l = \dfrac65$ and $\m = -\dfrac35$. Hence, $\matr A\oa{OE} = \cvecii{\frac25}{0}$, giving
    ...
    \solution
        ...
        \part
            ...
            \begin{align*}
                \oa{AB} \cdot \oa{OP} &= \left(\cveciii{11}{-13}2 -  \cveciii{14}{14}{14}\right) \cdot \cveciii{12}{-4}6\\
    ...
    \solution
        ...
        \part
            ...
            \begin{alignat*}{2}
                ...
                \implies&&\cveciii200 \cdot \left(\cveciii200 - \cveciii001\right) &= 2 \cdot \abs{\cveciii200 - \cveciii001} \cdot \cos\t\\
                ...
                \implies&&\t &= \arccos \left(\dfrac{2}{\sqrt5}\right)\\
                && &= 26.6^\circ \todp{1}
            \end{alignat*}
    ...
    \solution
        ...
        \part
            ...
            \begin{alignat*}{2}
                &&\oa{OP} \cdot \oa{AB} &= 0\\
                \implies&&\cveciii{1+\l}{2-5\l}{-2+8\l} \cdot \left(\cveciii2{-3}6 - \cveciii12{-2}\right) &= 0\\
        ...
        \part
            \begin{alignat*}{2}
                ...
                \implies&&\abs{\oa{OB}} \left(\oa{OP} \cdot \oa{OA}\right) &= \abs{\oa{OA}} \left( \oa{OP} \cdot \oa{OB}\right)\\
                \implies&&\oa{OP} \cdot \left(\abs{\oa{OB}} \, \oa{OA}\right) &= \oa{OP} \cdot \left( \abs{\oa{OA}} \, \oa{OB}\right)\\
                \implies&&\oa{OP} \cdot \left(\abs{\oa{OB}} \, \oa{OA}\right) - \oa{OP} \cdot \left( \abs{\oa{OA}} \, \oa{OB}\right) &= 0\\
                \implies&&\oa{OP} \cdot \left(\abs{\oa{OB}} \, \oa{OA} -  \abs{\oa{OA}} \, \oa{OB}\right) &= 0\\
                \implies&&\oa{OP} \cdot \left(\sqrt{2^2 + (-3)^2 + 6^2} \, \oa{OA} -  \sqrt{1^2 + 2^2 + (-2)^2} \, \oa{OB}\right) &= 0\\
                \implies&&\oa{OP} \cdot \left(7 \oa{OA} -  3 \oa{OB}\right) &= 0\\
                \implies&&\cveciii{1+\l}{2-5\l}{-2+8\l} \cdot \left(7 \cveciii12{-2} -  3 \cveciii2{-3}6\right) &= 0\\
    ...
    \solution
        ...
        \part
            ...
            \begin{alignat*}{2}
                ...
                \implies&&\dfrac47 \abs{\vec a \times \left(\l \vec a + \m \vec b\right)} &= \dfrac12 \abs{\vec b \times \left(\l \vec a + \m \vec b\right)}\\
                ...
                \implies&&\left(\dfrac47 \m - \dfrac12 \l\right) \abs{\vec a \times \vec b} &= 0\\
