...
\begin{document}
    ...
    \solution
        ...
        \part
            ...
            Thus,
            \boxt{$u_n = \left(\dfrac{\sqrt2 - 1}{2\sqrt2}a + \dfrac{1}{\sqrt{2}}b\right)\left(\dfrac{1 + \sqrt2}{2}\right)^n + \left(\dfrac{\sqrt2 + 1}{2\sqrt2}a - \dfrac{1}{\sqrt{2}}b\right)\left(\dfrac{1 - \sqrt2}{2}\right)^n$}
