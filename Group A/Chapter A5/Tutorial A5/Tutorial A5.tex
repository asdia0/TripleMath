...
\begin{document}
    ...
    \solution
        ...
        \part
            ...
            \boxt{There will be \$$\left(\dfrac{500000}9 \left(\left(\dfrac32\right)^n - \left(-\dfrac3{10}\right)^n\right)\right)$ in the account after $n$ years.}
    ...
    \solution
        ...
        \part
            ...
            \boxt{After $n$ months, there will be $\left(\dfrac1{\sqrt5} \left(\dfrac{1 + \sqrt5}{2}\right)^n - \dfrac1{\sqrt5} \left(\dfrac{1 - \sqrt5}{2}\right)^n \right)$ pairs of rabbits.}
    ...
    \solution
        ...
        \part
            ...
            \boxt{$a_n = \dfrac16 \left(2^n + 2 \cdot 5^n \right)$}
    ...
    \solution
        ...
        Thus,
        \boxt{$X_n = \exp{2^n \left(A \cos \left(\dfrac{\pi}3 n\right) + B \sin \left(\dfrac{\pi}3 n\right)\right)}$}
    ...
    \solution
        ...
        \boxt{$X_n = (n+1)\left(3^n - 2^n\right)$}
    ...
    \solution
        ...
        \part
            ...
            \boxt{$T_n = 0.9^{n-1} \left(250 - 10k\right) + 10k$}
