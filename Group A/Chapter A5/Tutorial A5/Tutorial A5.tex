...
\begin{document}
    ...
    \solution
        ...
        \part
            ...
            \begin{alignat*}{2}
                &&u_n + \dfrac72 &= 3\bp{u_{n-1} + \dfrac72}\\
                \implies&&u_n + \dfrac72 &= 3^n \bp{u_0 + \dfrac72}\\
                \implies&&u_n &= 3^n\bp{5 + \dfrac72} - \dfrac72\\
                && &= \dfrac{17}2 \cdot3^n  - \dfrac72
            \end{alignat*}

            \boxt{$u_n = \dfrac{17}2 \cdot3^n  - \dfrac72$}
    ...
    \solution
        \part
            ...
            \boxt{$u_n = 3 \cdot 2^n + 2 \cdot 3 ^n$}
        ...
        \part
            Consider the characteristic equation of $u_n$, $x^2 - 2x + 2 = 0$. Solving the characteristic equation using the quadratic formula,
            \begin{align*}
                x &= \dfrac{-(-2) \pm \sqrt{(-2)^2 - 4\cdot1\cdot2}}{2\cdot1}\\
                &= \dfrac{2 \pm \sqrt{-4}}{2}\\
                &= \dfrac{2 \pm 4i}{2}\\
                &= 1 \pm 2i\\
                &= \sqrt{2} \exp{\pm i \dfrac{\pi}4}
            \end{align*}

            Hence,
            \[
                u_n = A \cdot \sqrt{2}^n \cos{\dfrac{\pi}4 n } + B \cdot \sqrt{2}^n \sin{\dfrac{\pi}4 n}
            \]

            Since $u_0 = 2$,            
            \begin{alignat*}{2}
                && A \cdot \sqrt{2}^0 \cos{\dfrac{\pi}4 \cdot 0 } + B \cdot \sqrt{2}^0 \sin{\dfrac{\pi}4 \cdot 0} &= 2\\
            ...
            Since $u_1 = 6$,
            \begin{alignat*}{2}
                && A \cdot \sqrt{2}^1 \cos{\dfrac{\pi}4 \cdot 1 } + B \cdot \sqrt{2}^1 \sin{\dfrac{\pi}4 \cdot 1} &= 6\\
            ...
            Since $A = 2$ and $B = 4$,
            \begin{align*}
                u_n &= 2 \cdot \sqrt{2}^n \cos{\dfrac{\pi}4 n } + 4 \cdot \sqrt{2}^n \sin{\dfrac{\pi}4 n}\\
                &= \sqrt{2}^{n+2} \cos{\dfrac{\pi}4 n } + \sqrt{2}^{n+4} \sin{\dfrac{\pi}4 n}
            \end{align*}
    ...
    \solution
        ...
        \part
            \begin{align*}
                \lim_{n \to \infty} x_n &= \lim_{n \to \infty} \bp{0.9^n (x_0 - 900) + 900} \\
                &=  \lim_{n \to \infty} (0 (x_0 - 900) + 900) \\
                &= 900
            \end{align*}

            \boxt{When $n$ becomes very large, the amount of water in the tank converges to 900 litres.}
    ...
    \solution
        \part
            ...
            \boxt{$P_{n+2} = 1.2 P_{n+1} + 0.45 P_n$}
        ...
        \part
            ...
            \[
                P_n = A  \bp{-\dfrac3{10}}^n + B \bp{\dfrac32}^n
            \]
            Since $P_0 = 0$,
            \[
                A \bp{-\dfrac3{10}}^0 + B \bp{\dfrac32}^0 = 0 \implies A + B = 0
            \]
            Since $P_1 = 100000$,
            \[
                A \bp{-\dfrac3{10}}^1 + B \bp{\dfrac32}^1 = 100000 \implies -3A + 15B = 1000000
            \]
            Solving both equations simultaneously, we have $A = -\dfrac{500000}9$ and $B = \dfrac{500000}9$. Thus,
            \[
                P_n = \dfrac{500000}9 \bp{\bp{\dfrac32}^n - \bp{-\dfrac3{10}}^n}
            \]

            \boxt{There will be \$$\bp{\dfrac{500000}9 \bp{\bp{\dfrac32}^n - \bp{-\dfrac3{10}}^n}}$ in the account after $n$ years.}
    ...
    \solution
        \part
            \boxt{$f_{n+2} = f_{n+1} + f_n$, $n \geq 2$, $f_1 = 1, f_2 = 1$}
        ...
        \part
            ...
            \[
                f_n = A \bp{\dfrac{1 + \sqrt5}{2}}^n + B \bp{\dfrac{1 - \sqrt5}{2}}^n
            \]
            ...
            \boxt{After $n$ months, there will be $\bp{\dfrac1{\sqrt5} \bp{\dfrac{1 + \sqrt5}{2}}^n - \dfrac1{\sqrt5} \bp{\dfrac{1 - \sqrt5}{2}}^n }$ pairs of rabbits.}
    ...
    \solution
        ...
        \begin{alignat*}{2}
            &&t_i + \dfrac{17}2 &= 3\bp{t_{i-1} + \dfrac{17}2}\\
            \implies&&t_i + \dfrac{17}2 &= 3^i \bp{t_0 + \dfrac{17}2}\\
            && &= 3^i \bp{4 + \dfrac{17}2}\\
            && &= 3^i \cdot \dfrac{25}2\\
        ...
        \boxt{$T_n = \dfrac{25}2 \cdot 3^{\log_2{n}} - \dfrac{17}2$}       
    ...
    \solution
        \part
            \begin{alignat*}{2}
                &&a_{n+1} &= 2a_n + 5^n\\
                \implies&&k\bp{5^{n+1}} &= 2\cdot k\bp{5^n} + 5^n\\
        ...
        \part
            \begin{align*}
                ...
                &= 2\bp{a_{n-1} - \dfrac13 \cdot 5^{n-1}} + \dfrac23 \cdot 5^{n-1} + 5^{n-1} - \dfrac13 \cdot 5^n\\
            ...
            \begin{alignat*}{2}
                ...
                && &= \dfrac13 \bp{\dfrac12 2^n + 5^n }\\
                && &= \dfrac16 \bp{2^n + 2 \cdot 5^n }
            \end{alignat*}

            \boxt{$a_n = \dfrac16 \bp{2^n + 2 \cdot 5^n }$}
    ...
    \solution
        ...
        \end{align*}
        Thus,
        \boxt{$X_n = \exp{2^n \bp{A \cos{\dfrac{\pi}3 n} + B \sin{\dfrac{\pi}3 n}}}$}
    ...
    \solution
        \part
            \boxt{$T_{n+1} = 0.9T_n + k$}

        \part
            Let $m$ be a constant such that $T_{n+1} + m = 0.9\bp{T_n + m}$. Then $-0.1m = k \implies m = -10k$. Hence,
            \begin{alignat*}{2}
                &&T_{n+1} - 10k &= 0.9\bp{T_n - 10k}\\
                \implies&&T_{n} - 10k &= 0.9^{n-1} \bp{T_0 - 10k}\\
                && &= 0.9^{n-1} \bp{250 -10k}\\
                \implies&&T_n &= 0.9^{n-1} \bp{250 - 10k} + 10k
            \end{alignat*}

            \boxt{$T_n = 0.9^{n-1} \bp{250 - 10k} + 10k$}

        \part
            \begin{alignat*}{2}
                &&T_{12} &\geq 350\\
                \implies&&0.9^{12-1} \bp{250 - 10k} + 10k &\geq 350\\
                \implies&&0.9^{11} \cdot 250 - 0.9^{11} \cdot 10k + 10k &\geq 350\\
                \implies&&-0.9^{11} \cdot 10k + 10k &\geq 350 - 0.9^{11} \cdot 250\\
                \implies&&\bp{1-0.9^{11}} 10k &\geq 350 - 0.9^{11} \cdot 250\\
                \implies&& k &\geq \dfrac{350 - 0.9^{11} \cdot 250}{10 \bp{1-0.9^{11}}}\\
                && &= 39.6 \tosf{3}
            \end{alignat*}
            Since $k \in \N$, the least value of $k$ is 40.

            \boxt{The company needs to attract at least 40 subscribers in each subsequent month.}

        \part
            Since $k = 50$,
            \begin{align*}
                T_n &= 0.9^{n-1} \bp{250 - 10\cdot50} + 10\cdot50\\
            ...
            \begin{align*}
                ...
                &= 10 \sum_{n=1}^m \bp{-\dfrac{2500}9 \cdot 0.9^n + 500} \\
                &= 10 \bp{-\dfrac{2500}9 \cdot \dfrac{0.9 (0.9^m - 1)}{0.9 - 1} + 500m}\\
                &= 10\bp{2500 \bp{0.9^m - 1} + 500m}\\
            ...
            \begin{alignat*}{2}
                &&S_m - 4000m &\geq 0\\
                \implies&&25000 \bp{0.9^m - 1} + 5000m - 4000m &\geq 0\\
                \implies&&25000 \bp{0.9^m - 1} + 1000m &\geq 0\\
                \implies&&25 \bp{0.9^m - 1} + m &\geq 0\\
                \implies&&m &\geq 22.7 \tosf{3}
            \end{alignat*}
            Since $m \in \N$, the least value of $m$ is 23.

            \boxt{$m = 23$}

        \part
            \begin{align*}
                \lim_{n \to \infty} T_n &= \lim_{n \to \infty} \bp{ 0.9^{n-1} (250 - 10 \cdot 50) + 10 \cdot 50}\\
                &= \lim_{n \to \infty} \bp{ -250 \cdot 0.9^{n-1} + 500}\\
                &= -250 \cdot 0 + 500\\
                &= 500
            \end{align*}
            As $n$ becomes very large, the profit per month is $500 \cdot 10 - 4000 = 1000$ dollars.

            \boxt{This behaviour is appropriate.}
\end{document}