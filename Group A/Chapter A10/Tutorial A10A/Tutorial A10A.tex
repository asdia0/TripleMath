...
\begin{document}
    ...
    \solution
        Let $P(x) = 2x^3 - 9x^2 + 2x + 30$. Since $P(x)$ is a polynomial with integral coefficients, and $P(3+i) = 0$, we have that $(3+i)\cconj = 3 - i$ is a root of $P(x)$. Let $a$ be the real root of $P(x)$. We hence have
        \[
    ...
    \solution
        Let $P(z) = az^3 + bz^2 + cz + d$. Since $P(z)$ is a polynomial with integral coefficients, and $P\of{\dfrac54 - \dfrac{\sqrt7}4 i} = 0$, we have that $\bp{\dfrac54 - \dfrac{\sqrt7}4 i}\cconj = \dfrac54 + \dfrac{\sqrt7}4 i$ is also a root of $P(z)$. Hence,
        \begin{align*}
