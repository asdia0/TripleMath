...
\begin{document}
    ...
    \solution
        ...
        \part
            Let $D$ and $E$ be such that $OD$ and $OE$ are tangent to the circle given by the locus of $z$. Let $\angle COD = \t$. Observe that $\sin \t = \dfrac{CD}{CO} = \dfrac{\abs{a}}{\abs{2ia}} = \dfrac12$, whence $\t = \dfrac\pi6$. Since $\angle COA = \arg i = \dfrac\pi2$, it follows that $\angle DOA = \dfrac\pi2 - \t = \dfrac\pi2 - \arcsin \dfrac12 = \dfrac\pi3$. Thus, $\min \arg z = \arg a + \angle DOA = \arg a + \dfrac\pi3$. Meanwhile, $\angle COE = \angle COD = \t$, whence $\max \arg z = \arg a + \dfrac\pi2 + \t = \arg a + \dfrac23 \pi$. Since $\arg \dfrac1z = -\arg z$, we thus have
            \boxt{$\arg \dfrac1z \in \bs{-\bp{\arg a + \dfrac23 \pi}, -\bp{\arg a + \dfrac\pi3}}$}
