...
\begin{document}
    ...
    \solution
        \part
            ...
            \boxt{$u_n$ = $\left(\dfrac12\right)^{n+1}$}
        ...
        \part
            Consider $\lim_{n \to \infty} S_n = \lim_{n \to \infty} \dfrac12 - \left(\dfrac12\right)^{n+1}$. As $n \to \infty$, we see that $\left(\dfrac12\right)^{n+1} \to 0$. Hence, $S_n$ converges to $\dfrac12$.
