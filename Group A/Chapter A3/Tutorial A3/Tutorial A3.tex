...
\begin{document}
    \problem{}
        ...
        \begin{enumerate}
            \item $u_n = 3\left(\dfrac12\right)^{n-1}$
            \item $v_n = 2 - n$
            \item $t_n = (-1)^n$
            \item $w_n = 4$
        \end{enumerate}
    ...
    \solution
        \begin{equation*}
            \begin{aligned}
                \sum_{n=10}^{50} 2n &= 2\left(\sum_{n=1}^{50} n - \sum_{n=1}^{9} n\right) \\
                &= 2 \left( \dfrac{50\cdot51}2 - \dfrac{9\cdot10}2 \right)\\
                &= 2460
            \end{aligned}
        \end{equation*}

        \boxt{
            The sum of all even numbers from 20 to 100 inclusive is 2460.
        }
    ...
    \solution
        \part
            ...
            \boxt{
                The first four terms of the sequence are 0, $\dfrac12$, $\dfrac35$ and $\dfrac8{13}$.
            }
    ...
    \problem{}
        ...
        \begin{equation*}
            S_n = \dfrac12 - \left(\dfrac12\right)^{n+1}
        \end{equation*}
    ...
    \solution
        \part
            \begin{equation*}
                \begin{aligned}
                    u_n &= S_{n} - S_{n-1}\\
                    &= \dfrac12 - \left(\dfrac12\right)^{n+1} - \left(\dfrac12 - \left(\dfrac12\right)^{n}\right)\\
                    &= \left(\dfrac12\right)^{n} - \left(\dfrac12\right)^{n+1} \\
                    &= \left(\dfrac12\right)^{n}\left(1 - \dfrac12\right)\\
                    &= \dfrac12 \cdot \left(\dfrac12\right)^{n}\\
                    &= \left(\dfrac12\right)^{n+1}
                \end{aligned}
            \end{equation*}

            \boxt{
                $u_n$ = $\left(\dfrac12\right)^{n+1}$
            }
        ...
        \part
            ...
            \begin{equation*}
                \begin{aligned}
                    \dfrac{u_{n+1}}{u_n} &= \dfrac{\left(\dfrac12\right)^{n+2}}{\left(\dfrac12\right)^{n+1}} \\
                    &= \dfrac12
                \end{aligned}
            \end{equation*}
        ...
        \part
            \boxt{
                $\text{First term} = \dfrac14$, $\text{Common ratio} = \dfrac12$
            }

        \part
            Consider $\lim_{n \rightarrow \infty} S_n = \lim_{n \rightarrow \infty} \dfrac12 - \left(\dfrac12\right)^{n+1}$. As $n \rightarrow \infty$, we see that $\left(\dfrac12\right)^{n+1} \rightarrow 0$. Hence, $S_n$ converges to $\dfrac12$.
    ...
    \solution
        ...
        \boxt{
            $e^{S_1} + e^{S_2} + e^{S_3} + \ldots + e^{S_n} = \dfrac{x(1-x^{n+1})}{1-x}$
        }
    ...
    \solution
        ...
        \boxt{
            The cake has a volume of $50309$ cm$^3$.
        }
    \problem{}
    ...
    \solution
        ...
        \boxt{
            The common ratio is $\dfrac{-1+\sqrt2}{2}$.
        }       
    ...
    \solution
        ...
        \part
            ...
            \boxt{
                The sum of the geometric series converges to $3a$.
            }
        ...
        \part
            ...
            \boxt{
                $\{ n \in \mathbb{Z}^+ \colon 6 \leq n \leq 13\}$
            }
    ...
    \solution
        ...
        \part
            ...
            \boxt{
                The longest bar is 16.8 cm long. The common difference $d$ is $-0.491$ cm.
            }
    ...
    \problem{}
        ...
        \solution
            \part
                ...
                \medskip \noindent \subpart
                    ...
                    \boxt{
                        After 10 years, he will have at least \$$12x$ in his account for the first time.
                    }
            \part
                After $n$ years, the woman will have \$$ny$ in her account. Hence, the interest she gains after $n$ years is $0.05ny$. Hence, the total interest she will gain is $\sum_{k=1}^n \dfrac{1}{20}ny = \dfrac{1}{20} \cdot \dfrac{n(n+1)}2 \cdot y = \dfrac{1}{40} n(n+1)y$. 
        ...
        \solution
            ...
            \part
                ...
                \boxt{
                    $U_{n+1} = U_n - 7$, $U_1 = \dfrac{7+c}2$, $n \geq 1$
                }
        ...
        \problem{}
            ...
            \noindent for $n = 1, 2, 3, \ldots$.

            \begin{enumerate}
                \item Given that $n \rightarrow \infty$, $x_n \rightarrow \theta$, find the exact value of $\theta$.
                \item By considering $x^2_{n+1} - \theta^2$, or otherwise, show that if $x_n > \theta$, then $0 < x_{n+1} < \theta$.
            \end{enumerate}

        \solution
            \part
                \begin{alignat*}{2}
                    &&\theta &= \lim_{n \rightarrow \infty} \sqrt{\dfrac92 + \dfrac1{x_n}} \\
                    && &= \sqrt{\dfrac92 + \dfrac1{\lim_{n \rightarrow \infty} x_n}} \\
                    && &= \sqrt{\dfrac92 + \dfrac1{\theta}} \\
                    \implies&& \theta^2 &= \dfrac92 + \dfrac1{\theta}\\
                    \implies&& 2\theta^3 &= 9\theta + 2\\
                    \implies&& 2\theta^3 - 9\theta - 2 &= 0\\
                    \implies&& (\theta + 2)(2\theta^2 -4\theta -1) &= 0
                \end{alignat*}

                Hence, $\theta = -2$ or $2\theta^2 -4\theta -1 = 0$. We reject $\theta = -2$ since $\theta > 0$. We thus consider $2\theta^2 -4\theta -1 = 0$. By the quadratic formula, $\theta = 1 + \sqrt{\dfrac32}$ or $\theta = 1 - \sqrt{\dfrac32}$. Once again, we reject $\theta = 1 - \sqrt{\dfrac32}$ since $\theta > 0$. Thus, $\theta = 1 + \sqrt{\dfrac32}$.
            ...
            \part
                Consider $x_{n+1}^2 = \dfrac92 + \dfrac1{x_n}$. If $x_n > \theta$, then $\dfrac1{x_n} < \dfrac1{\theta}$. Hence, $x_{n+1}^2 < \dfrac92 + \dfrac1{\theta} = \theta^2$. Thus, $0 < x_{n+1} < \theta$.
\end{document}