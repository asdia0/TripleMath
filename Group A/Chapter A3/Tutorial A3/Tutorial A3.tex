...
\begin{document}
    ...
    \solution
        ...
        \part
            ...
            \begin{align*}
                \dfrac{u_{n+1}}{u_n} &= \bp{\dfrac12}^{n+2} \Bigg/ \bp{\dfrac12}^{n+1} \\
                &= \dfrac12
            \end{align*}
    ...
    \solution
        ...
        \part
            ...
            \end{alignat*}
            Observe that $-n^2 + 19n - 72 = 0$ when $n = 5.23$ or $n = 13.8$. Since the curve of $-n^2 + 19n - 72$ is concave downwards, we have $5.23 < n < 13.8$. Since $n$ is an integer, $n$ must be between 6 and 13 inclusive.
