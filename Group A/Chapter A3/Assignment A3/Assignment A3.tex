...
\begin{document}
    ...
    \solution
        ...
        \part
            ...
            \boxt{His total savings at the end of $n$ years is \$$326400 (1.05^k - 1)$.}
    ...
    \problem{}
        The graphs of $y = \dfrac13 (2^x)$ and $y=x$ intersect at $x = \a$ and $x=\b$ where $\a < \b$. A sequence of real numbers $x_1, x_2, x_3, \ldots$ satisfies the recurrence relation
    ...
    \solution
        \part
            ...
            Since $y=x$ and $y=\dfrac13 (2^x)$ intersect only at $x=\a$ and $x = \b$, then $\a$ and $\b$ are the only roots of $x = \dfrac13 (2^x)$. Since $L$ is also a root of $x = \dfrac13 (2^x)$, $L$ must be either $\a$ or $\b$.
