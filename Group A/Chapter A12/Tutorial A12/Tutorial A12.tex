...
\begin{document}
    ...
    \solution
        ...
        \part
            Let the scores of the first and second die be $p$ and $q$ respectively. Observe that $p$ is independent of $q$, and vice versa. Hence, the parity of $q$ is not affected by the parity of $p$. Thus, $\P{A} = \dfrac36 = \dfrac12$.

            We also have $\P{B} = 1 - \P{\text{neither $p$ nor $q$ is greater than 4}} = 1 - \bp{\dfrac46}^2 = \dfrac{20}{36}$.

            \begin{center}
                \begin{tabular}{|c|c|c|c|c|c|c|}
                    \hline $p$, $q$ & 1 & 2 & 3 & 4 & 5 & 6\\\hline
    ...
    \solution
        ...
        \part
            ...
            \begin{align*}
                ...
                0 \leq &g \leq 1
            \end{align*}
            Hence, $0.07 \leq g \leq 0.15$, whence \boxt{$0.07 \leq \P{A' \cap B \cap C} \leq 0.15$}
    ...
    \solution
        ...
        \part
            Note that
            \begin{align*}
                \P{\text{all red}} &= \dfrac{\comb44}{10!/(4! \, 6!)}\\
                &= \dfrac1{210}
            \end{align*}
            Hence, the required probability is given by $1 - \dfrac{1}{14} - \dfrac1{210} = \boxed{\dfrac{97}{105}}$.
