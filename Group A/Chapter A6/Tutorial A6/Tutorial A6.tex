...
\begin{document}
    ...
    \solution
        \part
            \subpart
                ...
                \begin{alignat*}{3}
                    x &= r\cos\t &= 3 \cos \left(-\dfrac\pi4\right) &= \dfrac{3\sqrt2}{2}\\
                    y &= r\sin\t &= 3\sin \left(-\dfrac\pi4\right) &= -\dfrac{3\sqrt2}2
                \end{alignat*}
    ...
    \problem{}
        \begin{enumerate}
            ...
            \item By finding the Cartesian equation, sketch the curve whose polar equation is $r = a\sec\left(\t - \dfrac\pi4\right)$, where $a$ is a positive constant.
        \end{enumerate}
    ...
    \solution
        ...
        \part
            \begin{alignat*}{2}
                &&r &= a\sec\left(\t - \dfrac\pi4\right)\\
                \implies&&r &= \dfrac{a}{\cos\left(\t - \dfrac\pi4\right)}\\
                \implies&&r\cos\left(\t - \dfrac\pi4\right) &= a\\
                \implies&&r\left(\cos\t\cos\dfrac\pi4 + \sin\t\sin\dfrac\pi4\right) &= a\\
                \implies&&r\left(\cos\t\cdot \dfrac1{\sqrt2} + \sin\t\cdot \dfrac1{\sqrt2}\right) &= a\\
                \implies&&r\left(\cos\t + \sin\t\right) &= \sqrt2a\\
    ...
    \solution
        ...
        \case{1}{} $n = 0, \, \t=\left(0 + \dfrac12\right)\pi \implies r = 1 + \sin\dfrac{0 + \frac12}3\pi = \dfrac32$

        \medskip

        \case{2}{} $n = 1, \, \t=\left(1 + \dfrac12\right)\implies r = 1 + \sin\dfrac{1 + \frac12}3\pi = 2$

        \medskip

        \case{3}{} $n = 2, \, \t=\left(2 + \dfrac12\right)\implies r = 1 + \sin\dfrac{2 + \frac12}3\pi = \dfrac32$

        \medskip

        \case{4}{} $n = 3, \, \t=\left(3 + \dfrac12\right)\implies r = 1 + \sin\dfrac{3 + \frac12}3\pi = \dfrac12$

        \medskip

        \case{5}{} $n = 4, \, \t=\left(4 + \dfrac12\right)\implies r = 1 + \sin\dfrac{4 + \frac12}3\pi = 0$
    ...
    \solution
        ...
        \part
            \begin{alignat*}{2}
                &&(x^2+y^2)^2 &= 4x^2\\
                \implies&&\left(r^2\right)^2&=4(r\cos\t)^2\\
    ...
    \solution
        \begin{alignat*}{2}
            ...
            \implies&&r^5\left(\cos^5\t + \sin^5\t\right) &= r^4 \cdot 5b\cos^2\t \sin^2\t\\
            \implies&&r\left(\cos^5\t + \sin^5\t\right) &= 5b\cos^2\t \sin^2\t\\
    ...
    \solution
        ...
        \part
            ...
            \begin{alignat*}{2}
                ...
                && &= a\dfrac{\cos\t}{\sin\t}\\
                && &= a\dfrac{r\cos\t}{r\sin\t}\\
                \implies&&r^2 &= a^2\left(\dfrac{r\cos\t}{r\sin\t}\right)^2\\
    ...
    \solution
        \part
            \begin{alignat*}{2}
                &&\left(x^2+y^2\right)^2 &= a^2\left(3x^2-y^2\right)\\
                \implies&& (r^2)^2 &= a^2\left(3(r\cos\t)^2 - (r\sin\t)^2\right)\\
                \implies&&r^4 &= a^2 r^2 \left(3\cos^2\t - \sin^2\t\right)\\
                \implies&&r^2 &= a^2 \left(3\cos^2\t - \sin^2\t\right)\\
                && &= a^2 \left(2\cos^2\t + (1 - \sin^2\t) - \sin^2\t \right)\\
                && &= a^2 \left(1 + 2\cos^2\t - 2 \sin^2\t \right)\\
                && &= a^2 \left(1 + 2\cos 2\t \right)
            \end{alignat*}
        ...
        \part
            ...
            \begin{alignat*}{2}
                &&r &= 0\\
                \implies&&a^2 \left(1 + 2\cos 2\t \right) &= 0\\
                \implies&&1 + 2\cos2\t &= 0\\
        ...
        \part
            \begin{align*}
                r^2 &= a^2 \left(1 + 2\cos \left(2\left(\t-\dfrac\pi3\right)\right)\right)\\
                &= a^2 \left(1 + 2\cos \left(2\t - \dfrac23 \pi \right)\right)
            \end{align*}

            \boxt{$r^2 = a^2 \left(1 + 2\cos \left(2\t - \dfrac23 \pi \right)\right)$}
        ...
        \part
            ...
            \case{1}{} $\t = \dfrac16\pi \implies r^2 = a^2 \left(1 + 2\cos 2\cdot\dfrac16\pi\right) = 2a^2 \implies r = \sqrt2a$. Hence, $C_1$ and $C_2$ intersect at $\bp{\sqrt2a, \dfrac16 \pi}$. Due to symmetry, there is another intersection point at $\bp{\sqrt2a, \dfrac76 \pi}$.

            \case{2}{} $\t = \dfrac23\pi \implies r^2 = a^2 \left(1 + 2\cos 2\cdot\dfrac23\pi\right) = 0
        ...
        \part
            ...
            \begin{align*}
                r^2 &= a^2 \left(1 + 2\cos \left(2\left(\t + \dfrac23\pi\right) - \dfrac23 \pi \right)\right)\\
                &= a^2 \left(1 + 2\cos \left(2\t + \dfrac23 \pi \right)\right)
            \end{align*}

            \boxt{$r^2 = a^2 \bp{1 + 2\cos \bp{2\t + \dfrac23 \pi}}$}
