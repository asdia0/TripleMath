...
\begin{document}
    ...
    \solution
        ...
        \begin{align*}
            ...
            &= r^2 \left(cos^2\t - \sin^2\t\right)\\
            &= r^2 \cos2\t
        \end{align*}

        Hence,
        \begin{alignat*}{2}
            &&\left(r^2\right)^2 - 2r^2\cos2\t &= 3\\
            \implies&&r^2 &= \dfrac{-\left(-2\cos2\t\right) \pm \sqrt{(-2\cos2\t)^2 - 4\cdot1\cdot-3}}{2\cdot1}\\
    ...
    \solution
        \part
            ...
            Consider the discriminant $\D = \left(-a^2\right)^2 - 4\cdot 2x \cdot x^3 = a^4 - 8x^4$. For points on the curve, $\D \geq 0$.
            \begin{alignat*}{2}
                &&\D &\geq 0\\
        ...
        \part
            \begin{alignat*}{2}
                ...
                \implies&&r^2\left(2 - \cos^2\t\right) &= a^2\tan\t\\
    ...
    \solution
        \part
            ...
            Consider $\t = \dfrac\pi2 \implies r = 1 - \sin\left(3 \cdot \dfrac\pi2\right) = 2$. Thus, $C$ intersects the vertical axis at $\bp{2, \dfrac\pi2}$.

            Consider $\t = \dfrac32 \pi \implies r = 1 - \sin\left(3 \cdot \dfrac32 pi\right) = 0$. Thus, $C$ intersects the pole.
        ...
        \part
            Note that
            \begin{align*}
                \left.\der{r}{\t}\right|_{\t = \frac\pi3} &= \left.\left(-3\cos3\t\right)\right|_{\t = \frac\pi3}\\
                &= -3\cos\left(3 \cdot \dfrac\pi3\right)\\
                &= 3
            \end{align*}

            Observe that when $\t = \dfrac\pi3$, $r = 1 - \sin\left(3 \cdot \dfrac\pi3\right) = 1$.

            \begin{align*}
                \left.\der{y}{x}\right|_{\t = \frac\pi3} &= \left.\left(\dfrac{\der{r}{\t}\sin\t + r\cos\t}{\der{r}{\t}\cos\t - r\sin\t}\right)\right|_{\t = \frac\pi3}\\
            ...
            \boxt{When $\t = \dfrac\pi3$, the gradient of the curve is $\left(2 + \dfrac53 \sqrt3\right)$.}
\end{document}