...
\begin{document}
    ...
    \solution
        ...
        \part
            Observe that there are $\comb{2}{1} \cdot \comb{6}{2}$ possible placements for the two particular canisters. Since the other 8 canisters have no restrictions, the total number of ways to place the canisters is given by $\comb{2}{1} \cdot \comb{6}{2} \cdot 8! = \boxed{1209600}$.
            
        \part
            Consider the number of ways the two particular canisters can be placed adjacently. There are $\comb{2}{1} \cdot (5-1) = 8$ possible arrangements per side, giving a total of $2 \cdot 8 = 16$ possible arrangements. Since the other 8 canisters have no restrictions, the total number of ways to place the canisters is given by $16 \cdot 8! = 645120$. The required number of ways is thus given by $3628800 - 645120 = \boxed{2983680}$.
\end{document}