...
\begin{figure}[H]\tikzsetnextfilename{355}
    ...
    \begin{tikzpicture}[trim axis left, trim axis right]
        \begin{axis}[
            ...
            \addplot[plotRed, thick] {x^2};
            \addlegendentry{$a > 0$};

            \addplot[plotBlue, thick] {-x^2};
            \addlegendentry{$a < 0$};
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[H]\tikzsetnextfilename{356}
    ...
    \begin{tikzpicture}[trim axis left, trim axis right]
        \begin{axis}[
            ...
            \addplot[plotRed, thick] ({x^2}, {x});
            \addlegendentry{$b > 0$};

            \addplot[plotBlue, thick] ({-x^2}, {x});
            \addlegendentry{$b < 0$};
        \end{axis}
    \end{tikzpicture}
...
\begin{table}[H]
    ...
    \hline
    \bd{How $y = f(x)$ was transformed} & \bd{Graphical effect on $y = f(x)$} & \bd{Effect on $x$ or $y$ values} \\ \hline\hline
...
\begin{example}[Graph of $y = f(\abs{x})$]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics{figures/250.pdf}
        \caption{}
    \end{figure}
\end{example}
...
\begin{example}[Graph of $y = 1/f(x)$]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics{figures/253.pdf}
        \caption{}
    \end{figure}
\end{example}