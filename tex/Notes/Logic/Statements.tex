...
We call $\forall$ the \vocab{universal quantifier}, and $\exists$ the \vocab{existential quantifier}.

When the domain $S$ is clear from context, we can simply write $\forall x, \, P(x)$, or $\exists x, \, P(x)$.
