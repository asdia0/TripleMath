...
\paragraph{Prerequisites.} \nameref{sec:Permutations-and-Combinations}.
\paragraph{Exercises.} \nameref{sec:A12}
...
\begin{example}[Venn Diagrams]
    ...
    \textbf{A:}
    \begin{center}\tikzsetnextfilename{351}
...
\begin{method}[Probability Trees]
...
\begin{example}[Probability Tree]
    ...
    \textbf{A:}
    \begin{center}\tikzsetnextfilename{350}
        \begin{tikzpicture}
            \coordinate (A) at (0, 0);
