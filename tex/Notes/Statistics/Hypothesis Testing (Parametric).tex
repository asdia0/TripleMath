...
\begin{example}[Degrees of Freedom]
...
\begin{table}[H]
    ...
    \hline
     & \bd{Party A} & \bd{Party B} & \bd{Party C} & \bd{Total} \\ \hline
    \bd{Male} & 313 & 124 & 391 & 828 \\ \hline
    \bd{Female} & 344 & 158 & 388 & 890 \\ \hline
    \bd{Total} &  657 & 282 & 779 & 1718 \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{c|ccc|}
    \cline{2-4}
    & \multicolumn{3}{c|}{\bd{Expected Frequencies}} \\ \cline{2-4} 
