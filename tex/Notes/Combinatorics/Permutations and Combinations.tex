...
\begin{proof}
    ...
    \begin{itemize}
        \item \bd{Stage 1.} The number of ways to fill in the first slot is $n$.
        \item \bd{Stage 2.} After filling in the first slot, the number of ways to fill in the second slot is $n-1$.
        \item \bd{Stage 3.} After filling in the first and second slots, the number of ways to fill in the third slot is $n-2$.
    \end{itemize}
    This continues until we reach the last stage:
    \begin{itemize}
        \item \bd{Stage $r$.} After filling all previous $r-1$ slots, the number of ways to fill in the last slot is $n-(r-1) = n-r+1$.
    \end{itemize}
