...
\begin{theorem}[Baye's Theorem]
    Let $A$ and $B$ be any two events, with $\P{B} \neq 0$. Then \[\P{A}{B} = \frac{\P{B}{A} \P{A}}{\P{B}}.\]
\end{theorem}
\begin{proof}
    If $\P{A} = 0$, we are done. Else, the RHS reduces to \[\frac{\P{B}{A} \P{A}}{\P{B}} = \frac{\P{B \cap A}}{\P{A}} \frac{\P{A}}{\P{B}} = \frac{\P{A \cap B}}{\P{B}} = \P{A}{B}\] as desired.
\end{proof}
...
\end{proposition}
\begin{proof}
    Since $A$ and $B$ are independent, we have $\P{A} = \P{A \mid B} = \P{A \cap B}/\P{B}$. Multiplying through by $\P{B}$ gives the desired claim.
\end{proof}
