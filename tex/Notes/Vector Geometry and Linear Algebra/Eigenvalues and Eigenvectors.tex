\chapter{Eigenvalues, Eigenvectors and Diagonal Matrices}\label{chap:eigen}
...
\begin{corollary}
    ...
    \begin{itemize}
        \item The sum of the $n$ eigenvalues of $\mat A$ (counting multiplicity) is equal to the sum of the diagonal entries of $\mat A$.
