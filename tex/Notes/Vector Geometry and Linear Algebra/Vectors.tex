...
\section{Vector Representation using Cartesian Unit Vectors}\label{sec:vector-cartesian}
...
\end{proposition}
\begin{proof}
    With reference to Figure~\ref{fig:336}, we have \[AN = OA \sin \t = \abs{\vec a} \frac{\abs{\vec a \crossp \vec b}}{\abs{\vec a}\abs{\vec b}} = \frac{\abs{\vec a \crossp \vec b}}{\vec b} = \abs{\vec a \crossp \hat{\vec b}}.\]
\end{proof}
