...
\begin{proposition}\label{prop:matrix-mult-lin-trans}
...
\subsection{Examples of Linear Spaces}\label{subsec:linear-space-eg}
...
\begin{proposition}\label{prop:linear-space-finite-func}
...
Geometrically, the solution set $S$ is obtained by translating the null space of $\mat A$ by $\vec x_p$. That is, $S = \vec x_p + \Ker \mat A$.
