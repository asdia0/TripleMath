...
\end{sample}
\begin{sampans}
    Fix $\ve > 0$ and choose $\de = 2\ve$. If $\abs{x - 9} < \de$, then \[\abs{\sqrt{x-5} - 2} = \frac{\abs{(x - 5) - 2^2}}{\sqrt{x-5} + 2} \leq \frac{\abs{x-9}}{2} < \frac{2\ve}{2} = \ve.\] Thus, $\lim_{x \to 9} \sqrt{x-5} = 2$.
\end{sampans}
