...
Another example of a quadric surface is the ellipsoid, which is a generalization of an ellipse, and has equation \[\frac{x^2}{a^2} + \frac{y^2}{b^2} + \frac{z^2}{c^2} = 1.\]
...
\begin{figure}[H]
    ...
    \setcapindent{0pt}
    \centering
    \begin{minipage}[t]{.3\textwidth}\tikzsetnextfilename{383}
      \centering
    ...
    \end{minipage}%
    \begin{minipage}[t]{.3\textwidth}\tikzsetnextfilename{384}
      \centering
      \begin{tikzpicture}[scale=0.5,trim axis left, trim axis right]
        \begin{axis}[
            hide axis,
    ...
    \end{minipage}%
    \begin{minipage}[t]{.3\textwidth}\tikzsetnextfilename{385}
      \centering
        \begin{tikzpicture}[scale=0.5,trim axis left, trim axis right]
            \begin{axis}[
                hide axis,
...
\begin{example}
    ...
    \begin{tikzpicture}[scale=0.7,trim axis left, trim axis right]
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{The graph of $z = f(x, y)$ with global maxima indicated.}
\end{figure}
\end{example}
