\chapter{Integration}\label{sec:integration}
...
Informally, the indefinite integral of $f(x)$ represents \emph{all} functions whose derivative is $f(x)$. The presence of $C$ is due to the fact that the derivative of a constant is 0.
