...
\begin{solution}
    ...
    \case{3}[$x \in [0, 3]$, $y = 5 - 5x/3$] Observe that \[f\bp{x, 5 - \frac53 x} = 3x\bp{5 - \frac53 x} - 6x - 3\bp{5 - \frac53 x} + 7 = -(x-2)(5x-4)\] is concave down and has a turning point at $x = 1.4$. Hence, the function clearly attains a maximum of $1.8$ when $x = 1.4$ and a minimum of $-11$ when $x = 3$ (note that at $x = 0$, the function returns $-8$). 
