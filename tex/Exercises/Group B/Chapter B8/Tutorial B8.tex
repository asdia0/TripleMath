...
\begin{solution}
    ...
    \end{ppart}
    \begin{ppart}
        Since $x \geq 0$, we have $x = \sqrt{y}$. \[\area = \int_0^4 \sqrt{y} \d y = 5.33 \units[2] \tosf{3}.\]
    \end{ppart}
    \begin{ppart}
        Since $y = \e^{2x}$, we have $x = \ln{y}/2$. Also, when $x = 0$, we have $y = 1$. Further, when $x = 2$, we have $y = \e^4$. Thus, \[\area = \int_0^{\e^4} \frac12 \ln y \d y = 82.4 \units[2] \tosf{3}.\]
    \end{ppart}
    \begin{ppart}
...
\begin{solution}
    \begin{ppart}
        \begin{psubpart}
            Since $x \geq 0$, we obtain $x = \sqrt{y}$ from $y = x^2$ and $x = \sqrt{8 - y}$ from $y = 8 - x^2$. Thus, \[\volume = 2\bp{2\pi \int_0^4 \sqrt{y}\cdot y \d y + 2\pi \int_4^8 \sqrt{8-y}\cdot y \d y} = 536 \units[3] \tosf{3}.\]
        \end{psubpart}
        \begin{psubpart}
            Since $x \geq 0$, we obtain $x = \sqrt{4-y}$ from $y = 4 - x^2$ and $x = y/3$ from $y = 3x$. Thus, \[\volume = 2\pi\int_0^3 \frac13 y \cdot y \d y + 2\pi\int_3^4 \sqrt{4-y}\cdot y \d y = 33.1 \units[3] \tosf{3}.\]
        \end{psubpart}
        \begin{psubpart}
            Since $x \geq 0$, we obtain $x = \sqrt{y}$ from $y = x^2$ and $x = y^2$ from $y = \sqrt{x}$. Thus, \[\volume = 2\pi\int_0^1 \bp{\sqrt{y} - y^2}y \d y = 0.942 \units[3] \tosf{3}.\]
        \end{psubpart}
    \end{ppart}
    \begin{ppart}
        \begin{psubpart}
...
\end{problem}
\begin{solution}
    For $\sin2\t \geq 0$, we have $\t \in \bs{0, \pi/2} \cup \bs{\pi, 3\pi/2}$. By symmetry, the area enclosed by the curve when $0 \leq \t \leq \pi/2$ is the same as that when $\pi \leq \t \leq 3\pi/2$. Thus, \[\area = 2 \cdot \frac12 \int_0^{\pi/2} \sin^2 2\t \d \t = \int_0^{\pi/2} \frac{1 - \cos 4\t}{2} \d \t = \frac12 \evalint{\t - \frac{\sin 4\t}{4}}0{\pi/2}= \frac{\pi}4 \units[2].\]
\end{solution}
...
\begin{solution}
    ...
    \begin{ppart}
        Consider the intersections between $y = x^2$ and $x^2 + y^2 = 12$. We have $x^2 + \bp{x^2}^2 = 12$, so $(x^2 - 3)(x^2 + 4) = 0$. Hence, the two curves intersect at $x = -\sqrt3$ and $x = \sqrt3$. Also note that from $x^2 + y^2 = 12$, we have $y = \sqrt{12 - x^2}$ since $y \geq 0$. Thus, \[\area = 2\int_0^{\sqrt3} \bp{\sqrt{12-x^2} - x^2} \d x = 8.02 \units[2] \tosf{3}.\]
    \end{ppart}
    \begin{ppart}
        We have $y^2 = 12 - x^2$.
        \begin{align*}
    ...
    \end{ppart}
    \begin{ppart}
        Note that when the curves intersect at $x = \sqrt{3}$, we have $y = 3$. Furthermore, when $x = 0$, we have $y = \sqrt{12}$. Also, $x^2 = 12 - y^2$. \[\volume = \pi\int_0^{3} y \d y + \pi \int_{3}^{\sqrt{12}} \bp{12 - y^2} \d y = \pi\bp{16\sqrt{3} - \frac{45}2} \units[3].\]
    \end{ppart}
\end{solution}
...
\begin{problem}
    ...
    \begin{enumerate}
        \item The graph of $y = 2^x$, for $0 \leq x \leq 1$ is shown in the diagram. Rectangles, each of width $1/n$, are drawn under the curve. Given that \[\sum\limits_{k = 0}^n x^k = \frac{1-x^{n+1}}{1-x},\] show that the total area $A$ of all $n$ rectangles is given by \[\frac1n \bp{\frac1{2^{1/n} - 1}}.\]
...
\begin{solution}
    ...
    \begin{ppart}
        \begin{align*}
            V &= \pi \sum_{k=0}^{n-1} \frac1n \bp{2^{k/n}}^2\\
            &= \frac\pi{n} \sum_{k=0}^{n-1} \bp{2^{2/n}}^k\\
            &= \frac\pi{n} \bp{\frac{1 - \bp{2^{2/n}}^{n}}{1 - 2^{2/n}}}\\
            &= \frac\pi{n} \bp{\frac{1 - 4}{1 - 2^{2/n}}}\\
            &= \frac{3\pi}{n\bp{4^{1/n} - 1}}.
        \end{align*}
    \end{ppart}
    \begin{ppart}
        \begin{align*}
            \lim_{n \to \infty} V &= \lim_{n \to \infty} \frac{3\pi}{n\bp{4^{1/n} - 1}}\\
            &= 3\pi \lim_{n \to \infty} \frac{1/n}{4^{1/n} - 1}\\
            &= 3\pi \lim_{m \to 0} \frac{m}{4^m - 1} \\
            &= 3\pi \lim_{m \to 0} \frac{1}{4^m \ln 4}\\
            &= 3\pi \bp{\frac1{\ln 4}}\\
            &= \frac{3\pi}{2\ln2}.
        \end{align*}
    \end{ppart}
...
\begin{solution}
    ...
    \begin{ppart}
        \begin{align*}
            \volume &= \pi \int_0^{\pi/3} \bs{\bp{\sqrt3}^2 - \tan^2 x} \d x\\
            &= \pi \int_0^{\pi/3} \bp{3 - \sec^2 x + 1} \d x \\
            &= \pi\evalint{4x - \tan x}{0}{\pi/3}\\
            &= \bp{\frac{4\pi^2}{3} - \sqrt{3}\pi} \units[3].
        \end{align*}
    \end{ppart}
    \begin{ppart}
...
\begin{problem}
    ...
    \begin{enumerate}
        \item Prove that the depth of the bowl is $8r^2/a$.
        \item Find the volume of the bowl in terms of $r$ and $a$.
        \item Given that the volume of the bowl is $\pi a^3/10$, find the depth of the bowl in terms of $a$ only.
    \end{enumerate}
\end{problem}
\begin{solution}
    Since $ay = x^2$, we have $y = x^2/a$.
    ...
    \end{ppart}
    \begin{ppart}
        We are given that \[\frac{40\pi r^4}{a} = \frac{\pi a^3}{10},\] so $r^2 = a^2/20$. Hence, the depth of the bowl is \[\frac{8}{a} \bp{\frac1{20} a^2} = \frac25 a \units.\]
    \end{ppart}
\end{solution}
...
\begin{solution}
    ...
    When $y = 2$, we have $3 - x^2 = 2$, so $x = 1$ (since $x > 0$).
    \begin{align*}
        \volume &= \pi\int_0^1 \bp{1 - x^2}^2 \d x\\
        &= \pi\int_0^1 \bp{1 - 2x^2 + x^4} \d x\\
        &= \pi \evalint{x - \frac23 x^3 + \frac15 x^5}01\\
        &= \frac{8}{15} \pi \units[3].
    \end{align*}
\end{solution}
...
\begin{solution}
    \begin{ppart}
        Consider the intersections between $(y+5)^2 = x-3$ and $y = x-10$. We have $(x-5)^2 = x-3$, so $x^2 - 11x + 28 = (x-4)(x-7) = 0$. Hence, $x = 4$ and $x = 7$, which correspond to $y = -6$ and $y = -3$ respectively. Thus, the two curves intersect at $(4, -6)$ and $(7, -3)$.

        From $(y+5)^2 = x - 3$, we have $x = 3 + (y+5)^2$. From $y = x - 10$, we have $x = y + 10$. \[\volume = \pi \int_{-6}^{-3} \bs{\bp{y+10}^2 - \bp{3 + (y+5)^2}^2} \d y = 130 \units[3] \tosf{3}.\]
    \end{ppart}
    \begin{ppart}
        From $(y+5)^2 = x - 3$, we have
        \[y = \begin{cases}
                -5+\sqrt{x-3},\qquad y \geq -5,\\
                -5-\sqrt{x-3}, \qquad y < -5.
        \end{cases}\] Thus,
        \begin{align*}
            \volume &= \pi\int_3^4 \bs{\bp{-5-\sqrt{x-3}}^2 - \bp{-5+\sqrt{x+3}}^2} \d x\\
            &\hspace{2em} + \pi\int_4^7 \bs{\bp{x-10}^2 - \bp{-5+\sqrt{x-3}}^2} \d x\\
            &= 127 \units[3] \tosf{3}.
        \end{align*}
    \end{ppart}
\end{solution}
...
\begin{problem}
    The curve $C$ is defined by the following pair of parametric equations. \[x = t - \frac1{t^2}, \quad y = 2 - t^2, \qquad t > 0.\]
...
\begin{solution}
    ...
    \begin{align*}
        \text{Area of $R$} &= \int_0^{\sqrt2 - 1/2} y \d x\\
        &= \int_1^{\sqrt2} \bp{2 - t^2} \der{x}{t} \d t \\
        &= \int_1^{\sqrt2} \bp{2 - t^2}\bp{1 + \frac2{t^3}} \d t\\
        &= 0.526 \units[2] \tosf{3}.
    \end{align*}
    ...
    \begin{align*}
        ...
        &= \pi\int_1^{\sqrt2} \bp{2 - t^2}\bp{1 + \frac2{t^3}} \d t\\
        &= 1.19 \units[3] \tosf{3}.
    \end{align*}
\end{solution}
...
\end{problem}
\begin{solution}
    By symmetry, we only need to consider the area of the ellipse in the first quadrant. When $x = 0$, we have $t = \pi/2$, and when $x = a$, we have $t = 0$. Hence,
    ...
    \begin{align*}
        ...
        &= 4ab\int_0^{\pi/2} \frac{1 - \cos 2t}2 \d t\\
        &= 2ab \evalint{t - \frac{\sin 2t}2}{0}{\pi/2}\\
        &= \pi ab \units[2].
    \end{align*}
    ...
    \begin{align*}
        ...
        &= 2\pi a b^2 \int_0^{\pi/2} \frac{3\sin t - \sin 3t}{4} \d t \\
        &= \frac12 \pi a b^2 \evalint{-3\cos t + \frac13 \cos 3t}{0}{\pi/2}\\
        &= \frac{4\pi}3 ab^2 \units[3].
    \end{align*}
\end{solution}

\begin{problem}
    Find the polar equation of the curve $C$ with equation $x^5 + y^5 = 5bx^2y^2$, where $b$ is a positive constant. Sketch the part of the curve $C$ where $0 \leq \t \leq \pi/2$. Show, using polar coordinates, that the area $A$ of the region enclosed by this part of the curve is given by \[A = \frac{25b^2}2 \int_0^{\frac\pi2} \frac{\sin^4\t\cos^4\t}{(\cos^5\t + \sin^5\t)^2} \d \t.\] By differentiating $1/\bp{1 + \tan^5\t}$ with respect to $\t$, or otherwise, find the exact value of $A$ in terms of $b$.
\end{problem}
\begin{solution}
    ...
    We have
    \begin{align*}
        A &= \frac12 \int_0^{\pi/2} \bp{\frac{5b\cos^2\t\sin^2\t}{\cos^5\t + \sin^5\t}}^2 \d \t\\
        &= \frac12 \int_0^{\pi/2} \frac{25b^2\cos^4\t\sin^4\t}{\bp{\cos^5\t + \sin^5\t}^2} \d \t \\
...
\begin{solution}
    ...
    When $\t = \pi/2$, we have $x = 0$ and $y = \e^{\pi/2}$. Hence, the tangent is given by $y - e^{\pi/2} = -(x - 0)$, which simplifies to $y = -x + e^{\pi/2}$. Thus, \[[R] = \frac12 \bp{\e^{\pi/2}}\bp{\e^{\pi/2}} - \frac12 \int_0^{\pi/2} \bp{e^\t}^2 \d \t = \frac{\e^\pi}2 - \frac12 \evalint{\frac{\e^{2\t}}2}0{\pi/2} = \frac{e^\pi + 1}4 \units[2].\]
\end{solution}
