...
\begin{problem}
    \begin{enumerate}
        ...
        \item The region $R$ is bounded by the curve $y=x^{2}\sin x$, the line $x=\pi/2$ and the part of the $x$-axis between $0$ and $\pi/2$. Find
        \begin{enumerate}
...
\begin{problem}
    The diagram below shows the graphs of \[y=-\frac{1}{\sqrt{9-2x^{2}}} \quad \tand \quad y=\e^{\abs{x}}.\]
    ...
    \begin{enumerate}
        \item The region $A$ is bounded by the two curves and the lines $x=-1$ and $x=2$. Find the area of $A$, giving your answer to 3 significant figures.
        \item The region bounded by the two curves, the $y$-axis and the line $x=2$ is rotated through $2\pi$ radians about the $y$-axis. Prove that the volume generated is $2\pi\bp{\e^2 + 2}$.
    \end{enumerate}
\end{problem}
...
\begin{problem}
    \begin{enumerate}
        \item \begin{enumerate}
            \item The region $S$, is enclosed by the $x$-axis, the line $x=1$ and the curve given by the parametric equations $x = (1 + t)^{3/2}$, $y = (1 - t)^{1/2}$, where $0 \leq t \leq 1$. Find the exact area of $S$.
            \item Find also the volume of the solid obtained when the region $S$ is rotated about the $y$-axis.
        \end{enumerate}
        \item The region $R$ is bounded by the line $x=2$, the line $y=1$, and the curve \[y=\bp{\frac{x-2}{4-x}}^{1/4}.\] By using the substitution $x=2\bp{1 + \cos^2 \t}$, or otherwise, find the exact volume of the solid generated when $R$ is rotated through four right angles about the $x$-axis.
    \end{enumerate}
\end{problem}

\begin{problem}
    The diagram shows the region $R$ in the first quadrant bounded by the line $y = 3$ and the curve $C$ with equation \[y=\sqrt{x}+\frac{2}{\sqrt{x}}.\] The line and the curve intersect at the points $(1, 3)$ and $(4, 3)$. Calculate the exact area of $R$. Write down the equation of the curve obtained when $C$ is translated by 3 units in the negative $y$-direction. Hence, or otherwise, show that the volume of the solid formed when $R$ is rotated completely about the line $y=3$ is given by \[\pi \int_1^4 \bp{x - 6\sqrt{x} + 13 - \frac{12}{\sqrt x} + \frac4x} \d x,\] and evaluate this integral exactly.
...
\begin{problem}
    ...
    \begin{enumerate}
        \item Show that the volume obtained by rotating the shaded part of the region about the $x$-axis is $(1/3) \pi r^3 \bp{\cos^3 \a - 3\cos \a + 2}$.
        \item Show that the total volume of $S$ is $(4/3) \pi r^3 \bp{1 - \cos^3 \a}$.
...
\begin{problem}
    Sketch the polar curve $r=a(1-\sin2\t)$, where $a>0$ and $0\leq\t<2\pi$. Prove that the area enclosed by each loop of the curve is $(3/4) \pi a^2$.
\end{problem}
