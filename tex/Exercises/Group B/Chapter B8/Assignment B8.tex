...
\begin{problem}
    ...
    The volume of the solid formed when $R$ is rotated completely about the $y$-axis is $V_y$. Show that $V_y = (8/15) V_x$.
...
\begin{solution}
    ...
    Note that $x = a - y^2/4a$, so \[x^2 = \bp{a - \frac{y^2}{4a}}^2 = a^2 - \frac12 y^2 + \frac1{16a^2}y^4.\] Hence, 
    \begin{align*}
        V_y &= \pi \int_0^{2a} x^2 \d y\\
        &= \pi \int_0^{2a} \bp{a^2 - \frac12 y^2 + \frac1{16a^2}y^4} \d y\\
...
\clearpage
\begin{problem}
    The region bounded by the axes and the curve $y = \cos x$ from $x = 0$ to $x = \pi/2$ is divided into two parts, of areas $A_1$ and $A_2$, by the curve $y = \sin x$.
...
\begin{problem}
    A curve has parametric equations $x = \cos^2 t$, $y = \sin^3 t$, where $0 \leq t \leq \pi/2$.
    
    \begin{enumerate}
        \item Sketch the curve.
        \item Show that the area under the curve for $0 \leq t \leq \pi/2$ is \[2\int_0^{\pi/2} \cos t \sin^4 t \d t,\] and find the exact value of the area.
...
\begin{solution}
    ...
    \end{ppart}
    \begin{ppart}
        Note that $t = \pi/2$ when $x = 0$ and $t = 0$ when $x = 1$. Hence,
        \begin{align*}
            \area &= \int_0^1 y \d x\\
...
\begin{problem}
    \begin{enumerate}
        \item Given that $f$ is a continuous function, explain, with the aid of a sketch, why \[\lim_{n \to \infty} \frac1n \bs{f\bp{\frac1n} + f\bp{\frac2n} + \ldots + f\bp{\frac{n}{n}}} = \int_0^1 f(x) \d x.\]
...
\end{problem}
\begin{solution}
    Since $y = f(x)$, we have $\d y = f'(x) \d x$. Hence, \[\int_\a^\b g(y) \d y = \int_a^b \inv f\bp{f(x)} f'(x) \d x = \int_a^b xf'(x) \d x.\] Integrating by parts,
    \[\begin{array}{r c @{\hspace*{1.0cm}} c}\toprule
        & D & I \\\cmidrule{1-3}
        + & x & f'(x) \\
        - & 1 & f(x) \\\bottomrule
    ...
    We now use the formula. Let $f(x) = e^{2x}$. Then $g(x) = \ln{x}/2$. Hence, $\a = g(0) = 1$ and $\b = g(1) = e^2$. Invoking the above formula, \[\int_0^1 \e^{2x} \d x = 1\bp{\e^2} - 0(1) - \int_1^{\e^2} \frac12 \ln x \d x = \e^2 - \frac12 \evalint{x \ln x - x}{1}{e^2} = \frac{\e^2 - 1}{2}.\] Hence, the formula holds for the above case.
    
    Similar to the above part, we have \[\int_\a^\b \bs{g(y)}^2 \d y = \int_\a^\b \bs{\inv f\bp{f(x)}}^2 f'(x) \d x = \int_a^b x^2 f'(x) \d x.\] Integrating by parts,
    \[\begin{array}{r c @{\hspace*{1.0cm}} c}\toprule
        & D & I \\\cmidrule{1-3}
        + & x^2 & f'(x) \\
        - & 2x & f(x) \\\bottomrule
