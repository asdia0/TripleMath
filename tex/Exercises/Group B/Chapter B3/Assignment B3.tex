...
\begin{solution}
    \begin{ppart}
        ...
        Let $y = f(x) = (x-3)^2 + 6$. Then $x = 3 \pm \sqrt{y-6}$. Since $x < 3$, we reject $x = 3 + \sqrt{y-6}$. Lastly, observe that $\dom{\inv f} = \ran f = [7, \infty)$. Thus, $\inv f \colon x \mapsto 3 - \sqrt{x-6}$, for $x \in \RR$, $x \geq 7$.
    \end{ppart}
    \begin{ppart}
...
\begin{problem}
    The function $f$ is defined as follows: \[f \colon x \mapsto \frac1{x^2 - 1}, \qquad x \in \RR \setminus \bc{-1, 1}.\]
    ...
    \end{enumerate}
     ...
     \bd{In the rest of the question, the domain of $f$ is $x \in \RR \setminus \bc{-1, 1}$, as originally defined.}

    \smallskip

    The function $g$ is defined as follows: \[g \colon x \mapsto \frac1{x-3}, \qquad x \in \RR \setminus \bc{2, 3, 4}.\]
...
\begin{problem}
    The function $f$ is defined by \[f \colon x \mapsto \frac{x}{x^2 - 1}, \qquad x \in \RR \setminus \bc{-1, 1}.\]
    ...
    The function $g$ is defined by $g \colon x \mapsto \ln x - 1$ for $x \in \RR$, $0 < x < 1$.
...
\begin{solution}
    ...
    \begin{ppart}
        \begin{psubpart}
            Note that $gh(x) = x$, so $h(x) = \inv g(x)$. Let $y = g(x) = \ln x - 1$. Then $x = \e^{y+1}$. Hence, $h(x) = \e^{x+1}$.
        \end{psubpart}
        \begin{psubpart}
            Let $h = h_2 \circ h_1$ such that $h_1g(x) = x$. Then $h_1(x) = \inv g(x)$, so $h_1(x) = \e^{x+1}$ by the previous subpart. We are given $hg(x) = h_2h_1g(x) = x^2+1$, so $h_2(x) = x^2+1$. Hence, $h(x) = h_2h_1(x) = h_2(\e^{x+1}) = \e^{2x+2} + 1$.
        \end{psubpart}
    \end{ppart}
\end{solution}