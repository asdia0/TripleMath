...
\begin{solution}
    \begin{ppart}
        Manipulating the given DE, we have \[\frac{1}{y-3} \der{y}{x} = x+2.\] Integrating with respect to $x$, we have \[\int \frac1{y-3} \d y = \int (x+2) \d x.\] Thus, \[\ln \abs{y-3} + C_1 = \frac12x^2 + 2x.\] Solving for $y$, we get \[y = C_2 \e^{\frac12x^2 + 2x} + 3.\]
    \end{ppart}
    \begin{ppart}
        Manipulating the given DE, we have \[\frac1{16-9u^2} \der{u}{t} = 1.\] Integrating with respect to $x$, we have \[\int \frac1{4^2 - (3u)^2} \d u = \int \d t.\] Thus, \[t = \frac13 \cdot \frac1{2(4)} \ln{\frac{4 + 3u}{4 - 3u}} + C = \frac{1}{24} \ln{\frac{4 + 3u}{4 - 3u}} + C.\] At $t=0$, $u = 1$. Hence, \[0 = \frac1{24} \ln{\frac{4 + 3}{4 - 3}} + C \implies C = -\frac1{24} \ln 7.\] Thus, \[t = \frac{1}{24} \ln{\frac{4 + 3u}{4 - 3u}} - \frac1{24} \ln 7 = \frac1{24} \ln{\frac{4+3u}{7(4-3u)}}.\]
    \end{ppart}
\end{solution}
...
\begin{solution}
    ...
    \begin{ppart}
        Solving for $x$, we get \[\frac1x \der{x}{t} = \frac1{20}.\] Integrating with respect to $t$, we have \[\int \frac1x \d x = \int \frac1{20} \d t.\] Thus, \[\ln \abs{x} + C_1 = \frac1{20} t.\] Solving for $x$, we obtain $x = C_2 \e^{t/20}$. When $t = 0$, $x = 900$. Hence, $C_2 = 900$ and \[x = 900 \e^{t/20}.\] At $t = 3$, \[x = 900 \e^{3/20} = 1045.65 \todp{2}.\] Hence, there will be \$$1045.65$ in the account 3 years later.
    \end{ppart}
    \begin{ppart}
