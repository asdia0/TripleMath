...
\begin{problem}
    ...
    It is thought that the drag force $F$ can be modelled by one of the formulae $F = a + bc$ or $F = c + dv^2$, where $a$, $b$, $c$ and $d$ are constants.
...
\begin{solution}
    ...
    \end{ppart}
    \begin{ppart}
        Since $t$ is independent, we use the regression line $1/t$ on $y$. Using G.C., this is given by $y = 344.60/t + 7.2048$.
    \end{ppart}
    \begin{ppart}
