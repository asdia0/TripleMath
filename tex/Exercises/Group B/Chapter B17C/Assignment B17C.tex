...
\begin{solution}
    \begin{ppart}
        ...
        \case{1} If $2p + 2 < 0$, i.e. $p < -1$, then $\mat A$ has three real eigenvalues, namely $p$, $\sqrt{-\bp{2p- 2}}$ and $\sqrt{-\bp{2p-2}}$.

        \case{2} If $2p + 2 = 0$, i.e. $p = -1$, then $\mat A$ has two real eigenvalues, namely $p = -1$ and $0$.
