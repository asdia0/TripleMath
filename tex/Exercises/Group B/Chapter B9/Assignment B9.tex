...
\begin{solution}
    \begin{ppart}
        When $C$ meets the $x$-axis, \[y = a(2\sin\t + \sin2\t) =  a\bp{2\sin \t + 2\sin \t \cos} = 2a \sin \t \bp{1 + \cos \t} = 0.\] Thus, $\t = 0$ or $\t = \pi$.
    ...
    \end{ppart}
    \begin{ppart}
        Note that \[\der{x}{\t} = -2a(\sin\t+\sin2\t) \quad \tand \quad \der{y}{\t} = 2a(\cos\t + \cos2\t).\] Hence,
        \begin{align*}
