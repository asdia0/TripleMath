...
\begin{solution}
    ...
    \begin{align*}
        \frac{\sqrt[3]{7}}{2} &= \bs{1 + 2\bp{\frac1{14}}}^{-1/3}\\
        &\approx 1 - \frac23 \bp{\frac1{14}} + \frac89 \bp{\frac1{14}}^2\\
        &= \frac{422}{441}.
    \end{align*}
    Thus, $\sqrt[3]{7} \approx \frac{844}{441} = 1.9138 \tosf{5}$. Since $\sqrt[3]7 = 1.9129 \tosf{5}$, the approximation is accurate.
\end{solution}
...
\end{problem}
\begin{solution}
    By the cosine rule, \[AC^2 = AB^2 + BC^2 - 2(AB)(BC)\cos ABC = 1^2 + 3^2 - 2(1)(3) \cos \t = 10 - 6 \cos \t.\] Since $\t$ is sufficiently small, $\cos \t \approx 1 - \t^2/2$. Hence, \[AC^2 \approx 10 - 6\bp{1 - \frac{\t^2}{2}} = 4 + 3\t^2.\] We thus have
    \begin{align*}
        AC &= \bp{4 + 3\t^2}^{1/2}\\
        &= 2\bp{1 + \frac{3\t^2}4}^{1/2}\\
        &\approx 2\bs{1 + \frac12 \bp{\frac{3\t^2}4}}\\
        &= 2 + \frac{3\t^2}4,
    \end{align*}
    so $a = 2$ and $b = \frac34$.
\end{solution}
