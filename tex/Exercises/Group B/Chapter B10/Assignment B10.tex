...
\begin{solution}
    ...
    \end{ppart}
    \begin{ppart}
        Let $f(x) = x/\sqrt{1 + x^2}$. By the trapezium rule, \[\volume = \pi \int_0^2 f(x) \d x \approx \pi \cdot \frac12 \cdot \frac{2-0}{6} \sum_{n=0}^5 \bs{f\bp{\frac{n}3} + f\bp{\frac{n+1}3}} = 3.8566 \tosf{5}.\] Hence, the percentage error is \[\abs{\frac{\pi(\sqrt5 - 1) - 3.8566}{\pi(\sqrt5 - 1)}} = 0.686\% \todp{3}.\]
