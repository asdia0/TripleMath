...
\end{problem}
\begin{solution}
    We have \[\mat T = \begin{pmatrix}2 & 1 \\ 3 & 0\end{pmatrix}\begin{pmatrix}1 & 0 \\ 2 & 2\end{pmatrix}^{-1} = \begin{pmatrix}1 & 1/2 \\ 3 & 0\end{pmatrix}.\]
\end{solution}
...
\begin{solution}
    \begin{ppart}
        We can reduce $\mat A$ to the identity matrix $\mat I$ using two elementary row operations: \[\begin{pmatrix}1 & 0 \\ 3 & 4\end{pmatrix} \rightarrow \begin{matrix}[r] \\ \scriptstyle R_2 - 3R_1\end{matrix} \begin{pmatrix}1 & 0 \\ 0 & 4 \end{pmatrix} \rightarrow \begin{matrix}[r] \\ \scriptstyle (1/4) R_2\end{matrix} \begin{pmatrix}1 & 0 \\ 0 & 1\end{pmatrix}.\] The two elementary matrices representing these operations are given by \[\mat E_1 = \begin{pmatrix}1 & 0 \\ -3 & 1\end{pmatrix} \quad \tand \quad \mat E_2 = \begin{pmatrix}1 & 0 \\ 0 & 1/4\end{pmatrix}.\]
    \end{ppart}
    \begin{ppart}
        From $\mat E_2 \mat E_1 \mat A = \mat I$, we have \[\mat A^{-1} = \mat E_2 \mat E_1 = \begin{pmatrix}1 & 0 \\ 0 & 1/4\end{pmatrix} \begin{pmatrix}1 & 0 \\ -3 & 1\end{pmatrix}.\]
    \end{ppart}
    \begin{ppart}
...
\begin{solution}
    ...
    Let $\vec x = \cveciiix{x}{y}{z}$. Then we have the system of equations \[\systeme{x-3z=1,y+2z=1}.\] Let $z = \l \in \RR$. Then the general solution is given by \[\vec x = \cveciii{x}{y}{z} = \cveciii{1 + 3\l}{1 - 2\l}{\l} = \cveciii110 + \l \cveciii{3}{-2}0.\]
\end{solution}
...
\begin{problem}
    The matrix $\mat A$ is given by \[\mat A = \begin{pmatrix}6 & 3 & 2 \\ 3 & 2 & 1 \\ 8 & 4 & 3\end{pmatrix}.\] By performing row-operations on the matrix $\begin{pmatrix}[c|c] \mat A & \mat I\end{pmatrix}$, find $\mat A^{-1}$. Hence, or otherwise, find $\mat B^{-1}$ where \[\mat B = \begin{pmatrix}1 & 1/2 & 1/3 \\[0.5em] 1/2 & 1/3 & 1/6 \\[0.5em] 1/3 & 1/6 & 1/8\end{pmatrix}.\] Given that the real numbers $x_1$, $x_2$ and $x_3$ satisfy the equation \[\mat B \cveciii{x_1}{x_2}{x_3} = \cveciii{c_1}{c_2}{c_3},\] show that the solution of the equation \[\mat B \vec x = \cveciii{c_1 + \de}{c_2 - \de}{c_3 - \de}\] is \[\vec x = \cveciii{x_1 + 42\de}{x_2 - 18\de}{x_3 - 96\de}.\]
\end{problem}
\begin{solution}
    ...
    Note that \[\mat B = \begin{pmatrix}1 & 1/2 & 1/3 \\[0.5em] 1/2 & 1/3 & 1/6 \\[0.5em] 1/3 & 1/6 & 1/8\end{pmatrix} = \begin{pmatrix}1/6 & 0 & 0 \\[0.5em] 0 & 1/6 & 0 \\[0.5em] 0 & 0 & 1/24\end{pmatrix} \mat A,\] so
    \begin{align*}
        \mat B^{-1} &= \mat A^{-1} \begin{pmatrix}1/6 & 0 & 0 \\[0.5em] 0 & 1/6 & 0 \\[0.5em] 0 & 0 & 1/24\end{pmatrix}^{-1}\\
        &= \begin{pmatrix}2 & -1 & -1 \\ -1 & 2 & 0 \\ -4 & 0 & 3\end{pmatrix} \begin{pmatrix}6 & 0 & 0 \\ 0 & 6 & 0 \\ 0 & 0 & 24\end{pmatrix}\\
        &= \begin{pmatrix}12 & -6 & -24 \\ -6 & 12 & 0 \\ -24 & 0 & 72\end{pmatrix}.
    \end{align*}
...
\begin{solution}
    ...
    \case{1}[$a = 2$] The equation can be represented by the following augmented matrix, which we reduce to its RREF: \[\begin{pmatrix}[ccc|c] 1 & 2 & 3 & 1 \\ 5 & 4 & 2 & 4 \\ -5 & 2 & 11 & -3\end{pmatrix} \rightarrow \begin{pmatrix}[ccc|c] 1 & 0 & -4/3 & 2/3 \\[0.5em] 0 & 1 & 13/6 & 1/6 \\[0.5em] 0 & 0 & 0 & 0\end{pmatrix}.\] Let $\vec x = \cveciiix{x}{y}{z}$. Then the system becomes \[\systeme{x - (4/3) z = 2/3, y + (13/6) z = 1/6}.\] Let $z = \l \in \RR$. Then \[\vec x = \cveciii{x}{y}{z} = \cveciii{2/3}{1/6}{0} + \l \cveciii{4/3}{-13/6}{1}.\]
