...
\begin{solution}
    ...
    \end{ppart}
    \begin{ppart}
        The statement is false. Let $\mat M$ be orthogonal. Then $-\mat M$ is also orthogonal (since $(-\mat M)\trp = -\mat M \trp$). However, their sum, $\mat 0$, is clearly not orthogonal.
    \end{ppart}
\end{solution}
...
\begin{solution}
    \begin{ppart}
        Note that the given system of linear equations has matrix representation \[\begin{pmatrix}[rrr|r]1 & 1 & 1 & 8\\ -1 & -2 & 3 & 1 \\ 3 & -7 & 4 & 10\end{pmatrix}.\] Performing row operations on this matrix, we get \[\begin{pmatrix}[rrr|r]1 & 1 & 1 & 8\\ -1 & -2 & 3 & 1 \\ 3 & -7 & 4 & 10\end{pmatrix} \rightarrow \begin{matrix}[r]\scriptstyle 2R_1 + R_2 \\ \scriptstyle -R_2 - R_1 \\ \scriptstyle -(1/39)(R_3 - 13R_1 - 10 R_2)\end{matrix}\begin{pmatrix}[rrr|r]1 & 0 & 5 & 17\\ 0 & 1 & -4 & -9 \\ 0 & 0 & 1 & 8/3\end{pmatrix}.\] We thus recover the system of linear equations \[\systeme{x_1 + 4x_3 = 17, x_2 - 4x_3 = -9, x_3 = 8/3},\] whence we have $x_1 = 11/3$, $x_2 = 5/3$ and $x_3 = 8/3$.
    \end{ppart}
    \begin{ppart}
        Note that the given system of linear equations has matrix representation \[\begin{pmatrix}[rrr]1 & 1 & 1 \\ -2 & 5 & 2 \\ -7 & 7 & 1\end{pmatrix}.\] Performing row operations on this matrix, we get \[\begin{pmatrix}[rrr]1 & 1 & 1 \\ -2 & 5 & 2 \\ -7 & 7 & 1\end{pmatrix} \rightarrow \begin{matrix}[r] \scriptstyle (1/7)(5R_1 - R_2) \\ \scriptstyle (1/7)(R_2 + 2R_1) \\ \scriptstyle R_3 + 3R_1 - 2R_2 \end{matrix}\begin{pmatrix}[rrr]1 & 0 & 3/7 \\ 0 & 1 & 4/7 \\ 0 & 0 & 0\end{pmatrix}.\] Since the last row is full of zeroes, we have a free variable. Let $x_3 = t$, where $t \in \RR$. Then we recover the system of linear equations \[\systeme{x_1 + (3/7) x_3 = 0, x_2 + (4/7) x_3 = 0, x_3 = t},\] whence $x_1 = -3t/7$, $x_2 = -4t/7$ and $x_3 = t$.
    \end{ppart}
\end{solution}
...
\begin{problem}
    ...
    \begin{tasks}(2)
        \task $\systeme{x_1-x_2+3x_3=b_1,3x_1-3x_2+4x_3=b_2,-2x_1+2x_2-6x_3=b_3}$
        \task $\systeme{2x_1+3x_2-x_3+x_4=b_1,x_1+5x_2+x_3-2x_4=b_2,-x_1+2x_2+2x_3-3x_4=b_3,3x_1+x_2-3x_3+4x_4=b_4}$
    \end{tasks}
\end{problem}
\clearpage
\begin{solution}
...
\begin{problem}
    ...
    \begin{tasks}(3)
        \task $\begin{pmatrix}
            2 & 3 & 1\\3 & 1 & 2\\1 & 2 & 3
        \end{pmatrix}$
        \task $\begin{pmatrix}[rr]
            \cos \a & \sin \a \\ -\sin \a & \cos \a
        \end{pmatrix}$
        \task $\begin{pmatrix}[rrr]
...
\begin{solution}
    \begin{ppart}
        Performing row operations on $\begin{pmatrix}[c|c]\mat A & \mat I\end{pmatrix}$, we have \[\begin{pmatrix}[rrr|rrr]2 & 3 & 1 & 1 & 0 & 0 \\ 3 & 1 & 2 & 0 & 1 & 0 \\ 1 & 2 & 3 & 0 & 0 & 1\end{pmatrix} \rightarrow \begin{matrix}[r] \scriptstyle (1/18) (R_1 + 7R_2 - 5R_3) \\[0.4em] \scriptstyle (1/18) (7R_1 - 5R_2 + R_3) \\[0.4em] \scriptstyle (1/18) (-5R_1 + R_2 + 7R_3)\end{matrix} \begin{pmatrix}[rrr|rrr] 1 & 0 & 0 & 1/18 & 7/18 & -5/18 \\[0.4em] 0 & 1 & 0 & 7/18 & -5/18 & 1/18 \\[0.4em] 0 & 0 & 1 & -5/18 & 1/18 & 7/18\end{pmatrix}.\] Thus, \[\inv{\mat A} = \frac1{18} \begin{pmatrix}[rrr]1 & 7 & -5 \\ 7 & -5 & 1 \\ -5 & 1 & 7\end{pmatrix}.\]
    \end{ppart}
    \begin{ppart}
...
\begin{problem}
    ...
    \begin{tasks}(2)
        \task $\mat A = \begin{pmatrix}
            0 & 4 \\ -1 & 2
        \end{pmatrix}$
        \task $\mat B = \begin{pmatrix}
            2 & -1 & 4 \\ 4 & -3 & 1 \\ 1 & 2 & 1
        \end{pmatrix}$
        \task $\mat C = \begin{pmatrix}
            2 & 0 & 0 \\ 4 & -3 & 0 \\ 1 & 2 & 1
        \end{pmatrix}$
        \task $\mat D = \begin{pmatrix}
            2 & -1 & 4 \\ 4 & -3 & 1 \\ 3 & 6 & 3
        \end{pmatrix}$
    \end{tasks}
\end{problem}
...
\begin{problem}
    For the case where \[\mat A = \begin{pmatrix} 0 & 1 & 0 \\ 1 & 2 & -1 \\ 0 & 1 & 3 \end{pmatrix} \quad \tand \quad \mat B = \begin{pmatrix} 1 & 0 & 2 \\ 2 & 1 & 0 \\ -1 & 1 & -1 \end{pmatrix},\] verify the results
    \begin{enumerate}
...
\begin{solution}
    ...
    \end{ppart}
    \begin{ppart}
        Using G.C., \[\inv{\mat A} = \frac13 \begin{pmatrix}[rrr]-7 & 3 & 1 \\ 3 & 0 & 0 \\ -1 & 0 & 1\end{pmatrix}.\] Hence, $\det{\inv{\mat A}} = -1/3 = 1/(-3) = 1/\det \mat A$.
    \end{ppart}
    \begin{ppart}
...
\begin{problem}
    It is given that \[\mat A = \begin{pmatrix}2 & 1 & 3  \\ -1 & 0 & 4 \\ 3 & 1 & 0\end{pmatrix} \quad \tand \quad \mat B = \begin{pmatrix} 2 & 1 & 3 \\ -1 & 1 & 12 \\ 3 & 1 & 0 \end{pmatrix}.\] Without the use of the G.C., find the inverse of $\mat A$ and $\mat B$ if it exists. For each of (a) and (b) below, solve, if possible, the equation, giving your answers in terms of $a$ (where applicable).
...
\begin{solution}
    \begin{ppart}
        Taking determinants on both sides of the given equation, we have $\det{\mat A^2} = \det \mat A$. Since $\det{\mat A^2} = \bp{\det \mat A}^2$, we see that the only possible values of $\det \mat A $ are 0 and 1. An example of $\mat A$ with determinant 0 is \[\mat A = \begin{pmatrix}1 & 0 \\ 0 & 0\end{pmatrix},\] while an example of $\mat A$ with determinant 1 is simply $\mat I$.

        In fact, $\mat I$ is the only such matrix that has determinant 1; if $\mat A$ is invertible, we can pre-multiply its inverse to the equation $\mat A^2 = \mat A$ to get $\inv{\mat A} \mat A^2 = \inv{\mat A} \mat A$, which simplifies to give $\mat A = \mat I$.
        
        \begin{psubpart}
            The statement is false. Take $\mat A = \mat I$. Then $\mat I - \mat A = \mat 0$, which is not invertible.
        \end{psubpart}
        \begin{psubpart}
    ...
    \end{ppart}
    \begin{ppart}
        Note that \[\mat D = \begin{pmatrix}1 & 0 & 0 \\ 2 & 1 & 0 \\ 0 & 0 & 1\end{pmatrix} \mat C = \begin{pmatrix}1 & 0 & 0 \\ 2 & 1 & 0 \\ 0 & 0 & 1\end{pmatrix} \inv{\mat B}.\] Thus, our goal matrix $\inv{\mat D}$ is given by \[\inv{\mat D} = \mat B \begin{pmatrix}1 & 0 & 0 \\ 2 & 1 & 0 \\ 0 & 0 & 1\end{pmatrix}^{-1} = \begin{pmatrix} a & b & c \\ d & e & f \\ g & h & i \end{pmatrix}\begin{pmatrix}1 & 0 & 0 \\ -2 & 1 & 0 \\ 0 & 0 & 1\end{pmatrix} = \begin{pmatrix}a-2b & b & c \\ d-2e & e & f \\ g-2h & h & i\end{pmatrix}.\]
    \end{ppart}
\end{solution}