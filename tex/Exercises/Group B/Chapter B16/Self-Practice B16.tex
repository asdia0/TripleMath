...
\begin{problem}
    Given that \[\der{x}{t} = 5x - 9t + y \quad \tand \quad \der{y}{t} = y - 4x + 9,\] by eliminating the variable $y$, show that \[\der[2]{x}{t} - 6\der{x}{t}+ 9x = 9t.\] Find the general solution of $x$ in terms of $t$ and hence obtain the general solution of $y$ in terms of $t$. Find the ratio $x:y$ when $t \to -\infty$.
\end{problem}
