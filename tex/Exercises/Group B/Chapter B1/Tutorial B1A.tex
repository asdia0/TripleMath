...
\begin{problem}
    ...
    \begin{enumerate}
        \item $\displaystyle y = \frac1{2x+1}$
        \item $\displaystyle y = \frac{3x}{x-2}$
        \item $\displaystyle y = \frac{x^2+x-6}{2x-2}$
    \end{enumerate}
\end{problem}
\begin{solution}
    \begin{ppart}
...
\begin{problem}
    ...
    \begin{enumerate}
        ...
        \item $y^2 = x - 9$
        \item $y^2 = (x-2)^4 + 5$
        \item $y = \tan{x/2}$ where $-2\pi \leq x \leq 2\pi$
    \end{enumerate}
\end{problem}
\begin{solution}
    \begin{ppart}
...
\begin{problem}
    ...
    \begin{enumerate}
        \item $\displaystyle y = \frac{1-3x}{2x-1}$
        \item $\displaystyle y = \frac{ax}{x-a}, \, a < 0$
        \item $\displaystyle y = -\frac{b(x+3a)}{x+a}, \, a,b > 0$
    \end{enumerate}
\end{problem}
\begin{solution}
    \begin{ppart}
...
\begin{problem}
    ...
    \begin{enumerate}
        \item $y = x + 2\sin x$, where $0 \leq x \leq 2\pi$
        \item $y = x/\ln x$, where $x > 0$ and $x \neq 1$
        \item $y = x\e^{-x}$
        \item $y = x\e^{-x^2}$
    \end{enumerate}
\end{problem}
...
\begin{problem}
    The equation of a curve $C$ is $y = 1 + 6/(x-3) - 24/(x+3)$.
...
\begin{solution}
    ...
    \end{ppart}
    \begin{ppart}
        Clearing denominators in $y = (-2x^2-3x)/(x+2)$, we get $y(x+2) = -2x^2 - 3x$. Rearranging, we get $2x^2 + (3+y)x + 2y = 0$. For solutions, we require the discriminant $\D = (3+y)^2 - 4(2)(2y)$ to be non-negative. Hence, $y^2-10y +9 = (y-1)(y-9) \geq 0$, so the set of values that $y$ can take is $(-\infty, 1] \cup [9, \infty)$.
    \end{ppart}
    \begin{ppart}
    ...
    \end{ppart}
    \begin{ppart}
        We may manipulate $x^4 + 2x^3 + 2x^2 + 3x = 0$ to get \[x^3 = \frac{-2x^2-3x}{x+2}.\] This motivates us to plot $y = x^3$ and $y = (-2x^2-3x)/(x+2)$ on the same graph.
        ...
        From the above graph, we see that $y = x^3$ intersects $y = (-2x^2-3x)/(x+2)$ twice, with one intersection point being the origin. Thus, there is only one real non-zero root to $x^4 + 2x^3 + 2x^2 + 3x = 0$.
    \end{ppart}
\end{solution}
...
\begin{problem}
    ...
    \begin{enumerate}
        ...
        \item Find the positive value $k$ such that the equation $x/(x^2-5x+4) = kx$ has exactly 2 distinct real roots.
    \end{enumerate}
\end{problem}
\begin{solution}
    \begin{ppart}
    ...
    \end{ppart}
    \begin{ppart}
        Note that $x = 0$ is always a root of $x/(x^2-5x+4) = kx$. We thus aim to find the value of $k$ such that $x/(x^2-5x+4) = kx$ has only one non-zero root. 

            We observe that if $k > 0$, $y=kx$ will intersect with $y = x/(x^2-5x+4)$ at least twice: before $x=1$ and after $x=4$. In order to have only one non-zero root, we must force the intersection point that comes before $x=1$ to be at the origin $(0, 0)$. Hence, $k$ is tangential to $C$ at $(0, 0)$, thus giving $k = \evalder{\derx{C}{x}}{x=0}$.
