...
\clearpage
\begin{problem}
    The curve with equation $y=x^3$ is transformed by a translation of 2 units in the positive $x$-direction, followed by a stretch with scale factor $1/2$ parallel to the $y$-axis, followed by a translation of 6 units in the negative $y$-direction. Find the equation of the new curve in the form $y = f(x)$ and the exact coordinates of the points where this curve crosses the $x$- and $y$-axes.
\end{problem}
\begin{solution}
    \begin{align*}
        y &= x^3\\
        y &= (x-2)^3 \tag{$x \mapsto x-2$}\\
        2y &= (x-2)^3 \tag{$y \mapsto 2y$}\\
        2(y+6) &= (x-2)^3 \tag{$y \mapsto y+6$}
    \end{align*}

    Hence, \[y = \frac{(x-2)^3}{2} - 6.\]
...
\begin{problem}
    ...
    Hence, state a sequence of transformations by which the graph of \[y = \frac{x^2-4x}{(x-2)^2}\] may be obtained from the graph of $y = 1/x^2$.
\end{problem}
\begin{solution}
    ...
    \begin{enumerate}
        \item[] \[y = \frac1{x^2}.\]
        \item Translate the curve 2 units in the positive $x$-direction. \[y = \frac1{(x-2)^2}. \tag{$x \mapsto x-2$}\]
        \item Stretch the curve with a scale factor of 4 parallel to the $y$-axis. \[y = \frac{4}{(x-2)^2}. \tag{$y \mapsto y/4$}\]
        \item Reflect the curve about the $x$-axis. \[y = -\frac{4}{(x-2)^2}. \tag{$y \mapsto -y$}\]
        \item Translate the curve 1 unit in the positive $y$-direction. \[y = 1 - \frac{4}{(x-2)^2}. \tag{$y \mapsto y-1$}\]
    \end{enumerate}
...
\begin{solution}
    ...
    \begin{enumerate}
        \item[] \[y = 3\sqrt{2-x} + 1.\]
        \item Translate the curve 1 unit in the negative $y$-direction. \[y = 3\sqrt{2-x}. \tag{$y \mapsto y+1$}\]
        \item Scale the curve parallel to the $y$-axis by a factor of $1/3$. \[y = \sqrt{2-x}. \tag{$y \mapsto 3y$}\]
        \item Translate the curve 2 units in the negative $x$-direction. \[y = \sqrt{-x}. \tag{$x \mapsto x+2$}\]
        \item Reflect the curve about the $y$-axis. \[y = \sqrt{x}. \tag{$x \mapsto -x$}\]
    \end{enumerate}
    \renewcommand{\theenumi}{(\alph{enumi})}
    ...
    \begin{center}\tikzsetnextfilename{248}
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[thick, domain=-5:0] {2*x * e^(1/2 -1/2 * x^2)} node[pos=0.4, below left] {$y=f(x)$};
        ...
        \begin{center}\tikzsetnextfilename{252}
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    \addplot[thick, domain=-5:0] {abs(2*x * e^(1/2 -1/2 * x^2))} node[pos=0.4, above left] {$y=f(x)$};
...
\begin{solution}
    ...
    \end{ppart}
    \begin{ppart}
        Scale by a factor of $1/2$ parallel to the $y$-axis.
    \end{ppart}
    \begin{ppart}
