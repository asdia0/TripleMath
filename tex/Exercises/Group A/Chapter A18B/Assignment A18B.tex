...
\begin{problem}
    A lorry is transporting a large number of red apples. As it passes over a bump in the road 10 apples fall off its back. The masses (in g) of the fallen apples are summarized by \[\sum (x - 100) = 23.7 \quad \tand \quad \sum (x - 100)^2 = 1374.86.\]
    ...
    On its return down the road the lorry is carrying a large number of green apples. When it passes over the bump 15 green apples fall off its back and are collected. The masses (in g) of these apples are summarized by \[\sum (y - 110) = -73.2 \quad \tand \quad \sum (y - 110)^2 = 2114.33.\]
