...
\begin{solution}
    ...
    \end{ppart}
    \begin{ppart}
        Since $\bc{b_n}$ is in arithmetic progression, we have \[\sum_{n = 1}^{N+1} b_n = \frac{N+1}{2} \bp{b_1 + b_{N+1}} = \frac{N+1}{2} \bp{\ln a_1 + \ln a_{N+1}} = \frac{N+1}{2} \ln{a_1 a_{N+1}}.\]
    \end{ppart}
    \begin{ppart}
...
\begin{solution}
    ...
    \begin{ppart}
        We have
        \begin{align*}
            &43\times26 + 45\times27 + 47\times28 + \dots +87\times48 + 89\times49\\
            &\hspace{2em}= \sum_{r = 24 + 1}^{2(24)} (2r-7)(r+1)\\
            &\hspace{2em}= \frac{(24)\bs{28(24)^2 - 27(24) - 55}}6\\
            &\hspace{2em}= 61700.
        \end{align*}
    \end{ppart}
\end{solution}
...
\begin{problem}
    It is given that \[\sum_{r = 1}^n \frac{2r+1}{r(r+1)(r+2)} = \frac{n\bp{5n+7}}{4(n+1)(n+2)}.\]
    \begin{enumerate}
...
\begin{solution}
    \begin{ppart}
        Clearly, \[\sum_{r = 1}^\infty \frac{2r+1}{r(r+1)(r+2)} = \lim_{n \to \infty} \frac{n\bp{5n+7}}{4(n+1)(n+2)} = \lim_{n \to \infty} \frac{5 + 7/n}{4 \bp{1 + 1/n} \bp{1 + 2/n}} = \frac54.\] Thus, the series converges and its sum to infinity is $5/4$.
    \end{ppart}
    \begin{ppart}
