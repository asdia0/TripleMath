...
\begin{solution}
    ...
    \begin{ppart}
        ...
        \end{psubpart}
        \begin{psubpart}
            Consider \[\P{\text{$A$ wins competition}} = \bs{\frac12 \cdot p} + \bs{\frac12 \cdot (1-p) \cdot \frac13} + \bs{\frac12 \cdot \frac13 \cdot p} = \frac{p}2 + \frac16 = \frac12.\] We hence need $p = 2/3$ for $A$ to have equal chances of winning and losing.
        \end{psubpart}
    \end{ppart}
\end{solution}
