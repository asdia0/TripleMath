...
\begin{problem}
    Two events $A$ and $B$ are such that $\P{A} = 8/15$, $\P{B} = 1/3$ and $\P{A}{B} = 1/5$. Calculate the probabilities that
    \begin{enumerate}
...
\begin{solution}
    ...
    \begin{ppart}
        We have
        \begin{align*}
            \P{\text{only one occurs}} &= \P{A \cup B} - \P{A \cap B}\\
            &= \P{A} + \P{B} - 2\P{A \cap B} \\
            &= \frac8{15} + \frac13 - 2 \bp{\frac1{15}}\\
            &= \frac{11}{15}.
        \end{align*}
    \end{ppart}
    \begin{ppart}
    ...
    Since $\P{A} = 8/15 \neq 1/15 = \P{A}{B}$, it follows that $A$ and $B$ are not independent. Also, since $\P{A \cap B} = 1/15 \neq 0$, the two events are also not mutually exclusive.
\end{solution}

\clearpage
\begin{problem}
    Two events $A$ and $B$ are such that $\P{A} = \P{B} = p$ and $\P{A \cup B} = 5/9$.
    \begin{enumerate}
...
\begin{solution}
    \begin{ppart}
        ...
        \begin{align*}
            ...
            &= 2 - \frac{5}{9p}.
        \end{align*}
        Multiplying through by $p$ and rearranging, we get $9p^2 - 18p + 5 = 0$.
    \end{ppart}
    \begin{ppart}
        Observe that $9p^2 - 18p + 5 = (3p - 1)(3p - 5) = 0$.  Thus, $p = 1/3$. Note that $p \neq 5/3$ since $0 < p \leq 1$.

        Since $A$ and $B$ are independent, $\P{A \cap B} = \P{A} \P{B} = (1/3)(1/3) = 1/9$.
    \end{ppart}
\end{solution}
...
\begin{solution}
    ...
    \begin{ppart}
        ...
        \begin{align*}
            ...
            &= -0.1p + 0.3
        \end{align*}
        Consider $\P{\text{$A$ wins}} = \P{\text{$B$ wins}}$. Then $0.2p + 0.2 = -0.1p + 0.3$, so $p = 1/3$.
    \end{ppart}
\end{solution}
...
\begin{solution}
    \begin{ppart}
        Let the scores of the first and second die be $p$ and $q$ respectively. Suppose $A$ occurs. Then $p$ and $q$ are of different parities. Thus, $p$ and $q$ cannot be equal. Hence, $C$ cannot occur, whence $A$ and $C$ are mutually exclusive.
    \end{ppart}
    \begin{ppart}
        ...
        We now consider $\P(A \cap B)$. From the table of outcomes above, it is clear that $\P(A \cap B) = 10/36 = \P{A}\P{B}$. Hence, $A$ and $B$ are independent.
    \end{ppart}
\end{solution}
...
\begin{solution}
    ...
    \begin{ppart}
        ...
        Note that $\P{A' \cap B \cap C} = g$. Firstly, from part (d), we have $b + g = \P{A' \cap C} = 0.15$. Hence, $g \leq 0.15$. Secondly, from part (b), we have $a + b = 1 - \P{A \cup B} = 1 - 0.92 = 0.08$. Hence, $b \leq 0.08$, so $g \geq 0.07$. Lastly, we know that $\P{A' \cap B} = \P{A \cup B} - \P{A} = 0.92 - 0.7 = 0.22$. Hence, $d + g = 0.22$, so $g \leq 0.22$.
...
\begin{solution}
    ...
    \begin{ppart}
        \begin{align*}
            ...
            &= \frac{1/200 \cdot 0.9^2}{1/200 \cdot 0.9^2 + 199/200 \cdot 0.02^2}\\
            &= \frac{2025}{2224}.
        \end{align*}
    \end{ppart}
\end{solution}
...
\begin{solution}
    ...
    \begin{ppart}
        ...
        \begin{align*}
            ...
            &= \P{M \cap W} + \P{B} \P{M}{B} \\
            &= \frac{3}{14} + \frac35 \bp{\frac47\cdot\frac36 + \frac37\cdot\frac46}\\
            &= \frac{39}{70}.
        \end{align*}
...
\begin{solution}
    \begin{ppart}
        Let the two sisters be one unit. There are hence 14 units altogether, giving $14! \cdot 2!$ arrangements with the restriction. Since there are a total of $15!$ arrangements without the restriction, the required probability is $14! \, 2! / 15! = 2/15$.
    \end{ppart}
    \begin{ppart}
    ...
    \begin{ppart}
        ...
        \begin{align*}
            ...
            &\hspace{2em}= \P{\text{sisters together}} + \P{\text{brothers together}} - \P{\text{sisters together $\cap$ brothers together}}\\
            &\hspace{2em}= \frac2{15} + \bp{1 - \frac1{35}} - \frac2{455}\\
            &\hspace{2em}= \frac{43}{273}.
        \end{align*}
    \end{ppart}
    \begin{ppart}
        Note that
        \begin{align*}
            ...
            &\hspace{2em}= \P{\text{sisters together}} - \P{\text{sisters together $\cap$ brothers together}}\\
            &\hspace{2em}= \frac2{15} - \frac{2}{455}\\
            &\hspace{2em}= \frac{176}{1365}.
        \end{align*}
        Hence, the required probability can be calculated as
        \begin{align*}
            &\P{\text{sisters together}}{\text{brothers not together}}\\
            &\hspace{2em}= \frac{\P{\text{sisters together $\cap$ brothers not together}}}{\P{\text{brothers not together}}}\\
            &\hspace{2em}= \frac{176/1365}{34/35}\\
            &\hspace{2em}= \frac{88}{663}.
        \end{align*}
    \end{ppart}
\end{solution}