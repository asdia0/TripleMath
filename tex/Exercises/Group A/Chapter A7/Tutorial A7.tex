...
\begin{solution}
    ...
    \begin{ppart}
        ...
        The area of $\triangle ONC$ is given by \[[\triangle ONC] = \frac12 \abs{\oa{ON} \crossp \oa{OC}} = \frac12 \abs{\bs{\frac47\vec a + \frac37(\l \vec a + \m \vec b)} \crossp \bp{\l \vec a + \m \vec b}} = \frac{2\m}{7} \abs{\vec a \crossp \vec b}.\] Meanwhile, the area of $\triangle OMC$ is given by \[[\triangle OMC] = \frac12 \abs{\oa{OM} \crossp \oa{OC}} = \frac12 \abs{\frac12 \vec b \crossp \bp{\l \vec a + \m \vec b}} = \frac{\l}{4} \abs{\vec a \crossp \vec b}.\] Since the two areas are equal, \[[\triangle ONC] = [\triangle OMC] \implies \frac{2\m}{7} \abs{\vec a \crossp \vec b} = \frac{\l}{4} \abs{\vec a \crossp \vec b} \implies \l = \frac87 \m.\]
    \end{ppart}
\end{solution}