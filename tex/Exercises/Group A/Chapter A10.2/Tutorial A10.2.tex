...
\begin{solution}
    \begin{ppart}
        ...
        We have $r = \sqrt{2^2 + (-2)^2} = 2\sqrt2$ and $\t = \arctan{-2/2} = -\pi/4$. Hence, $2 - 2\i = 2\sqrt2 \bs{\cos{-\pi/4} + \i\sin{-\pi/4}}$.
    \end{ppart}
    \begin{ppart}
        ...
        We have $r = \sqrt{(-1)^2 + (\sqrt3)^2} = 2$ and $\t = \arctan{\sqrt{3}/(-1)} = 2\pi/3$. Hence, $-1 + \sqrt3 \i = 2 \bs{\cos{2\pi/3} + \i\sin{2\pi/3}}$.
    \end{ppart}
    \begin{ppart}
        ...
        We have $r = 5$ and $\t = -\pi/2$. Hence, $-5\i = 5\bs{\cos{-\pi/2} + \i\sin{-\pi/2}}$.
    \end{ppart}
    \begin{ppart}
        ...
        We have $r = \sqrt{(-2\sqrt3)^2 + (-2)^2} = 4$ and $\t = \arctan{-2/(-2\sqrt3)} = -5\pi/6$. Hence, $-2\sqrt3 - 2\i = 4\bs{\cos{-5\pi/6} + \i\sin{-5\pi/6}}$.
    \end{ppart}
\end{solution}
...
\begin{solution}
    \begin{ppart}
        ...
        We have $r = \sqrt{(-1)^2 + \bp{2/13}^2} = 1.01 \tosf{3}$ and $\t = \arctan{-2/13} = 2.99 \tosf{3}$. Hence, $-1 + 2\i/13 = 1.01\e^{2.99\i}$.
    \end{ppart}
    \begin{ppart}
        We have $r = 1$ and $\t = -50\deg = -5\pi/18$. Hence, $\cos 50 \deg + i \sin 50 \deg = \e^{-\i(5\pi/18)}$.
    \end{ppart}
\end{solution}
...
\begin{problem}
    ...
    \begin{enumerate}
        \item $z = 7\e^{1 - 5\i}$
        \item $z = 6\bp{\cos{\pi/8} - \i\sin{\pi/8}}$
    \end{enumerate}
\end{problem}
\begin{solution}
    \begin{ppart}
...
\begin{solution}
    ...
    We have $r = \sqrt{(\sqrt3)^2 + (-1)^2} = 2$ and $\t = \arctan{-1/\sqrt3} = -\pi/6$. Hence, $\abs{z} = 2$ and $\arg z = -\pi/6$.
...
\end{problem}
\begin{solution}
    \[\arg{2z - 1} = \arg{2 \bs{z - \frac12}} = \arg{z - \frac12} = \frac\pi5.\]
\end{solution}
...
\begin{problem}
    \begin{enumerate}
        \item Given that $u = 2\bp{\cos{\pi/6} + \i\sin{\pi/6}}$ and $w = 4\bp{\cos{\pi/3} - \i\sin{\pi/3}}$, find the modulus and argument of $u\conj/w^3$ in exact form.
...
\begin{solution}
    ...
    \end{ppart}
    \begin{ppart}
        Since $\arg{z^2 + az} = -\pi/2$, we have that $z^2 + az$ is purely imaginary, with a negative imaginary part. Since \[z^2 + az = \bp{-1 + \i\sqrt3}^2 + a\bp{-1 + \i \sqrt3} = -\bp{2+a} + \i \sqrt3 \bp{-2+a},\] it follows that $2+a = 0$, so $a = -2$.
    \end{ppart}
\end{solution}
...
\begin{solution}
    ...
    Since $p^5$ is real and positive, we have $\arg p^5 = 2\pi n$, where $n$ is an integer. Thus, $\arg p = 2\pi n/5 = 2\t$, hence $\t =\pi n/5$. Since $0 < \t < \pi/2$, the possible values of $\t$ are $\pi/5$ and $2\pi/5$.
\end{solution}
...
\begin{problem}
    ...
    Hence, show that $\sin{\pi/12} = (\sqrt3 - 1)/2\sqrt2$.
\end{problem}
\begin{solution}
    ...
    From the first part, we have that $wz = 2\sqrt2 \bs{\cos{11\pi/12} + \i\sin{11\pi/12}}$. Thus, $\Im{wz} = 2\sqrt{2} \sin{11\pi/12} = 2\sqrt2 \sin{\pi/12}$. Equating the result for $\Im{wz}$ found in the second part, we have \[2\sqrt2 \sin \frac\pi{12} = \sqrt3 - 1,\] so \[\sin \frac{\pi}{12} = \frac{\sqrt3 - 1}{2\sqrt2}.\]
\end{solution}

\clearpage
\begin{problem}
    Given that $(5+z)/(5-z) = \e^{\i\t}$, show that $z$ can be written as $5\i\tan{\t/2}$.
\end{problem}
\begin{solution}
    Clearing denominators, we get $5 + z = \e^{\i\t} (5-z)$. Expanding and solving for $z$, we see that \[z = 5\bp{\frac{\e^{\i\t} - 1}{\e^{\i\t} + 1}} = 5\bp{\frac{\e^{\i\t/2} - \e^{-\i\t/2}}{\e^{\i\t/2} + \e^{-\i\t/2}}} = 5\bp{\frac{2\i \sin{\t/2}}{2\cos{\t/2}}} = 5\i\tan \frac\t2.\]
\end{solution}
...
\begin{problem}
    ...
    \begin{enumerate}
        ...
        \item Given that 3 roots of the equation $z^6 = -64$ are $2\e^{\i \pi/6}$, $2\e^{\i\pi/2}$ and $2\e^{-\i(5\pi/6)}$, express $z^6 + 64$ as a product of three quadratic factors with real coefficients, giving each factor in non-trigonometric form.
