...
\begin{solution}
    ...
    We now calculate $\Var{\bar{X}}$. Observe that the means of $X$ and $\bar{X}$ are 0 by symmetry. Hence, \[\Var{\bar{X}} = \E{\ol{X}^2} = 2\bs{1^2\bp{\frac1{64}} + \bp{\frac23}^2 \bp{\frac3{32}} + \bp{\frac13}^2\bp{\frac{15}{64}}} = \frac16.\] Now, note that \[\Var{X} = \E{X^2} = 2\bs{1^2 \bp{\frac14}} = \frac12.\] Thus, \[\Var{\bar{X}} = \frac13 \Var{X}.\]
\end{solution}
