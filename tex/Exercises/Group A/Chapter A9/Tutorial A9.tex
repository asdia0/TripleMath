...
\begin{problem}
    ...
    \begin{enumerate}
        ...
        \item The plane passes through the point with position vector $7\vec i$ and is parallel to the plane $\vec r = (2 - p + q)\vec i + (p + 3q)\vec j + (-2-3q)\vec k$, where $p, q \in \RR$.
        \item The plane contains the line $l : \vec r = (-2\vec i + 5\vec j -3\vec k) + \l(2\vec i + \vec j + 2\vec k)$, where $\l \in \RR$, and is perpendicular to the plane $\pi : \vec r \dotp (7\vec i + 4\vec j + 5\vec k) = 2$.
    \end{enumerate}
\end{problem}
\begin{solution}
    \begin{ppart}
        \bd{Parametric.}
        Note that $\cveciiix04{-2}$ is parallel to $\cveciiix02{-1}$. Hence, the plane has parametric form \[\vec r = \cveciii72{-3} + \l\cveciii130 + \m\cveciii02{-1}, \quad \l, \m \in \RR.\]

        \bd{Scalar Product.}
        Note that \[\vec n = \cveciii130 \crossp \cveciii02{-1} = \cveciii{-3}12 \quad \tand \quad d = \cveciii72{-3} \dotp \vec n = -25,\] so the plane has scalar product form \[\vec r \dotp \cveciii{-3}12 = -2.\]

        \bd{Cartesian.} From the scalar product form, we have $-3x + y + 2z = -25$.
    \end{ppart}
    \begin{ppart}
        \bd{Parametric.} Since the plane passes through the points $A$, $B$ and $C$, it is parallel to both $\oa{AB} = -\cveciiix11{-1}$ and $\oa{AC}= \cveciiix{-1}30$. Hence, the plane has parametric form \[\vec r = \cveciii201 + \l\cveciii11{-1} + \m\cveciii{-1}30, \quad \l, \m \in \RR.\]

        \bd{Scalar Product.} Note that \[\vec n = \cveciii11{-1} \crossp \cveciii{-1}30 = \cveciii314 \quad \tand \quad d = \cveciii201 \dotp \vec n = 10,\] so the plane has scalar product form \[\vec r \dotp \cveciii314 = 10.\]

        \bd{Cartesian.} From the scalar product form, we have $3x + y + 4z = 10$.
    \end{ppart}
    \begin{ppart}
        \bd{Parametric.} Note that the plane is parallel to \[\vec r = \cveciiix20{-1} + p\cveciiix{-1}10 + q\cveciiix13{-3}, \quad  p, q \in \RR\] and passes through $(7, 0, 0)$. Hence, the plane has parametric form \[\vec r = \cveciii700 + \l\cveciii{-1}10 + \m\cveciii13{-3}, \quad \l, \m \in \RR.\]

        \bd{Scalar Product.} Note that \[\cveciii{-1}10 \crossp \cveciii13{-3} = \cveciii{-3}{-3}{-4},\] which is parallel to $\cveciiix334$. Take $\vec n = \cveciiix334$, so \[d = \cveciii700 \dotp \vec n = 21.\] Hence, the plane has scalar product form \[\vec r \dotp \cveciii334 = 21.\]

        \bd{Cartesian.} From the scalar product form, we have $3x + 3y + 4z = 21$.
    \end{ppart}
    \begin{ppart}
        \bd{Parametric.} Since the line with equation \[\vec r = \cveciiix{-2}5{-3} + \l\cveciiix212, \quad \l \in \RR,\] lies on the plane, it follows that the plane passes through $(-2, 5, -3)$ and is parallel to the vector $\cveciiix212$. Furthermore, since the plane is perpendicular to the plane with normal $\cveciiix745$, it must be parallel to said vector. Thus, the plane has parametric form \[\vec r = \cveciii{-2}5{-3} + \l\cveciii212 + \m\cveciii745, \quad \l, \m \in \RR.\]

        \bd{Scalar Product.} Note that \[\vec n = \cveciii212 \crossp \cveciii745 = \cveciii{-3}41 \quad \tand \quad d = \cveciii{-2}5{-3} \dotp \vec n = 23,\] so the plane has scalar product form \[\vec r \dotp \cveciii{-3}41 = 23.\]

        \bd{Cartesian.} From the scalar product form, we have $-3x + 4y + z = 23$.
    \end{ppart}
\end{solution}
...
\end{problem}
\begin{solution}
    Note that $\oa{AB} = -\cveciiix3{-1}3$. Thus, the line $l$ has vector equation \[\vec r = \cveciii124 + \l\cveciii3{-1}3, \quad \l \in \RR.\]

    Also note that the equation of the plane $p$ can be written as \[\vec r \dotp \cveciii3{-1}2 = 17.\]

    \begin{ppart}
        Let $P$ be the point of intersection of $l$ and $p$. Since $P$ lies on the line $l$, we may write $\oa{OP} = \cveciiix124 + \l \cveciiix3{-1}3$ for some $\l \in \RR$. Since $P$ lies on the plane $p$, we have \[\bs{\cveciii124 + \l\cveciii3{-1}3} \dotp \cveciii3{-1}2 = 17,\] so $9 + 16\l = 17$ and thus $\l = 1/2$. Hence, \[\oa{OP} = \cveciii124 + \frac12\cveciii3{-1}3 = \cveciii{5/2}{3/2}{11/2},\] whence $P(5/2, 3/2, 11/2)$.

    \end{ppart}
    \begin{ppart}
        Let $\t$ be the acute angle between $l$ and $p$. Then \[\sin\t = \frac{\abs{\cveciiix3{-1}3 \dotp \cveciiix3{-1}2}}{\abs{\cveciiix3{-1}3} \abs{\cveciiix3{-1}2}} = \frac{16}{\sqrt{266}},\] whence $\t = 78.8 \deg \todp{1}$.
    \end{ppart}
    \begin{ppart}
        Note that $\oa{AP} = (1/2)\cveciiix3{-1}3$. The perpendicular distance from $A$ to $p$ is hence \[\abs{\oa{AP} \dotp \hat{\vec n}} = \frac{\abs{\frac12\cveciiix3{-1}3 \dotp \cveciiix3{-1}2}}{\abs{\cveciiix3{-1}2}} = \frac8{\sqrt{14}} \units.\]
    \end{ppart}
    \begin{ppart}
        Let $F$ be the foot of the perpendicular from $B$ to $p$. Since $F$ is on $p$, we have $\oa{OF} \dotp \cveciiix3{-1}2 = 17$. Furthermore, since $BF$ is perpendicular to $p$, we have $\oa{BF} = \l \vec n = \l \cveciiix3{-1}2$ for some $\l \in \RR$. We hence have $\oa{OF} = \oa{OB} + \oa{BF} = \cveciiix{-2}31 + \l \cveciiix3{-1}2$. Thus, \[\bs{\cveciii{-2}31 + \l \cveciii3{-1}2} \dotp \cveciii3{-1}2 = 17,\] so $-7 + 14\l = 17$, whence $\l = 12/7$. Hence, \[\oa{OF} = \cveciii{-2}31 + \frac{12}7 \cveciii3{-1}2 = \frac17\cveciii{22}9{31}.\]
    \end{ppart}
    \begin{ppart}
        Note that $m$ has the vector equation \[\vec r_m = \cveciii610 + \l \cveciii021, \quad \l \in \RR.\] Consider $\vec r_m \dotp \vec n$: \[\vec r_m \dotp \vec n = \bs{\cveciii610 + \l \cveciii021} \dotp \cveciii3{-1}2 = 17.\] Since $\vec r_m \dotp \vec n = 17$ for all $\l \in \RR$, it follows that $m$ lies in $p$.
    \end{ppart}
\end{solution}
...
\begin{solution}
    ...
    \end{ppart}
    \begin{ppart}
        We have $d = \vec r \dotp \vec n = \bp{\vec a + t\vec b} \dotp \vec n = \vec a \dotp \vec n + t\bp{\vec b \dotp \vec n}$, so \[t = \frac{d - \vec a \dotp \vec n}{\vec b \dotp \vec n},\] whence \[\vec r = \vec a + \bp{\frac{d - \vec a \dotp \vec n}{\vec b \dotp \vec n}} \vec b\] is the position vector of the point of intersection of the line and plane.
    \end{ppart}
\end{solution}
...
\begin{solution}
    \begin{ppart}
        Let $\t$ the acute angle between $p_1$ and $p_2$. Then \[\cos\t = \frac{\abs{\cveciiix2{-2}1 \dotp \cveciiix{-6}32}}{\abs{\cveciiix2{-2}1} \abs{\cveciiix{-6}32}} = \frac{16}{21},\] so $\t = 40.4 \deg \todp{1}$.
    \end{ppart}
    \begin{ppart}
        Observe that $p_1$ has the Cartesian equation $2x-2y+z = 1$ and $p_2$ has the Cartesian equation $-6x + 3y + 2z = -1$. Solving both Cartesian equations simultaneously gives the family of solutions \[x = -\frac16 + \frac76t, \quad y = -\frac23 + \frac53 t, \quad z = t,\] where $t \in \RR$. The line $l$ thus has vector equation \[\vec r = \cveciii{x}{y}{z} = -\frac16\cveciii140 + t\cveciii7{10}6, \quad t \in \RR.\]
    \end{ppart}
    \begin{ppart}
        Let $Q$ be the point with position vector $-(1/6)\cveciiix140$. Then $\oa{AQ} = -(1/6)\cveciiix{25}{22}{6c}$. Since $Q$ lies on $l$, it lies on both $p_1$ and $p_2$. Since $A$ is equidistant to $p_1$ and $p_2$, the perpendicular distances from $A$ to $p_1$ and $p_2$ are equal.

        The perpendicular distance from $A$ to $p_1$ is given by \[\frac{\abs{\oa{AQ} \dotp \cveciiix2{-2}1}}{\abs{\cveciiix2{-2}1}} = \frac13 \abs{-\frac16 \cveciii{25}{22}{6c} \dotp \cveciii2{-2}1} = \frac13 \abs{1 + c}.\] Meanwhile, the perpendicular distance from $A$ to $p_2$ is given by: \[\frac{\abs{\oa{AQ} \dotp \cveciiix{-6}32}}{\abs{\cveciiix{-6}32}} = \frac17 \abs{-\frac16 \cveciii{25}{22}{6c} \dotp \cveciii{-6}32} = \frac17 \abs{-14 + 2c}.\] Equating the two gives \[\frac13 \abs{1 + c} = \frac17 \abs{-14 + 2c},\] so $\abs{7 + 7c} = \abs{-42 + 6c}$. This splits into two cases: if $7+7c = -42+6c$, then $c = -49$; else if $7+7c = -(-42+6c)$, then $c = -35/13$.
    \end{ppart}
\end{solution}
...
\begin{solution}
    \begin{ppart}
        Let $l$ be the required line. Since $l$ is normal to $\Pi$, it is parallel to $\cveciiix230$, the normal vector of $\Pi$. Thus, $l$ has vector equation \[l: \vec r = \cveciii214 + \l\cveciii230, \quad \l \in \RR.\]
    \end{ppart}
    \begin{ppart}
        Since $Q$ is on $\Pi$, we have $\oa{OQ} \dotp \cveciiix230 = -6$. Since $Q$ is on the line $l$, we may write $\oa{OQ} = \cveciiix214 + \l\cveciiix230$ for some $\l \in \RR$. Hence, \[\bs{\cveciii214 + \l\cveciii230} \dotp \cveciii230 = -6.\] This gives $7 + 13\l = -6$, whence $\l = -1$. Thus, \[\oa{OQ} = \cveciii214 - \cveciii230 = \cveciii0{-2}4.\]

        Let the reflection of $P$ in $\Pi$ be $P'$. By the midpoint theorem, \[\oa{OQ} = \frac{\oa{OP} + \oa{OP'}}{2},\] so \[\oa{OP'} = 2\oa{OQ} - \oa{OP} = 2\cveciii0{-2}4 - \cveciii214 = \cveciii{-2}{-5}4.\]
    \end{ppart}
    \begin{ppart}
        Let $\t$ be the acute angle between $OQ$ and $\Pi$. Then \[\sin\t = \frac{\abs{\cveciiix0{-2}4 \dotp \cveciiix230}}{\abs{\cveciiix0{-2}4} \abs{\cveciiix230}} = \frac{3}{\sqrt{65}}.\]
    \end{ppart}
    \begin{ppart}
        Let $\oa{OA} = \cveciiix{x}{y}{z}$. From \[\oa{OA} \dotp \cveciii230 = -6, \quad \oa{OA} \dotp \cveciii111 = 5, \quad \oa{OA} \dotp \cveciiix100 = 0,\] we obtain the following system of equations: \[\systeme{2x+3y=-6,x+y+z=5,x=0}\] whence $x = 0$, $y = -2$ and $z = 7$, so $\oa{OA} = \cveciiix0{-2}7$.
    \end{ppart}
    \begin{ppart}
        Let the line of intersection of $\Pi$ and $\Pi'$ be $l'$. Observe that $A$ is on $\Pi$ and $\Pi'$ and thus lies on $l'$. Hence, $l'$ has equation \[\vec r = \cveciii0{-2}7 + \l\vec b, \quad \l \in \RR.\] Since $l'$ lies on both $\Pi$ and $\Pi'$, $\vec b$ is perpendicular to the normals of both planes, i.e. $\cveciiix230$ and $\cveciiix111$. Thus, \[\vec b = \cveciii230 \crossp \cveciii111 = \cveciii3{-2}{-1},\] whence the equation of $l'$ becomes \[l': \vec r = \cveciii0{-2}7 + \l\cveciii3{-2}{-1}, \quad \l \in \RR.\]
    \end{ppart}
\end{solution}
...
\begin{problem}
    ...
    The diagram shows a garden shed with horizontal base $ABCD$, where $AB = 3$ m and $BC = 2$ m. There are two vertical rectangular walls $ABFE$ and $DCGH$, where $AE = BF = CG = DH = 2$ m. The roof consists of two rectangular planes $EFML$ and $HGML$, which are inclined at an angle $\t$ to the horizontal such that $\tan \t = 3/4$.
...
\begin{solution}
    \begin{ppart}
        ...
        \end{align*}            
        Since $\oa{AB}$, $\oa{AD}$ and $\oa{AM}$ satisfy the equation $\vec r \dotp \cveciiix{22}{33}{-12} = 66$, the points $B$, $D$ and $M$ all lie on the plane with said equation.
    \end{ppart}
    \begin{ppart}
    ...
    \end{ppart}
    \begin{ppart}
        Observe that $\oa{EM} = \oa{AM} - \oa{AE} = (1/4) \cveciiix{12}43$. Hence, the line $EM$ has vector equation \[\vec r = \cveciii002 + \l \cveciii{12}43, \quad \l \in \RR.\]
    \end{ppart}
    \begin{ppart}
...
\begin{problem}
    The planes $\pi_1$ and $\pi_2$ have equations \[x + y - z = 0 \quad \tand \quad 2x-4y+z+12=0\] respectively. The point $P$ has coordinates $(3, 8, 2)$ and $O$ is the origin.
...
\begin{solution}
    ...
    \begin{ppart}
        Observe that \[\cveciii112 \dotp \cveciii11{-1} = \cveciii112 \dotp \cveciii2{-4}1 = 0.\] Thus, the vector $\cveciiix112$ is perpendicular to the normal vectors of both $\pi_1$ and $\pi_2$ and is hence parallel to them.
    \end{ppart}
    \begin{ppart}
        Let the required plane be $\pi_3$. Since $\pi_3$ is perpendicular to both $\pi_1$ and $\pi_2$, its normal vector is parallel to both planes. Thus, \[\vec n = \cveciii112 \quad \tand \quad d = \cveciiix382 \dotp \vec n = 15.\] Thus, the plane $\pi_3$ has the vector equation \[\vec r \dotp \cveciii112 = 15.\]
    \end{ppart}
    \begin{ppart}
        Since \[\cveciii044 \dotp \cveciii11{-1} = 0 \quad \tand \quad \cveciii044 \dotp \cveciii2{-4}1 = -12,\] the vector $(0, 4, 4)$ satisfies the vector equation of both $\pi_1$ and $\pi_2$ and thus lies on both planes.

        Let $l$ be the line of intersection of $\pi_1$ and $\pi_2$. Since $(0, 4, 4)$ is a point common to both planes, $l$ passes through it. Furthermore, since $l$ lies on both $\pi_1$ and $\pi_2$, it is perpendicular to the normal vector of both planes and hence has direction vector $\cveciiix11{-1} \crossp \cveciiix2{-4}1 = -3\cveciiix112$. Thus, $l$ can be expressed as \[l : \vec r = \cveciii044 + \l\cveciii112, \quad \l \in \RR.\]
    \end{ppart}
    \begin{ppart}
        Note that the line $OP$, denoted $l_{OP}$ has equation \[l_{OP} : \vec r = \m \cveciii382, \quad \m \in \RR.\] Let $A$ be the point of intersection between $l_{OP}$ and $\pi_2$. Since $A$ lies on $l_{OP}$, we may write \[\oa{OA} = \m \cveciii382\] for some real $\m$. Since $A$ lies on $\pi_2$, we have \[\m \cveciii382 \dotp \cveciii2{-4}1 = -12,\] so $-24\m = -12$, whence $\m = \frac12$. Hence, \[\oa{OA} = \frac12 \cveciii382 = \cveciii{3/2}41,\] so $OP$ meets $\pi_2$ at $(3/2, 4, 1)$.
    \end{ppart}
    \begin{ppart}
...
\begin{solution}
    \begin{ppart}
        Note that $l_1$ and $l_2$ have vector equations \[\vec r = \cveciii3{-5}{-4} + \l\cveciii342 \quad \tand \quad \vec r = \cveciii235 + \m\cveciii1{-1}{-4}\] respectively, where $\l, \m \in \RR$. Since $PQ$ is perpendicular to both $l_1$ and $l_2$, it is parallel to \[\cveciii342 \crossp \cveciii1{-1}{-4} = \cveciii{-14}{14}{-7} = -7\cveciii2{-2}1.\]
    \end{ppart}
    \begin{ppart}
        Since $\Pi$ contains $PQ$ and $l_1$, it is parallel to $\cveciiix2{-2}1$ and $\cveciiix342$. Also note that $\Pi$ contains $\cveciiix3{-5}{-4}$. Thus, \[\Pi : \vec r = \cveciii3{-5}{-4} + \l \cveciii2{-2}1 + \m \cveciii342, \quad \l, \m \in \RR.\] Note that also that \[\cveciii2{-2}1 \crossp \cveciii342 = \cveciii{-8}{-1}{14},\] which is parallel to $\cveciiix81{-14}$. Take $\vec n = \cveciiix81{-14}$, whence \[d = \cveciii3{-5}{-4} \dotp \vec n = 75.\] Thus, $\Pi$ is also given by \[\Pi: \vec r \dotp \cveciii81{-14} = 75.\]
    \end{ppart}
    \begin{ppart}
    ...
    \end{ppart}
    \begin{ppart}
        Let $\t$ be the acute angle between $\Pi$ and $l_2$. Then \[\sin\t = \frac{\abs{\cveciiix1{-1}{-4} \dotp \cveciiix81{-14}}}{\abs{\cveciiix1{-1}{-4}} \abs{\cveciiix81{-14}}} = \frac{7}{\sqrt{58}},\] so $\t = 66.8 \deg \todp{1}$.
    \end{ppart}
    \begin{ppart}
        Since $P$ is on $l_1$, we have \[\oa{OP} = \cveciii3{-5}{-4} + \l\cveciii342\] for some real $\l$. Similarly, since $Q$ is on $l_2$, we have \[\oa{OQ} = \cveciii235 + \m\cveciii1{-1}4\] for some real $\m$. Thus, \[\oa{PQ} = \oa{OQ} - \oa{OP} = \cveciii{-1}89 - \l\cveciii342 + \m\cveciii1{-1}{-4}.\] Recall that $PQ$ is parallel to $\cveciiix2{-2}1$. Hence, $\oa{PQ}$ can be expressed as $\nu \cveciiix2{-2}1$ for some $\nu \in \RR$. Equating the two expressions for $\oa{PQ}$, we obtain \[\cveciii{-1}89 - \l\cveciii342 + \m\cveciii1{-1}{-4} = \nu \cveciii2{-2}1.\] This gives the system \[\systeme[\l\m\n]{3\l - \m + 2\n = -1,4\l + \m -2\n = 8,2\l + 4\m + \n = 9}\] which has the unique solution $\l = 1$, $\m = 2$ and $\n = -1$. Thus, \[\oa{OP} = \cveciii3{-5}{-4} + \cveciii342 = \cveciii6{-1}{-2}, \quad \oa{OQ} = \cveciii235 + 2\cveciii1{-1}{-4} = \cveciii41{-3}.\]
    \end{ppart}
\end{solution}

\begin{problem}
    The equations of three planes $p_1$, $p_2$ and $p_3$ are \[\systeme[xyz]{2x-5y+3z=3,3x+2y-5z=-5,5x+\l y + 17z=\m}\] respectively, where $\l$ and $\m$ are constants. The planes $p_1$ and $p_2$ intersect in a line $l$.
...
\begin{solution}
    \begin{ppart}
        Consider the intersection of $p_1$ and $p_2$: \[\systeme{2x-5y+3z= 3,3x+2y-5z=-5}\] The above system has the family of solutions $x = -1 + t$, $y = -1 + t$ and $z = t$, where $t \in \RR$. Thus, the line $l$ has vector equation \[l : \vec r = \cveciii{-1}{-1}0 + t \cveciii111, \quad t \in \RR.\]
    \end{ppart}
    \begin{ppart}
        Since all three planes meet in the line $l$, $l$ must satisfy the equation of $p_3$. Substituting the above solution to the given equation, we have $5(-1 + t) + \l(-1 + t) + 17t = \m$. Rearranging, we get $(22+\l)t - (5+\l+\m) = 0$. Comparing the coefficients of $t$ and the constant terms, we have the following system: \[\systeme[\l\m]{22 + \l = 0,5 + \l + \m = 0}\] which has the unique solution $\l = -22$ and $\m = 17$.
    \end{ppart}
    \begin{ppart}
    ...
    \end{ppart}
    \begin{ppart}
        Note that $\cveciiix{-1}{-1}0$ lies on $l$ and is thus contained on the required plane. Observe that $\cveciiix{-1}{-1}0 - \cveciiix1{-1}3 = \cveciiix{-2}0{-3}$. Thus, the required plane is parallel to $\cveciiix111$ and $\cveciiix{-2}0{-3}$ and hence has vector equation \[\vec r = \cveciii{-1}{-1}0 + \l\cveciii111 + \m\cveciii{-2}0{-3}, \quad \l, \m \in \RR.\] Since \[\vec n = \cveciii111 \crossp \cveciii{-2}03 = \cveciii{-3}12 \quad \tand \quad d = \cveciiix{-1}{-1}0 \dotp \vec n= 2,\] the required plane has the equation \[\vec r \dotp \cveciii{-3}12 = 2\] and thus has Cartesian equation $-3x + y + 2 = 2$.
    \end{ppart}
\end{solution}
...
\begin{solution}
    \begin{ppart}
        Consider the intersection of $p_1$ and $p_2$. This gives the system \[\systeme{x-2y+2z=0,2x-2y+z=0}\] which has solution $x = t$, $y = 3t/2$ and $z = t$, where $t \in \RR$. Thus, $l$ has Cartesian equation \[x = \frac23 y = z.\]
    \end{ppart}
    \begin{ppart}
...
\begin{solution}
    ...
    \end{ppart}
    \begin{ppart}
        Let the point of intersection between $l_{PV}$ and the screen be $I$. Since $I$ lies on the line $l_{PV}$, we may rewrite \[\oa{OI} = \cveciii{20}{-4}0 + \l\cveciii{-10}2h\] for some real $\l$. Since $I$ lies on the screen, we have \[\bs{\cveciii{20}{-4}0 + \l\cveciii{-10}2h} \dotp \cveciii100 = \a,\] whence $20-10\l = \a$, so $\l = (20-\a)/10$. Thus, \[\oa{OI} = \cveciii{20}{-4}0 + \frac{20-\a}{10}\cveciii{-10}2h.\] To prevent the shadow from exceeding the screen, we require the $\vec k$-component of $\oa{OI}$ to be less than the height of the screen, i.e. 35 units. This gives the inequality $h(20-\a)/10 \leq 35$, whence we obtain \[h \leq \frac{350}{20 - \a}.\]
    \end{ppart}
    \begin{ppart}
    ...
    \end{ppart}
    \begin{ppart}
        Note that $\oa{BV} = 4\cveciiix{-1}15$ and $\oa{BC} = 8\cveciiix010$. Hence, the plane $VBC$ is parallel to $\cveciiix{-1}15$ and $\cveciiix010$. Note that \[\cveciii{-1}15 \crossp \cveciii010 = -\cveciii501.\] Take $\vec n = \cveciiix501$, so \[d = \cveciii00{20} \dotp \vec n = 20.\] Thus, the plane $VBC$ has the vector equation \[\vec r \dotp \cveciii501 = 20.\] 
        
        Observe that the ground is given by the vector equation $\vec r \dotp \cveciiix001 = 0$. Let $\t$ be the angle of inclination made by the mirror with the ground. Then \[\cos\t = \frac{\cveciiix501 \dotp \cveciiix001}{\abs{\cveciiix501}\abs{\cveciiix001}} = \frac1{\sqrt{26}},\] so $\t = 78.7 \deg \todp{1}$.
    \end{ppart}
\end{solution}