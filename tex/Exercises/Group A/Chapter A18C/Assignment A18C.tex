...
\begin{problem}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|}
            \hline
            & \bd{Authoritarian} & \bd{Democratic} & \bd{Laissez-faire} \\ \hline
            \bd{Male} & 12 & 22 & 9 \\ \hline
            \bd{Female} & 20 & 13 & 3 \\ \hline
        \end{tabular}
    \end{table}
...
\begin{solution}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|}
            \hline
            & \bd{Authoritarian} & \bd{Democratic} & \bd{Laissez-faire} \\ \hline
            \bd{Male} & 17.418 & 19.051 & 6.5316 \\ \hline
            \bd{Female} & 14.582 & 15.949 & 5.4684 \\ \hline
        \end{tabular}
    \end{table}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|}
            \hline
            & \bd{Authoritarian} & \bd{Democratic} & \bd{Laissez-faire} \\ \hline
            \bd{Male} & 1.6853 & 0.4565 & 0.9328 \\ \hline
            \bd{Female} & 2.0131 & 0.5453 & 1.1142 \\ \hline
        \end{tabular}
    \end{table}
...
\begin{problem}
    \begin{enumerate}
        ...
        \begin{tabular}{|c|c|c|c|c|c|c|}
            \hline
            \bd{Number of vehicles in the period} & 0 & 1 & 2 & 3 & 4 & 5 \\ \hline
            \bd{Frequency} & 24 & 36 & 28 & 8 & 3 & 1 \\ \hline
        \end{tabular}
        \end{table}
        \begin{enumerate}
        ...
        \begin{table}[H]
            ...
            \begin{tabular}{|c|c|c|c|c|}
                \hline
                \bd{Region} & North & South & East & West \\ \hline
                \bd{Channel 5} & 10 & 17 & $10 + a$ & $23 - a$ \\ \hline
                \bd{Channel 8} & 5 & 8 & $20 - a$ & $7 + a$ \\ \hline
            \end{tabular}
        \end{table}
    ...
    \begin{ppart}
        ...
        \begin{table}[H]
            ...
            \begin{tabular}{|c|c|c|c|c|}
                \hline
                \bd{Region} & North & South & East & West \\ \hline
                \bd{Channel 5} & 9 & 15 & 18 & 18 \\ \hline
                \bd{Channel 8} & 6 & 10 & 12 & 12 \\ \hline
            \end{tabular}
        \end{table}
        ...
        \end{align*}
        The critical value for a 5\% level of significance is $7.815$. Hence, to not reject \nullhyp, we require \[\frac{10a^2 - 130a + 479}{36} \leq 7.815,\] which gives $1.76 \leq a \leq 11.2$. Since $a$ is an integer, the required range of values of $a$ is $2 \leq a \leq 11$.
    \end{ppart}
\end{solution}
