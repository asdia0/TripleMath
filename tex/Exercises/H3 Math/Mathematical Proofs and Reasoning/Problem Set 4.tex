...
\end{problem}
\begin{proof}[Proof 1.]
    Observe that $\gcd{2n+1, 9n+4} = \gcd{2n+1, n} = \gcd{1, n} = 1$. The claim follows immediately from B\'ezout's identity.
\end{proof}
\begin{proof}[Proof 2.]
