...
\begin{solution}
    \begin{ppart}
        By way of contradiction, suppose $g(x_0) = 0$ for some $x \in (0, 2)$. Then $g(0) = g(x_0) = g(2) = 0$. By Rolle's Theorem, there exists some $x_1 \in (0, x_0)$ and $x_2 \in (x_0, 2)$ such that $g'(x_1) = 0$ and $g'(x_2) = 0$. Applying Rolle's Theorem once more, we see that there exists some $x_3 \in (x_1, x_2)$ such that $g''(x_3) = 0$, a contradiction. Thus, $g(x) \neq 0$ for all $x \in (0, 2)$.
    \end{ppart}
    \begin{ppart}
...
\begin{solution}
    \begin{ppart}
        \begin{figure}[H]\tikzsetnextfilename{445}
        \centering
