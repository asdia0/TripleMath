...
\begin{solution}
    \begin{ppart}
        ...
        \end{psubpart}
        \begin{psubpart}
            Let $b$ be a non-zero integer. Then \[f(x) = f\Big(\underbrace{\frac{x}{b} + \dots + \frac{x}{b}}_{\text{$b$ times}}\Big) = \underbrace{f\bp{\frac{x}{b}} + \dots + f\bp{\frac{x}{b}}}_{\text{$b$ times}} = b f\bp{\frac{x}{b}}.\] Thus, $f(x/b) = f(x)/b$. Let $r \in \QQ$. Without loss of generality, write $r = a/b$, where $a, b \in \ZZ$ and $b \geq 1$. Then \[f(rx) = f\bp{\frac{ax}{b}} = a f\bp{\frac{x}{b}} = \frac{a}{b} f(x) = rf(x).\]
        \end{psubpart}
        \begin{psubpart}
