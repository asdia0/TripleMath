...
\begin{solution}
    \begin{ppart}
        ...
        \begin{align*}
            ...
            &= \frac12 \bp{\frac1{1 + \tan[2]{x}/2}} \bp{\frac1{\cos^2 x}}\\
            &= \frac1{2 + \tan^2 x} \frac{1}{\cos^2 x}\\
            &=\frac1{2\cos^2 x + \sin^2 x}\\
            &= \frac1{1 + \cos^2 x}.
        \end{align*}
    \end{ppart}
    \begin{ppart}
        ...
        \begin{align*}
            ...
            &= \pi\int_0^{\pi/2} \frac{1}{1 + \cos^2 x} \d x\\
            &= \pi \evalint{\frac1{\sqrt2} \arctan{\frac{\tan x}{\sqrt2}}}0{\pi/2}.
        \end{align*}
        The $x = 0$ term vanishes, so \[I = \frac{\pi}{\sqrt2} \lim_{x \to \frac\pi2^{-}} \arctan \frac{\tan x}{\sqrt2}.\] As $x \to (\pi/2)^-$, $\tan x \to \infty$. Thus, $\arctan{\tan{x}/ \sqrt2} \to \pi/2$, whence \[I = \frac{\pi}{\sqrt2} \cdot \frac{\pi}{2} = \frac{\pi^2}{2\sqrt2}.\]
    \end{ppart}
\end{solution}
...
\end{problem}\begin{solution}
    \begin{ppart}
        Note that
        \begin{align*}
            I_n &= \int_{0}^{\pi/2} \sin^2 x \sin^{n-2} x \d x\\
            &= \int_0^{\pi/2} \bp{1 - \cos^2 x} \sin^{n-2} \d x \\
            &= I_{n-2} - \int_0^{\pi/2} \cos x \bp{\cos x \sin^{n-2} x} \d x.
        \end{align*}
        Integrating by parts, we obtain
        \begin{align}
            I_n &= I_{n-2} - \bp{\evalint{\frac{\cos x \sin^{n-1} x}{n-1}}0{\pi/2} + \frac1{n-1} \int_0^{\pi/2} \sin^{n} x \d x}\\
            &= I_{n-2} - \frac1{n-1} I_n.
        \end{align}
        Rearranging, we obtain \[I_n = \frac{n-1}{n} I_{n-2}.\]
    \end{ppart}
    \begin{ppart}
    ...
    \end{ppart}
    \begin{ppart}
        From (a), we see that \[I_{2n+2} = \frac{2n+1}{2n+2} I_{2n},\] so \[\frac{I_{2n+2}}{I_{2n}} = \frac{2n+1}{2n+2}.\]
    \end{ppart}
    \begin{ppart}
...
\begin{solution}
    \begin{ppart}
        By partial fraction decomposition, we may rewrite the integrand as \[\frac{3x-1}{4x^3 - x^2} = \frac1{x^2} - \frac1{x \bp{4x-1}}.\] Completing the square on the denominator of the last term, we obtain \[\frac{3x-1}{4x^3 - x^2} = \frac1{x^2} - \frac1{(2x - 1/4)^2 - (1/4)^2}.\]
        
        Let $I$ be the target integral. Then \[I = \int_1^\infty \frac{3x-1}{4x^3 - x^2} \d x = \int_1^\infty \frac1{x^2} \d x - \int_1^\infty \frac1{(2x - 1/4)^2 - (1/4)^2} \d x.\] The first integral sorts out to 1. Applying the substitution $u = 2x - 1/4$ to the second integral, we have \[I = 1 - \frac12 \int_{7/4}^\infty \frac1{u^2 - (1/4)^2} \d u = 1 - \frac12 \evalint{\frac1{2(1/4)} \ln{\frac{u - 1/4}{u + 1/4}}}{7/4}\infty = 1 - \ln \frac43.\]
    \end{ppart}
    \begin{ppart}
...
\begin{solution}
    \begin{ppart}
        Clearly, the integral $\int_0^\infty 1/x \d x$ diverges. Since \[\lim_{x \to \infty} \frac{1/\sqrt{x^2 + 1}}{1/x} = 1,\] by the limit comparison test, it follows that the given integral also diverges.
    \end{ppart}
    \begin{ppart}
