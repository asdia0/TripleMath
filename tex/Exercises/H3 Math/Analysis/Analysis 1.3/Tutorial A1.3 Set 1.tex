...
\begin{solution}
    \begin{ppart}
        ...
        \begin{align*}
            I &= \int_1^\infty \frac{3x-1}{4x^3 - x^2} \d x\\
            &= \int_1^\infty \frac{3x-1}{x^2 \bp{4x - 1}} \d x\\
            &= \int_1^\infty \bp{\frac{4x-1}{x^2 \bp{4x-1}} - \frac{x}{x^2 \bp{4x-1}}} \d x \\
            &= \int_1^\infty \frac1{x^2} \d x - \int_1^\infty \frac1{x \bp{4x-1}} \d x\\
            &= \evalint{-\frac1x}1\infty - \int_1^\infty \frac1{x \bp{4x-1}} \d x\\
            &= 1 - \int_1^\infty \frac1{x \bp{4x-1}} \d x\\
            &= 1 - \int_1^\infty \frac1{(2x - 1/4)^2 - (1/4)^2} \d x.
        \end{align*}
