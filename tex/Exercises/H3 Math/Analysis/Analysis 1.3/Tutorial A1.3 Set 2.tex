...
\begin{problem}
    ...
    \begin{enumerate}
        ...
        \item Show that for $n \in \ZZ^+$, \[\int_{-\infty}^n \floor{g(x)} \d x = a \ln b - \ln{b!} + \frac{n(n-c)}{2},\] where $a$, $b$ and $c$ are integers to be determined.
    \end{enumerate}
\end{problem}
\begin{solution}
    \begin{ppart}
    ...
    \begin{ppart}
        ...
        Putting everything together, we see that \[\int_{-\infty}^n \floor{g(x)} \d x = 2014 \ln 2014 - \ln 2014! + \frac{n(n-3)}{2},\] whence $a = 2014$, $b = 2014$ and $c = 3$.
    \end{ppart}
\end{solution}