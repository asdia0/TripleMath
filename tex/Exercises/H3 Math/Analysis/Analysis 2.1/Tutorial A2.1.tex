...
\begin{problem}
    ...
    \begin{table}[H]
        \begin{tabularx}{0.9\linewidth}{@{}l *3{>{\centering\arraybackslash}X}@{}}
            (a)  & (b) , & (c) $\displaystyle\lim_{n \to \infty} \bp{1 - \frac1n}^n$.
        \end{tabularx}
    \end{table}
\end{problem}
\begin{solution}
...
\begin{solution}
    \begin{ppart}
        We have \[\lim_{t \to 6} 8(t-5)(t-7) = 8(6-5)(6-7) = -8.\]
    \end{ppart}
    \begin{ppart}
        We have \[\lim_{y \to -3} (5-y)^{4/3} = (5 - (-3))^{4/3} = 16.\]
    \end{ppart}
    \begin{ppart}
        We have \[\lim_{y \to 2} \frac{y+2}{y^2 + 5y + 6} = \frac{2 + 2}{2^2 + 5(2) + 6} = \frac15.\]
    \end{ppart}
    \begin{ppart}
        Observe that \[\lim_{h \to 0} \frac{\sqrt{5h + 4} - 2}{h} = \evalder{\der{}{x} \sqrt{5x + 4}}{x = 0} = \evalder{\frac5{2\sqrt{5x + 4}}}{x=0} = \frac54.\]
    \end{ppart}
    \begin{ppart}
        We have \[\lim_{u \to 0} \frac{u^4 - 1}{u^3 - 1} = \frac{-1}{-1} = 1.\]
    \end{ppart}
    \begin{ppart}
...
\begin{problem}
    Suppose that \[\lim_{x \to 4} \frac{f(x) - 5}{x-2} = 1.\] Find the value of $\lim_{x \to 4} f(x)$.
\end{problem}
\begin{solution}
    We have \[\lim_{x \to 4} \frac{f(x) - 5}{x-2} = \frac{\lim_{x \to 4} f(x) - 5}{4 - 2} = 1,\] so $\lim_{x \to 4} f(x) = 7$.
\end{solution}

\begin{problem}
    Suppose that \[\lim_{x \to 0} \frac{f(x)}{x^2} = 1.\] Find the values of \[\lim_{x \to 0} \frac{f(x)}{x} \quad \tand \quad \lim_{x \to 0} f(x).\]
\end{problem}
\begin{solution}
...
\begin{solution}
    ...
    \end{ppart}
    \begin{ppart}
        We have \[\lim_{t \to 4^+} \bp{t - \floor{t}} = 4 - 4 = 0.\]
    \end{ppart}
    \begin{ppart}
        We have \[\lim_{t \to 4^-} \bp{t - \floor{t}} = 4 - 3 = 1.\]
    \end{ppart}
    \begin{ppart}
        Observe that
        \begin{align*}
...
\end{problem}
\begin{solution}
    Equating the left and right limits at $x = 0$, we get \[b = \lim_{x \to 0^-} g(x) = \lim_{x \to 0^+} g(x) = 3a - b.\] Equating the left and right limit at $x = 2$, we get \[4 + 3a - b = \lim_{x \to 2^-} g(x) = \lim_{x \to 2^+} g(x) = 1.\] Solving these two linear equations simultaneously, we get $a = b = -3/2$.
\end{solution}

\begin{problem}
    For what values of $a$ and $b$ is \[f(x) = \begin{cases}
        \bp{\sin x - a}\bp{\cos x - b}/\bp{\e^x - 1}, & x \neq 0,\\
        5, & x = 0
    \end{cases}\] continuous at every $x$?
\end{problem}
\begin{ppart}
