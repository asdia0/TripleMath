...
\begin{solution}
    Observe that
    \begin{align*}
        &\frac{r+1}{r} \bp{\frac{\comb{n+r}{r+1}}{\comb{n+r-1}{r}} - \frac{\comb{n+r}{r+1}}{\comb{n+r}{r}}}\\
        &\hspace{2em}= \frac{r+1}{r} \bp{\frac{(n+r)! \, / \, (r+1)! \, (n-1)!}{(n+r-1)! \, / \, r! \, (n-1)!} - \frac{(n+r)! \, / \, (r+1)! \, (n-1)!}{(n+r)! \, / \, r! \, n!}}\\
        &\hspace{2em}= \frac{r+1}{r} \bp{\frac{n+r}{r+1} - \frac{n}{r+1}} \\
        &\hspace{2em}= \frac{n+r}{r} - \frac{n}{r}\\
        &\hspace{2em}= 1.
    \end{align*}
