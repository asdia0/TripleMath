...
\begin{solution}
    \begin{ppart}
        Note that $\oa{OC} = m\oa{OA} = m \vec a$, so $\oa{AC} = m \vec a - \vec a = (m-1) \vec a$. By the Ratio Theorem, \[\oa{OB} = \frac{\oa{OD} + 2\oa{OA}}{1 + 2}.\] Hence, $\oa{OD} = 3\oa{OB} - 2\oa{OA} = 3\vec b - 2 \vec a$, so $\oa{AD} = 3\vec b - 3\vec a$. Thus,
        \begin{align*}
    ...
    \begin{ppart}
        ...
        Since $\oa{AC}$ is a unit vector, we have $\abs{(m-1) \vec a} = 1$, so \[m = 1 \pm \frac1{\abs{\vec a}}.\]
    \end{ppart}
\end{solution}
...
\begin{solution}
    \begin{ppart}
        We have the recurrence relation $u_n = 0.93^7 u_{n-1} + 2.3$, with initial value $u_0 = 0$.
...
\begin{solution}
    \begin{ppart}
        ...
        Thus, \[\oa{AF} = \bs{\cveciii12{-3} + \l \cveciii{2}{-2}{1}} - \cveciii3{-2}{-6} = \cveciii{-2}43 + \l \cveciii{2}{-2}{1}.\] Note also that $\oa{AF}$ is perpendicular to $l_1$. Hence, \[\bs{\cveciii{-2}43 + \l \cveciii{2}{-2}{1}} \cdot \cveciii2{-2}1 = -9 + 9\l = 0,\] so $\l = 1$. Thus, \[\oa{OF} = \cveciii12{-3} + \cveciii{2}{-2}{1} = \cveciii30{-2}.\]
    \end{ppart}
    \begin{ppart}
    ...
    \end{ppart}
    \begin{ppart}
        Observe that $l_3$ passes through the midpoint of $\cveciiix12{-3}$ and $\cveciiix{-1}6{-1}$, which evaluates to \[\frac12 \bs{\cveciii12{-3} + \cveciii{-1}6{-1}} = \cveciii04{-2}.\] $l_3$ is also parallel to both $l_1$ and $l_2$. Hence, $l_3$ has vector equation \[\vec r = \cveciii04{-2} + \n \cveciii2{-2}1, \quad \n \in \RR.\]
    \end{ppart}
\end{solution}
...
\begin{solution}
    \begin{ppart}
        ...
        \end{align*}
        Cancelling terms from the RHS, we get \[\frac{v_{n+1}}{v_{n-1}} -10 \bp{\frac{v_n}{v_{n-1}}} = -16,\] giving the recurrence relation $v_{n+1} - 10v_n + 16v_{n-1} = 0$. Hence, $a = -10$.
    \end{ppart}
    \begin{ppart}
        ...
        From $u_1 = 1$, we see that \[\frac32 = u_1 + \frac12 = \frac{v_1}{v_0} = \frac{2A + 8B}{A + B},\] so $A = -13B$.
