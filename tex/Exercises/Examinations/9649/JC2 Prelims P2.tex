...
\begin{solution}
    ...
    \begin{ppart}
        ...
        \begin{table}[H]
            ...
            1 & 2.13401 &  & 6 & 2.224735 \\ \cline{1-2} \cline{4-5} 
            2 & 2.193347 &  & 7 & 2.225030 \\ \cline{1-2} \cline{4-5} 
            3 & 2.214178 &  & 8 & 2.225131 \\ \cline{1-2} \cline{4-5} 
            4 & 2.221392 &  & 9 & 2.225166 \\ \cline{1-2} \cline{4-5} 
            5 & 2.223879 &  & 10 & 2.225178 \\ \cline{1-2} \cline{4-5} 
            \end{tabular}
        \end{table}
...
\begin{solution}
    ...
    \end{ppart}
    \begin{ppart}
        When $t = 2$, we have $N = 25P_0$ and $P = 5P_0$. Substituting this into the above expression yields \[5P_0 = \frac{25P_0^2)}{P_0 + 24P_0\e^{-2k}}.\] Since $P_0 \neq 0$, we may divide both sides by $P_0$ to get \[5 = \frac{25}{1 + 24\e^{-2k}},\] which gives $k = \ln{6}/2$.
    \end{ppart}
    \begin{ppart}
        Consider the critical points of $P$. Setting $\derx{P}{t} = 0$, we get \[kP\bp{1 - \frac{P}{N}} - HP = 0\] so $P = 0$ or $P = (N/k) (k-H)$. In order for the critical point at $P = 0$ to be stable (hence eradicating the tumour), we must have $(N/k) (k-H) < 0$. Since $N$ and $k$ are positive constants, we must have $H > k$.
    \end{ppart}
\end{solution}
...
\begin{problem}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|}
        \hline
        \bd{Reliability, $R$ (hours)} & \bd{Observed Frequency} \\ \hline\hline
        $R < 2000$ & 53 \\ \hline
...
\begin{solution}
    ...
    \begin{ppart}
        ...
        \begin{table}[H]
            ...
            \begin{tabular}{|c|c|c|}
            \hline
            \bd{Reliability, $R$ (hours)} & \bd{$E_i$} & \bd{$O_i$} \\ \hline\hline
...
\begin{problem}
    ...
    \begin{table}[H]
        ...
        \cline{1-3} \cline{5-7}
        \bd{User} & \bd{Before} & \bd{After} &  & \bd{User} & \bd{Before} & \bd{After} \\ \cline{1-3} \cline{5-7} 
        1 & 70.0 & 73.2 &  & 7 & 66.4 & 71.9 \\ \cline{1-3} \cline{5-7} 
        2 & 65.5 & 69.0 &  & 8 & 75.0 & 72.0 \\ \cline{1-3} \cline{5-7} 
        3 & 75.1 & 72.4 &  & 9 & 67.0 & 66.1 \\ \cline{1-3} \cline{5-7} 
        4 & 68.0 & 64.3 &  & 10 & 73.0 & 77.6 \\ \cline{1-3} \cline{5-7} 
        5 & 72.2 & 76.0 &  & 11 & 70.1 & 67.8 \\ \cline{1-3} \cline{5-7} 
        6 & 69.8 & 72.7 &  & 12 & 64.5 & 70.7 \\ \cline{1-3} \cline{5-7} 
        \end{tabular}
    \end{table}
...
\begin{solution}
    ...
    \begin{ppart}
        ...
        \begin{table}[H]
            ...
            \hline
            \bd{User} & \bd{Before} & \bd{After} & \bd{Change} & \bd{Rank} \\ \hline\hline
...
\begin{solution}
    \begin{ppart}
        ...
        \begin{align*}
            ...
            &\hspace{2em}= \P{X < 15} \P{\text{Mrs Yeo last drove the car}}\\
            &\hspace{4em}+ \P{Y < 15} \P{\text{Her son last drove the car}}\\
            &\hspace{2em}= \frac{5}{40} (0.8) + \frac{15}{20} (0.2)\\
            &\hspace{2em}= 0.25.
        \end{align*}
    \end{ppart}
    \begin{ppart}
        ...
        Thus, by the law of total probability \[F_T = \begin{cases}
            0 , & t < 0,\\
            0 (0.8) + (t/20) (0.2), & 0 \leq t < 10,\\
            (t-10)/40 (0.8) + (t/20) (0.2), & 10 \leq t < 20,\\
            (t-10)/40 (0.8) + 1 (0.2), & 20 \leq t \leq 50,\\
            1 , & t > 50,
    ...
    \begin{ppart}
        We have
        \begin{align*}
            \P{D > 504} &= \P{650 - \frac{3250}{T + 5} > 504}\\
            &= \P{T \geq \frac{1260}{73}}\\
            &= 1 - F_T\!\bp{\frac{1260}{73}}\\
            &= 1 - \bs{0.03\bp{\frac{1260}{73}} - 0.2}\\
            &= \frac{249}{365}.
        \end{align*}
    \end{ppart}
\end{solution}
...
\begin{solution}
    ...
    \begin{ppart}
        ...
        \end{psubpart}
        \begin{psubpart}
            Note that $D + S \sim \Po{3}$. Let $X_n \sim \Po{3n/7}$. We require $\P{X_n > 0} > 0.8$. Using G.C., the least value of $n$ is 4.
        \end{psubpart}
        \begin{psubpart}
        ...
        \begin{psubpart}
            ...
            \begin{align*}
                &\P{\abs{D - S} > 3}{D + S = 7}\\
                &\hspace{2em}= \frac{\P{D + S = 7 \, \tand \, \abs{D - S} > 3}}{\P{D + S = 7}}\\
                &\hspace{2em}= \frac{1}{\P{D + S = 7}} \Big[\P{D = 0} \P{S = 7} + \P{D = 1}\P{S = 6}\\
                &\hspace{9em} + \P{D = 6} \P{S = 1} + \P{D = 7} \P{S = 0}\Big]\\
                &\hspace{2em}= 0.270 \tosf{3}.
            \end{align*}
        \end{psubpart}
    \end{ppart}
\end{solution}
...
\begin{problem}
    ...
    \begin{table}[H]
        ...
        \hline
        \bd{\#1} & 8.47 & \bd{\#2} & 11.36 & \bd{\#3} & 10.26 & \bd{\#4} & 9.59 & \bd{\#5} & 7.38 \\ \hline
        \bd{\#6} & 7.38 & \bd{\#7} & 6.89 & \bd{\#8} & 10.93 & \bd{\#9} & 9.61 & \bd{\#10} & 10.14 \\ \hline
        \end{tabular}
    \end{table}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
        \hline
        \bd{\#1} & 8.70 & \bd{\#2} & 11.30 & \bd{\#3} & 10.22 & \bd{\#4} & 9.61 & \bd{\#5} & 7.70 \\ \hline
        \bd{\#6} & 8.10 & \bd{\#7} & 7.86 & \bd{\#8} & 10.70 & \bd{\#9} & 9.90 & \bd{\#10} & 9.98 \\ \hline
        \end{tabular}
    \end{table}
