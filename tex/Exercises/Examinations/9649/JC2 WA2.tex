\section{9649 JC2 Weighted Assessment 2}
...
\begin{problem}
    \begin{enumerate}
        ...
        \item Let $T$ be the linear transformation such that $T : \RR^3 \to \RR^3$ and $T(\vec x) = \mat A \vec x$, where \[\mat A = \begin{pmatrix}0 & -1 & -5 \\ 1 & 0 & a \\ 5 & b & 0\end{pmatrix},\] where $a$ and $b$ are real numbers. It is given that the nullity of $T$ is 1.
        \begin{enumerate}
...
\begin{solution}
    ...
    \begin{ppart}
        ...
        \end{psubpart}
        \begin{psubpart}
            Consider $\mat A \vec v = \vec 0$, where $\vec v = (x, y, z)\trp \in \RR^3$. Then \[\begin{pmatrix}0 & -1 & -5 \\ 1 & 0 & a \\ 5 & -a & 0\end{pmatrix} \cveciii{x}{y}{z} = \cveciii000,\] giving the system of equations \[\left\{\begin{aligned}y + 5z = 0 \\ x + az = 0 \\ 5x-ay = 0\end{aligned}\right..\] Let $z = \l \in \RR$. From the first two equations, we see that $y = -5\l$ and $x = -a\l$. Thus, $\vec v$ is of the form $\l (-a, -5, 1)\trp$, whence the kernel of $T$ is given by \[\Ker T = \bc{\vec v \in \RR^3 : \vec v = \l \cveciii{-a}{-5}{1}, \, \l \in \RR}.\]
        \end{psubpart}
        \begin{psubpart}
...
\begin{solution}
    ...
    \begin{ppart}
        ...
        \begin{align*}
            \vec P_n &= \mat A^n \vec P_0\\
            &= \mat Q (3\mat D)^n \mat Q^{-1} \vec P_0 \\
