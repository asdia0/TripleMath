...
\begin{solution}
    ...
    \begin{ppart}
        ...
        \end{align*}
        Because both $k, s \in (0, 1)$, it follows that $1-ks \in (0, 1)$ too. We can hence remove the modulus sign, whence we obtain \[\frac{k}{2} \abs{\vec a \crossp \vec c} = \l \bp{\frac{1-ks}{2} \abs{\vec a \crossp \vec c}} \implies \l = \frac{k}{1-ks}.\]
    \end{ppart}
\end{solution}