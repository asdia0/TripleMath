...
\begin{solution}
    \begin{ppart}
        \begin{align*}
            &\sum_{r=-n}^n (r+1)(r+3)\\
            &\hspace{1em}= \sum_{r=0}^{2n} (r-n+1)(r-n+3)\\
            &\hspace{1em}= \sum_{r=0}^{2n} \bs{r^2 + r(4-2n) + (n^2 - 4n + 3)}\\
            &\hspace{1em}= \frac{(2n)(2n+1)(4n+1)}{6} + (4-2n) \, \frac{(2n)(2n+1)}2 + (n^2 - 4n + 3) (2n+1)\\
            &\hspace{1em}= (2n+1)\bs{\frac{n(4n+1)}{3} + (4-2n)(n) + (n^2 - 4n + 3)}\\
            &\hspace{1em}= \frac{2n+1}{3} \bp{n^2 + n +9}.
        \end{align*}
    \end{ppart}
    \begin{ppart}
...
\begin{solution}
    ...
    \begin{ppart}
        ...
        From the graph, $-1-\sqrt5 < x < -2 \tor \frac23 < x < -1 + \sqrt5$.
    \end{ppart}
\end{solution}
...
\begin{solution}
    \begin{ppart}
        ...
        \begin{align*}
            \int_{1/\sqrt{3}}^{2/\sqrt3} \sqrt{\frac{3x^2-1}{x^2}} \d x &= \int_0^{\pi/3} \sqrt{\frac{\tan^2 \t}{\frac13 \sec^2 \t}} \frac1{\sqrt3} \sec \t \tan \t \d \t\\
            &= \int_0^{\pi/3} \tan^2 \t \d \t\\
            &= \int_0^{\pi/3} \bp{\sec^2 \t - 1} \d \t\\
            &= \evalint{\tan \t - \t}{0}{\pi/3} = \sqrt3 - \frac\pi3.
        \end{align*}
    \end{ppart}
    \begin{ppart}
...
\begin{solution}
    \begin{ppart}
        ...
        Let $y = f(x)$. Then \[3\sin{2x - \frac16 \pi} = y \implies 2x - \frac16 \pi = \arcsin{\frac{y}3} \implies x = \frac12 \arcsin{\frac{y}3} + \frac1{12} \pi.\] Hence, \[\inv f(x) = \frac12 \arcsin{\frac{x}3} + \frac1{12} \pi.\]
    \end{ppart}
    \clearpage
    \begin{ppart}
