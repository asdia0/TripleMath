\section{9758 JC1 Promotional Examination}
...
\end{problem}
\begin{solution}
    We have \[\frac{3x^2+2x-12}{x-1} - (x+2) = \frac{(x-2)(2x+5)}{x-1}.\] Rearranging terms, the given inequality becomes \[\frac{(x-2)(2x+5)}{x-1} = \frac{3x^2+2x-12}{x-1} - (x+2) \geq 0,\] which is equivalent to $(x-2)(2x+5)(x-1) \geq 0$.
...
\begin{solution}
    \begin{ppart}
        \begin{align*}
            &\sum_{r=-n}^n (r+1)(r+3)\\
            &\hspace{2em}= \sum_{r=0}^{2n} (r-n+1)(r-n+3)\\
            &\hspace{2em}= \sum_{r=0}^{2n} \bs{r^2 + r(4-2n) + (n^2 - 4n + 3)}\\
            &\hspace{2em}= \frac{(2n)(2n+1)(4n+1)}{6} + (4-2n) \, \frac{(2n)(2n+1)}2 + (n^2 - 4n + 3) (2n+1)\\
            &\hspace{2em}= (2n+1)\bs{\frac{n(4n+1)}{3} + (4-2n)(n) + (n^2 - 4n + 3)}\\
            &\hspace{2em}= \frac{2n+1}{3} \bp{n^2 + n +9}.
        \end{align*}
    \end{ppart}
    \begin{ppart}
        \[\sum_{r=1}^\infty \frac{(-1)^{r+1} x^r}{r 2^r} = \sum_{r=1}^\infty \frac{(-1)^{r+1} (x/2)^r}{r} = \ln{1 + \frac{x}2}.\] For convergence, we require $-1 < x/2 \leq 1$, i.e. $-2 < x \leq 2$.
    \end{ppart}
\end{solution}
...
\begin{solution}
    \begin{ppart}
        Note that $y$ is undefined when $t = -1$. Hence, there is a vertical asymptote $x = 1$. Also, $x$ is undefined when $t = 1$, so there is a horizontal asymptote $y = 2$.

        \begin{center}\tikzsetnextfilename{6}
    ...
    \end{ppart}
    \begin{ppart}
        Note that $x = -2/(t-1)$, so $t = 1-2/x$. Hence, \[y = \frac{4}{(1-2/x) + 1} = \frac{2x}{x-1}.\] Thus, \[y = \frac{2x}{x-1}, \quad x \neq 1, x > 0.\]
    \end{ppart}
\end{solution}
...
\begin{solution}
    \begin{ppart}
        \case{1}[$3x^2 + 5x - 8 = 4-x$] Then $3(x^2 + 2x - 4) = 0$. By the quadratic formula, we get $x = -1\pm\sqrt5$.

        \case{2}[$3x^2 + 5x - 8 = -(4-x)$] Then $3x^2 + 4x - 4 = (3x-2)(x+2) = 0$. Thus, $x = 2/3$ or $x = -2$.

        Hence, the roots are $x = -1\pm\sqrt5$, $2/3$ and $-2$.
    \end{ppart}
    \begin{ppart}
        \begin{center}\tikzsetnextfilename{7}
            \begin{tikzpicture}[trim axis left, trim axis right]
                \begin{axis}[
                    domain = -4:2.5,
        ...
        From the graph, $-1-\sqrt5 < x < -2 \tor 2/3 < x < -1 + \sqrt5$.
    \end{ppart}
\end{solution}
...
\begin{problem}
    \begin{enumerate}
        ...
        A curve undergoes in succession, the transformations $A$, $B$ and $C$, and the equation of the resulting curve is $y = (2x+1)/(2x+2)$. Determine the equation of the curve before the transformations, expressing your answer as a single fraction.
        \item The diagram shows the curve $y = f(x)$. The lines $x = -2$, $x = 2$ and $y = 3x/2$ are asymptotes to the curve. The curve has turning points at $(-3, -5)$ and $(3, 5)$. It also has a stationary point of inflexion at the origin $O$.
        \begin{center}\tikzsetnextfilename{8}
            \begin{tikzpicture}[trim axis left, trim axis right]
                \begin{axis}[
                    domain = -10:10,
        ...
        \begin{enumerate}
            ...
            \item Sketch the graph of $y = 1/f(x)$.
...
\begin{solution}
    \begin{ppart}
        We apply the inverse transformations in reverse order to recover the equation of the original curve.

        \renewcommand{\theenumi}{\arabic{enumi}.}
        \begin{enumerate}
            \item[] \[y = \frac{2x+1}{2x+2}.\]
            \item A translation of two units in the positive $x$-direction \[y = \frac{2x-3}{2x-2}. \tag{$x \mapsto x-2$}\]
            \item A translation of one unit in the negative $y$-direction. \[y = -\frac1{2x-2}. \tag{$y \mapsto y+1$}\]
            \item A reflection about the $x$-axis. \[y = \frac1{2x-2}. \tag{$y \mapsto -y$}\]
        \end{enumerate}
        \renewcommand{\theenumi}{(\alph{enumi})}

        Thus, the original curve has equation $y = 1/(2x-2)$.
    \end{ppart}
    \begin{ppart}
        \begin{psubpart}
            From the graph, we clearly have $x < -2$ or $0 < x < 2$.
        \end{psubpart}
        \begin{psubpart}
            \begin{center}\tikzsetnextfilename{9}
                \begin{tikzpicture}[trim axis left, trim axis right]
                    \begin{axis}[
                        domain = -10:10,
        ...
        \end{psubpart}
        \begin{psubpart}
            \begin{center}\tikzsetnextfilename{10}
                \begin{tikzpicture}[trim axis left, trim axis right]
                    \begin{axis}[
                        domain = -5:5,
...
\begin{problem}
    A curve has parametric equations $x = 3u^2$, $y = 6u$.
    \begin{enumerate}
        \item Find the equations of the normal to the curve at the point $P(3p^2, 6p)$, where $p$ is a non-zero constant.
...
\begin{solution}
    \begin{ppart}
        Note that \[\der{y}{x} = \frac{\derx{y}{u}}{\derx{x}{u}} = \frac{6}{6u} = \frac1u.\] At $u = p$, the gradient of the normal is hence $-1/(1/p) = -p$. Thus, the equation of the normal at $P$ is $y - 6p = -p\bp{x - 3p^2}$.
    \end{ppart}
    \begin{ppart}
        At $Q$, $y = 0$. Hence, $x = 6 + 3p^2$, whence $Q(6 + 3p^2, 0)$. At $R$, $x = 0$. Hence, $y = 6p + 3p^2$, whence $R(0, 6p+3p^2)$.
    \end{ppart}
    \begin{ppart}
        When $p > 0$, the area of the triangle is $(1/2)(6p + 3p^3)(6 + 3p^2)$ units$^2$. When $p < 0$, the area of the triangle is $-(1/2)(6p + 3p^3)(6 + 3p^2)$ units$^2$.
    \end{ppart}
    \begin{ppart}
        Let the area of the triangle be $A \units[2]$. Since $p>0$, we have \[A = \frac12 (6p + 3p^3)(6 + 3p^2).\] Thus, \[\der{A}{p} = \frac12 \bs{(6p + 3p^3)(6p) + (6+3p^2)(6 + 9p^2)} = \frac92 \bp{5p^4 + 12p^2 + 4}.\] Hence, the rate of change of area of the triangle is \[\der{A}{t} = \der{A}{p} \cdot \der{p}{t} = 9\bp{5p^4 + 12p^2 + 4} \units[2]\text{/s}.\]
    \end{ppart}
\end{solution}

\begin{problem}
    The shaded region $R$ is bounded by the lines $y = 2x$, $y = 3/2$, the $x$-axis and the curve \[y = \sqrt{\frac{3x^2 - 1}{x^2}}.\]

    \begin{center}\tikzsetnextfilename{11}
        \begin{tikzpicture}[trim axis left, trim axis right]
            \begin{axis}[
                domain = 0:1.3,
    ...
    \begin{enumerate}
        \item By using the substitution $x = \sec{\t}/\sqrt3$, find the exact value of \[\int_{1/\sqrt{3}}^{2/\sqrt3} \sqrt{\frac{3x^2-1}{x^2}} \d x.\]
...
\begin{solution}
    \begin{ppart}
        Note that $3x^2 - 1 = \tan^2 \t$ and \[\der{x}{\t} = \frac1{\sqrt3} \sec\t\tan\t.\] The bounds of integration now go from $\t = 0$ to $\pi/3$.
        \begin{align*}
            \int_{1/\sqrt{3}}^{2/\sqrt3} \sqrt{\frac{3x^2-1}{x^2}} \d x &= \int_0^{\pi/3} \sqrt{\frac{\tan^2 \t}{(1/3) \sec^2 \t}} \frac1{\sqrt3} \sec \t \tan \t \d \t\\
            &= \int_0^{\pi/3} \tan^2 \t \d \t\\
...
\begin{solution}
    \begin{ppart}
        ...
        \begin{align*}
            ...
            &= \frac1{1 - 4x^2} \bs{-8 + 4x \cdot \frac{2\bs{\arccos{2x} - \arcsin{2x}}}{\sqrt{1-4x^2}}}\\
            &= \frac1{1-4x^2} \bp{-8 + 4xy'}.
        \end{align*}
        Hence, $\bp{1-4x^2} y'' - 4xy' + 8 = 0$. Differentiating with respect to $x$, we get $\bp{1-4x^2} y''' - 12xy'' - 4y' = 0$. Evaluating $y$, $y'$, $y''$ and $y'''$ at $x = 0$, we get $y(0) = 0$, $y'(0) = \pi$, $y''(0) = -8$, and $y'''(0) = 4\pi$. Hence, \[y = \pi x - 4x^2 + \frac23 \pi x^3 + \cdots.\]
    \end{ppart}
    \begin{ppart}
        \begin{align*}
            \int_{0.1}^{0.2} \bp{\frac2x}^3 \arccos{2x}\arcsin{2x} \d x &= 8 \int_{0.1}^{0.2} x^{-3} \arccos{2x}\arcsin{2x} \d x\\
            &\approx 8 \int_{0.1}^{0.2} x^{-3} \bs{\pi x - 4x^2 + \frac23 \pi x^3} \d x\\
            &= 8 \int_{0.1}^{0.2} \bp{\pi x^{-2} - 4x^{-1} + \frac23 \pi x} \d x\\
            &= 8 \evalint{-\frac\pi{x} - 4\ln\abs{x} + \frac23 \pi x}{0.1}{0.2}\\
            &= 105.1585 \todp{4}.
        \end{align*}
    \end{ppart}
    \begin{ppart}
...
\begin{problem}
    ...
    \begin{enumerate}
        \item Show that the largest exact value of $k$ such that $\inv f$ exists is $\pi/3$. Find $\inv f(x)$.
        \item It is given that $k = \pi/3$. In a single diagram, sketch the graphs of $y = f(x)$ and $y = \inv f(x)$, labelling your graphs clearly.
    \end{enumerate}

    The function $h$ is defined by \[h : x \mapsto 3\sin{2x - \frac16 \pi}, \quad 0 \leq x \leq \pi/3, \; x \neq \frac\pi{12}.\]

    Another function $g$ is defined by \[g : x \mapsto \abs{3 - \frac1{x}}, \quad 3 \leq x \leq 3, \; x \neq 0.\]
...
\begin{solution}
    \begin{ppart}
        For $\inv f$ to exist, $f$ must be one-one. Since $\pi/3$ is the first maximum point of $f$, it is the largest value of $k$. 

        Let $y = f(x)$. Then \[3\sin{2x - \frac16 \pi} = y.\] Solving for $x$, we get \[x = \frac12 \arcsin{\frac{y}3} + \frac1{12} \pi.\] Hence, \[\inv f(x) = \frac12 \arcsin{\frac{x}3} + \frac1{12} \pi.\]
    \end{ppart}
    \begin{ppart}
        \begin{center}\tikzsetnextfilename{12}
            \begin{tikzpicture}[trim axis left, trim axis right]
                \begin{axis}[
                    xmin = -2,
                    ymin=-1.7,
    ...
    \end{ppart}
    \begin{ppart}
        Since $\ran h = [-3/2, 0) \cup (0, 3]$ and $\dom g = [-3, 0) \cup (0, 3]$, we have $\ran h \subseteq \dom g$, whence $gh$ exists.

        \[gh(x) = g\bs{3\sin{2x - \frac16\pi}} = \abs{3 - \frac1{3\sin{2x - \pi/6}}}.\]

        When $h(x) = 1/3$, $gh(x) = 0$. When $x \to \pi/12$, $gh(x) \to \infty$. Hence, $\ran {gh} = [0, \infty)$.
    \end{ppart}
    \begin{ppart}
        From $\inv{gh}(x) = 0$, we have $x = gh(0)$, so \[x = gh(0) = \abs{3 - \frac1{3\sin{-\pi/6}}} = \frac{11}3.\]
    \end{ppart}
\end{solution}
...
\begin{solution}
    \begin{ppart}
        ...
        \begin{psubpart}
            ...
            \begin{align*}
                ...
                &= \evalint{-\ln \abs{x+1} + \frac12 \bp{\ln{x^2 + 1} + 2\arctan x}}01\\
                &= -\frac{\ln 2}{2} + \frac\pi4.
            \end{align*}
            Thus, 
            \begin{align*}
                \int_0^1 \frac{\ln{1+x^2}}{(x+1)^2} \d x &= \evalint{-\frac{\ln{1+x^2}}{x+1}}{0}{1} + \int_0^1 \frac{2x}{(x+1)(x^2 + 1)} \d x\\
                &= -\frac{\ln2}2 + \bp{-\frac{\ln 2}{2} + \frac\pi2}\\
                &= -\ln 2 + \frac\pi4.
            \end{align*}
            Hence, $a = 1/4$ and $b = 2$.
        \end{psubpart}
    \end{ppart}
    \begin{ppart}
        Note that $\sin 3u = 3\sin u - 4\sin^3 u$, whence $\sin^3 u = (3\sin u - \sin 3u)/4$.
        \begin{align*}
            \int \sin[3]{kx} \d x = \int \frac{3\sin{kx} - \sin{3kx}}{4} \d x = \frac{-3\cos{kx} + (1/3)\cos{3kx}}{4k} + C.
        \end{align*}
    \end{ppart}
\end{solution}
...
\begin{problem}
    ...
    While training, Alan suffers from inflammation and needs medication. The concentration of the medicine in the bloodstream after administration can be modelled by the recurrence relation \[C_{n+1} = C_n \exp{-\bp{p + \frac{1}{n+100}}},\] where $n$ represents the number of complete hours from which the medicine is first taken and $p$ is the decay constant.
...
\begin{solution}
    \begin{ppart}
        Let $R_n$ m be the distance ran in the $n$th week. We have $R_1 = 400$ and $R_{n+1} = \bp{1 + r/100}R_n$, whence \[R_n = 400 \bp{1 + \frac{r}{100}}^{n-1}.\] Since $R_5 = 829.44$, we have \[400 \bp{1 + \frac{r}{100}}^4 = 829.44.\] Solving for $r$, we get \[r = 100\bs{\bp{\frac{829.44}{400}}^{1/4} - 1} = 20.\] Hence, $R_20 = 400 \cdot 1.2^19 = 12779.2 = 13000$, rounded to the nearest thousand. Hence, Alan will run 13 km in week 20.
    \end{ppart}
    \begin{ppart}
    ...
    \begin{ppart}
        ...
        \[168 = 200 \exp{-\bp{p + \frac1{100}}},\] whence $p = 0.16435$. Using G.C., the first time $C_n \leq 60$ occurs when $n = 7$. Thus, after 7 complete hours, Alan will feel significant pain and should take his medicine again.
    \end{ppart}
\end{solution}