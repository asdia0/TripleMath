...
\begin{solution}
    ...
    \begin{ppart}
        ...
        Since $\a$ is not real, it follows that $z_2$ is in the second quadrant (see case 1 in (b)). Thus, $z_2 = -\sqrt2 + 3\i /\sqrt2$. Thus, by Vieta's formulas, we have \[\a = -\bp{z_1 + z_2} = -3\sqrt{2} \i \quad \tand \quad \b = z_1 z_2 = -\frac{13}{2}.\]
    \end{ppart}
\end{solution}
