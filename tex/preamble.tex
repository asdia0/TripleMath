...
\newcommand{\bd}[1]{\textbf{\sffamily #1}}
\newcommand{\vocab}[1]{{\color{ForestGreen!90!black}\bd{#1}}}
...
% Do not reset footnote count
\usepackage{chngcntr}
\counterwithout*{footnote}{chapter}

\DeclareEmphSequence{\itshape\sffamily}

% Make parentheses in \pmod auto expand with \pmod*{}
\makeatletter
...
% Deprecated macros from asdia.sty

\newcommand*{\cvecii}[2]{\colvec{#1, #2}} % 2D vector
\newcommand*{\cveciii}[3]{\colvec{#1, #2, #3}} % 3D vector
\newcommand*{\cveciv}[4]{\colvec{#1, #2, #3, #4}} % 4D vector
\newcommand*{\cveciix}[2]{\rowvec{#1, #2}\trp} % 2D vector (inline)
\newcommand*{\cveciiix}[3]{\rowvec{#1, #2, #3}\trp} %3D vector (inline)
\newcommand*{\cvecivx}[4]{\rowvec{#1, #2, #3, #4}\trp} %4D vector (inline)
