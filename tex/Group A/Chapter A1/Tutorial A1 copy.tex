...
\begin{problem}
    ...
    \begin{center}\tikzsetnextfilename{29}\tikzsetnextfilename{1}
        \begin{tikzpicture}
...
\begin{solution}
    ...
    \begin{ppart}
        ...
        \begin{center}\tikzsetnextfilename{30}\tikzsetnextfilename{2}
            \begin{tikzpicture}
    ...
    \end{ppart}
    \begin{ppart}
        \begin{center}\tikzsetnextfilename{31}\tikzsetnextfilename{3}
            \begin{tikzpicture}
...
\begin{solution}
    \begin{ppart}
        ...
        \begin{center}\tikzsetnextfilename{32}\tikzsetnextfilename{4}
            \begin{tikzpicture}
    ...
    \begin{ppart}
        ...
        \begin{center}\tikzsetnextfilename{33}\tikzsetnextfilename{5}
            \begin{tikzpicture}
...
\begin{solution}
    ...
    \begin{center}\tikzsetnextfilename{34}\tikzsetnextfilename{6}
        \begin{tikzpicture}
...
\begin{solution}
    \begin{ppart}
        \begin{center}\tikzsetnextfilename{35}\tikzsetnextfilename{7}
    ...
    \end{ppart}
    \begin{ppart}
        \begin{center}\tikzsetnextfilename{36}\tikzsetnextfilename{8}
            \begin{tikzpicture}[trim axis left, trim axis right]
                \begin{axis}[
                    domain = -6:8,
                    samples = 50,
    ...
    \clearpage
    \begin{ppart}
        \begin{center}\tikzsetnextfilename{37}\tikzsetnextfilename{9}
            \begin{tikzpicture}[trim axis left, trim axis right]
                \begin{axis}[
                    domain = -0.5:2.5,
                    samples = 50,
    ...
    \end{ppart}
    \begin{ppart}
        \begin{center}\tikzsetnextfilename{38}\tikzsetnextfilename{10}
            \begin{tikzpicture}[trim axis left, trim axis right]
                \begin{axis}[
                    domain = -2.3:3,
                    samples = 200,
...
\end{problem}
\begin{solution}
    \begin{center}\tikzsetnextfilename{39}\tikzsetnextfilename{11}
...
\begin{solution}
    ...
    \begin{center}\tikzsetnextfilename{40}\tikzsetnextfilename{12}
        \begin{tikzpicture}
...
\begin{solution}
    ...
    \begin{center}\tikzsetnextfilename{41}\tikzsetnextfilename{13}
        \begin{tikzpicture}
...
\begin{solution}
    \begin{ppart}
        \begin{center}\tikzsetnextfilename{42}\tikzsetnextfilename{14}
            \begin{tikzpicture}[trim axis left, trim axis right]
                \begin{axis}[
                    domain = 0:5.5,
                    samples = 101,
    ...
    \begin{ppart}
        ...
        \begin{center}\tikzsetnextfilename{43}\tikzsetnextfilename{15}
            \begin{tikzpicture}
...
\begin{solution}
    ...
    \begin{center}\tikzsetnextfilename{44}\tikzsetnextfilename{16}
        \begin{tikzpicture}[trim axis left, trim axis right]
            \begin{axis}[
                domain = 0:13,
                samples = 81,
