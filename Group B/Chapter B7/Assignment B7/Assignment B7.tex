...
\begin{document}
    ...
    \solution
        \part
            \begin{align*}
                ...
                &= 3 \int \bp{1 - \dfrac1u} \d u + 2\arctan x + C\\
                &= 3\bp{u - \ln \abs{u}} + 2\arctan x + C\\
                &= 3\bp{x^2 + 1} - \ln{x^2 + 1} + 2\arctan x + C\\
                &= 3x^2 - \ln\bp{x^2 + 1} + 2\arctan x + C
            \end{align*}

            \boxt{$\displaystyle\int \dfrac{6x^3 + 2}{x^2 + 1} \d x = 3x^2 - \ln\bp{x^2 + 1} + 2\arctan x + C$}
        ...
        \part
            ...
            Let $I = \displaystyle\int x\ln x \d x$.
            {\allowdisplaybreaks
            \begin{alignat*}{2}
                &&I &= \int x\ln x \d x\\
                && &= x^2\ln x - \int \bp{x + x\ln x} \d x\\
            ...
            \begin{align*}
                \int_2^4 x\ln x \d x &= \evalint{\dfrac12 x^2 \ln x - \dfrac14 x^2}24\\
                &= 14 \ln 2 - 3
            \end{align*}
    ...
    \solution
        \part
            \begin{align*}
                \dfrac{x^2}{9-x^2} &= \dfrac{-\bp{9 - x^2} + 9}{9 - x^2}\\
                &= -1 + \dfrac9{9 - x^2}\\
                &= -1 + \dfrac9{(3-x)(3+x)}\\
        ...
        \part
            \begin{align*}
                \int_0^2 \dfrac{x^2}{9-x^2} \d x &= \int_0^2 \bp{-1 + \dfrac{3/2}{3-x} + \dfrac{3/2}{3 + x}} \d x\\
                &= \evalint{-x -\dfrac32 \ln{3 - x} + \dfrac32 \ln{3 + x}}02\\
                &= \dfrac32\ln5 - 2
            \end{align*}
        ...
        \part
            ...
            \]
            \begin{align*}
                \int_0^2 \ln\bp{9 - x^2} \d x &= \evalint{x\ln\bp{9 - x^2}}02 + 2\int_0^2 \dfrac{x^2}{9-x^2} \d x\\
                &= 2\ln5 + 2\bp{\dfrac32 \ln5 - 2}\\
                &= 5\ln5 - 4
            \end{align*}

            \boxt{$\displaystyle\int_0^2 \ln\bp{9 - x^2} \d x = 5\ln5 - 4$}
