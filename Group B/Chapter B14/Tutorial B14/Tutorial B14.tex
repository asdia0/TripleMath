...
\begin{document}
    ...
    \solution
        ...
        \part
            Observe that on the intevral $x \in [1, 1.2]$, we have $\der{y}{x} = 1 + y^2 \tan x > 0$. Since $y(1) = 1$, we also have $y > 0$. Thus, $\der[2]{y}{x} = 2y \der{y}{x} \tan x + y^2 \sec^2 x > 0$, whence $y$ is concave upwards. Thus, the estimates are likely to be underestimates.
