...
\begin{document}
    ...
    \solution
        ...
        \part
            ...
            When $t = 120$, $P = 0$. Hence, \[X\arctan{-75X} = -\dfrac{120}{600} + X \arctan{25X},\] which has the solution $X = 0.079667$. Note that we reject $X = -0.079667$ since $X \geq 0$. We thus have
