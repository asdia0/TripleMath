...
\title{Assignment B15\\Modelling Populations with First Order DE}
\author{Eytan Chong}
\date{2024-08-27}
...
\begin{document}
    ...
    \solution
        ...
        \part
            Note that $t = 10 \cdot 12 = 120$, $P(0) = 100$ and $P(108) = 0$.
            {\allowdisplaybreaks
            \begin{alignat*}{2}
            ...
            Let $X = \dfrac{1}{\sqrt{600H - 75^2}}$. This simplifies the above result to \[X \arctan{(P-75)X} = -\dfrac1{600}t + C.\] When $t = 0$, $P = 100$. Hence, \[C = X \arctan{25X}\]
            When $t = 108$, $P = 0$. Hence, \[X\arctan{-75X} = -\dfrac{108}{600} + X \arctan{25X},\] which has the solution $X = 0.073145$. Note that we reject $X = -0.073145$ since $X \geq 0$. We thus have
            \[H = \dfrac1{600}\bp{\dfrac1{0.073145^2} + 75^2} = \boxed{9.377} \todp{3}\]
