...
\begin{document}
    ...
    \solution
        \part
            \begin{alignat*}{2}
                ...
                && &= e^x + 5^{\frac{n}2} e^{x} \sin{n \arctan 2 + 2x}\\
        ...
        \part
            ...
            \begin{align*}
                \binom{9/4}{2} \bp{\dfrac43 }^2 x^2 &= \dfrac{9/4 \cdot (9/4-1)}{2}  \bp{\dfrac43}^2 x^2\\
                &= \dfrac52 x^2
            \end{align*}
    ...
    \problem{}
        \begin{enumerate}
            \item Show that the first three non-zero terms in the expansion of $\bp{\dfrac8{x^3} - 1}^{1/3}$ in ascending powers of $x$ are in the form $\dfrac{a}x + bx^2 + cx^5$, where $a$, $b$ and $c$ are constants to be determined.
    ...
    \solution
        \part
            \begin{align*}
                ...
                &= \dfrac2x \sum_{k=0}^\infty \binom{1/3}{k} \bp{- \dfrac{x^3}8}^k\\
                &= \dfrac2x \bs{\binom{1/3}{0} \bp{- \dfrac{x^3}8}^0 + \binom{1/3}{1} \bp{- \dfrac{x^3}8}^1 + \binom{1/3}{2} \bp{- \dfrac{x^3}8}^2 + \ldots }\\
                &= \dfrac2x \bp{1 + \dfrac13 \cdot - \dfrac{x^3}8 + \dfrac{1/3 \cdot (1/3 - 1)}{2} \cdot \dfrac{x^6}{64} + \ldots }\\
        ...
        \part
            ...
            \begin{alignat*}{2}
                && \bp{\dfrac8{\bp{2/3}^3} - 1}^{1/3} &= \dfrac2{2/3} - \dfrac{\bp{2/3}^2}{12} - \dfrac{\bp{2/3}^5}{288} + \ldots\\
            ...
            Since $\abs{6} > 1$, the binomial expansion of $ \bp{\dfrac8{x^3} - 1}^{1/3}$ does not hold. Hence, $x = 6$ is not an appropriate choice.
    ...
    \solution
        ...
        \part
            \begin{alignat*}{2}
                ...
                && &= 2^{\tfrac{n}2} e^x \sin{\tfrac{\pi}4 n + x}
            \end{alignat*}
            ...
            Hence,
            \begin{align*}
                f(0) &=  2^{\tfrac{0}2}\sin{\tfrac{\pi}4 \cdot 0} = 0\\
                f'(0) &=  2^{\tfrac{1}2}\sin{\tfrac{\pi}4 \cdot 1} = 1\\
                f''(0) &=  2^{\tfrac{2}2}\sin{\tfrac{\pi}4 \cdot 2} = 2\\
                f^{(3)}(0) &=  2^{\tfrac{3}2}\sin{\tfrac{\pi}4 \cdot 2} = 2
            \end{align*}
            Thus,
            \begin{align*}
                f(x) &= \sum_{n=0}^\infty \dfrac{f^{(n)}(0)}{n!} x^n \\
        ...
        \part
            ...
            \begin{alignat*}{2}
                &&f(x) - g(x) &\leq 0.5\\
                \implies&&e^x \sin x - \bp{x + x^2 + \dfrac13 x^3} &\leq 0.5\\
                \implies&&x &\geq -1.96
            \end{alignat*}

            \case{2}{$-\bs{f(x) - g(x)} \leq 0.5$}
            \begin{alignat*}{2}
                &&-\bs{f(x) - g(x)} &\leq 0.5\\
