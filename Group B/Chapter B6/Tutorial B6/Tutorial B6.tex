...
\begin{document}
    \problem{}
        \begin{enumerate}
            ...
            \item Given that $g(x) = \tan{2x + \dfrac14 \pi }$, find $g(0)$, $g'(0)$ and $g''(0)$. Hence, find the first three terms in the MacLaurin series of $g(x)$.
        \end{enumerate}
    ...
    \solution
        ...
        \part
            \begin{alignat*}{2}
                &&g(x) &= \tan{2x + \dfrac14 \pi }\\
                \implies&&g'(x) &= \sec^2 \bp{2x + \dfrac14 \pi } \cdot 2\\
                && &= 2\bp{1 + \tan^2\bp{2x + \dfrac14 \pi }}\\
                && &= 2 + 2g^2(x)\\
    ...
    \solution
        \part
            ...
            \begin{alignat}{2}
                ...
                \implies&&y\bp{(1+2x)\cdot y' + y} &= 12(1+3x)^7\label{P2-1-3}\\\nonumber
            \end{alignat}
    ...
    \solution
        ...
        Consider $\bp{\sum_{k=0}^\infty \dfrac{(-1)^k}{(2k)!} x^{2k} }^{n+1}$, which is equivalent to
        ...
        The second way to obtain an $x^4$ term is to select an $x^2$ term ($-\dfrac{x^2}{2!}$) from 2 copies and a constant term ($1$) from the remaining copies. There are $\displaystyle \binom{n+1}{2} = \dfrac{(n+1)n}2$ ways to do this, which further contributes $\dfrac{(n+1)n}2 \cdot 1 \cdot \bp{-\dfrac{1}{2!}}^2 = \dfrac{n(n+1)}8$ to the coefficient of $x^4$. Hence, the coefficient of $x^4$ is given by $\dfrac{n+1}{24} + \dfrac{n(n+1)}8 = \dfrac{(n+1)(3n + 1)}{24}$. 
    ...
    \problem{}
        \begin{enumerate}
            ...
            \item It is given that the first two terms of this series are equal to the first two terms in the series expansion, in ascending powers of $x$, of $\bp{1 + \dfrac43 x}^n$. Find $n$ and show that the third terms in each of these series are equal.
        \end{enumerate}
    ...
    \solution
        \part
            \begin{alignat*}{2}
                ...
                && &= e^x + \Im{\bp{\sqrt 5 e^{i \arctan 2}}^n e^{x(1+2i)}}\\
                && &= e^x + \Im{5^{\frac{n}2} e^{in \arctan 2} e^{x(1+2i)}}\\
                && &= e^x + 5^{\frac{n}2} e^{x} \Im{ e^{i(n \arctan 2 + 2x)} }\\
                && &= e^x + 5^{\frac{n}2} e^{x} \sin{\bp{n \arctan 2 + 2x}}\\
            ...
            \begin{alignat*}{2}
                ...
                && &= 1 + 5 \cdot 2\sin{\arctan 2} \cos{\arctan 2}\\
        ...
        \part
            ...
            \begin{align*}
                \bp{1 + \dfrac43x}^n &= \sum_{k=0}^n \binom{n}{k} \bp{\dfrac43 x}^k  1^{n-k}\\
                &= \sum_{k=0}^n \binom{n}{k} \bp{\dfrac43 }^k x^k\\
                &= \binom{n}{0} \bp{\dfrac43 }^0 x^0 + \binom{n}{1} \bp{\dfrac43 }^1 x^1 + \ldots\\
                &= 1 + \dfrac43 nx + \ldots
            \end{align*}

            Comparing the coefficient of $x$ terms, we have $3 = \dfrac43 n$, whence $n = \dfrac94$. Hence, the third term is in the expansion of $\bp{1 + \dfrac43x}^n$ is given by

            \begin{align*}
                \binom{\frac94}{2} \bp{\dfrac43 }^2 x^2 &= \dfrac{\frac94(\frac94-1)}{2}  \bp{\dfrac43}^2 x^2\\
                &= \dfrac52 x^2
            \end{align*}
    ...
    \problem{}
        \begin{enumerate}
            \item Show that the first three non-zero terms in the expansion of $\bp{\dfrac8{x^3} - 1}^{\tfrac13}$ in ascending powers of $x$ are in the form $\dfrac{a}x + bx^2 + cx^5$, where $a$, $b$ and $c$ are constants to be determined.
    ...
    \solution
        \part
            \begin{align*}
                \bp{\dfrac8{x^3} - 1}^{\tfrac13} &= \dfrac2x \bp{1 - \dfrac{x^3}8}^{\tfrac13}\\ 
                &= \dfrac2x \sum_{k=0}^\infty \binom{\frac13}{k} \bp{- \dfrac{x^3}8}^k\\
                &= \dfrac2x \bp{\binom{\frac13}{0} \bp{- \dfrac{x^3}8}^0 + \binom{\frac13}{1} \bp{- \dfrac{x^3}8}^1 + \binom{\frac13}{2} \bp{- \dfrac{x^3}8}^2 + \ldots }\\
                &= \dfrac2x \bp{1 + \dfrac13 \cdot - \dfrac{x^3}8 + \dfrac{\frac13 (\frac13 - 1)}{2} \cdot \dfrac{x^6}{64} + \ldots }\\
        ...
        \part
            ...
            \begin{alignat*}{2}
                && \bp{\dfrac8{\bp{\frac23}^3} - 1}^{\tfrac13} &= \dfrac2{\tfrac23} - \dfrac{\bp{\frac23}^2}{12} - \dfrac{\bp{\frac23}^5}{288} + \ldots\\
            ...
            Since $\abs{6} > 1$, the binomial expansion of $ \bp{\dfrac8{x^3} - 1}^{\tfrac13}$ does not hold. Hence, $x = 6$ is not an appropriate choice.
    ...
    \solution
        ...
        \part
            \begin{alignat*}{2}
                ...
                && &= \Im{(1+i)^n e^{x(1 + i)}}\\
                && &= \Im{\bp{\sqrt2 e^{i\tfrac{\pi}4}}^n e^{x(1 + i)}}\\
                && &= \Im{2^{\tfrac{n}2} e^x e^{i\tfrac{\pi}4 n} e^{ix}}\\
                && &= 2^{\tfrac{n}2} e^x \Im{e^{i\bp{\tfrac{\pi}4 n + x}}}\\
                && &= 2^{\tfrac{n}2} e^x \sin{\bp{\tfrac{\pi}4 n + x}}
            \end{alignat*}

            Evaluating $f^{(n)}(x)$ at $x = 0$,
            \[
                f^{(n)}(x) = 2^{\tfrac{n}2}\sin{\bp{\tfrac{\pi}4 n}}
            \]

            Hence,
            \begin{align*}
                f(0) &=  2^{\tfrac{0}2}\sin{\bp{\tfrac{\pi}4 \cdot 0}} = 0\\
                f'(0) &=  2^{\tfrac{1}2}\sin{\bp{\tfrac{\pi}4 \cdot 1}} = 1\\
                f''(0) &=  2^{\tfrac{2}2}\sin{\bp{\tfrac{\pi}4 \cdot 2}} = 2\\
                f^{(3)}(0) &=  2^{\tfrac{3}2}\sin{\bp{\tfrac{\pi}4 \cdot 2}} = 2
            \end{align*}
    ...
    \solution
        \begin{alignat}{2}
            ...
            \implies&&y'' &= -2 \bp{\cos 2x \cdot 2y\cdot y' + y^2 \cdot -\sin 2x \cdot 2}\nonumber\\
            && &= -4\bp{y\cdot y' \cos 2x - y^2\sin 2x  }\label{P7-3}
        \end{alignat}
        ...
        \part
            \begin{align*}
                \int_{-0.1}^{0.1} y \d x &\approx \int_{-0.1}^{0.1} \bp{1 - 2x + 4x^2 } \d x\\
                &= \evalint{x - 2 \cdot \dfrac12 x^2 + 4 \cdot \dfrac13 x^3}{-0.1}{0.1}\\
                &= \dfrac{76}{275}
            \end{align*}
    ...
    \solution
        \part
            ...
            \begin{alignat}{2}
                ...
                \implies&& \bp{1 -4x^2}y''  - 4xy' &= 2y' \sqrt{1-4x^2}\nonumber\\
                && &= 2 \bp{\dfrac{2y}{\sqrt{1-4x^2}}} 
                \sqrt{1-4x^2}\nonumber\\
                && &= 4y\label{P8-4}
            \end{alignat}
        ...
        \part
            ...
            \begin{align*}
                e^{\tfrac{\pi}2} &\approx 1 + 2\cdot\dfrac12 + 2\bp{\dfrac12}^2 + \dfrac83 \bp{\dfrac12}^3\\
                &= \dfrac{17}6
            \end{align*}
    ...
    \solution
        \part
            ...
            \begin{alignat}{2}
                &&-2\bp{y''\sin 2x + y'\cos 2x \cdot 2 } + \bp{y'' \cdot -\sin 2x \cdot 2 + y^{(3)} \cos 2x} &= -2y''\nonumber\\
        ...
        \part
            \begin{align*}
                ...
                &= -a \bp{ 1 - 2x + \dfrac12 (2x)^2 - \dfrac13 (2x)^3 + \ldots} + b\\
                &\approx -a \bp{ 1 - 2x + \dfrac12 (2x)^2 - \dfrac13 (2x)^3} + b\\
                &= -a \bp{ 1 - 2x + 2x^2 - \dfrac83 x^3} + b\\
                &= a \bp{-1 + 2x - 2x^2 + \dfrac83 x^3} + b\\
                &= a \bp{-1 + \dfrac12 \bp{f(x) - 1}} + b\\
    ...
    \solution
        \begin{alignat*}{2}
            &&13-59\sin x &= 10\bp{2 - \cos 2x}\\
            && &= 10\bp{2 - \bp{1-2\sin^2 x}}\\
            && &= 10 \bp{1 + 2\sin^2 x}\\
            && &= 10 + 20\sin^2 x \\
    ...
    \problem{}
        In triangle $ABC$, angle $A = \dfrac{\pi}3$ radians, angle $B = \bp{\dfrac{\pi}3 + x}$ radians and angle $C = \bp{\dfrac{\pi}3 - x}$ radians, where $x$ is small. The lengths of the sides $BC$, $CA$ and $AB$ are denoted by $a$, $b$ and $c$ respectively. Show that $b-c \approx \dfrac{2ax}{\sqrt{3}}$.
