...
\begin{document}
    ...
    \solution
        ...
        \part
            \begin{align*}
                \int_{-0.1}^{0.1} y \, dx &\approx \int_{-0.1}^{0.1} \left(1 - 2x + 4x^2 \right)\, dx\\
                &= \left.\left[x - 2 \cdot \dfrac12 x^2 + 4 \cdot \dfrac13 x^3\right]\right|_{-0.1}^{0.1}\\
                &= \dfrac{76}{275}
            \end{align*}

            \boxt{
                $\int_{-0.1}^{0.1} y \, dx \approx \dfrac{76}{275}$
            }
    ...
    \solution
        ...
        \part
            ...
            Since $\sec x$ is even, $\sec x$ only contributes even powers of $x$ to the power series expansion of $\dfrac{1-\sin x}{\cos x}$. Likewise, since $\tan x$ is odd, $\tan x$ only contribute odd powers of $x$ to the power series expansion of $\dfrac{1-\sin x}{\cos x}$.
