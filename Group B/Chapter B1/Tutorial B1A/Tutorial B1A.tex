            ...
            \begin{center}
                \begin{tikzpicture}[trim axis left, trim axis right]
                    \begin{axis}[
                        ...
                        \draw[dotted, thick] (-0.5, -10) -- (-0.5, 10) node[anchor=north east] {$x = -\dfrac12$};
                    \end{axis}
                \end{tikzpicture}
            \end{center}
            ...
            \begin{center}
                \begin{tikzpicture}[trim axis left, trim axis right]
                    \begin{axis}[
                        ...
                        \draw[dotted, thick] (9, 4.6) node[anchor=south east] {$y = \dfrac12 x + 1$};
                    \end{axis}
                \end{tikzpicture}
            \end{center}
            ...
            \begin{center}
                \begin{tikzpicture}[trim axis left, trim axis right]
                    \begin{axis}[
                        ...
                        \draw[dotted, thick] (0.5, -4) -- (0.5, 1) node[anchor=north west, fill=white, opacity = 0.6, text opacity=1] {$x = \dfrac12$};

                        \draw[dotted, thick] (-0.5, -1.5) -- (3, -1.5) node[anchor=south east, fill=white, opacity = 0.6, text opacity=1] {$y = -\dfrac32$};
                    \end{axis}
                \end{tikzpicture}
            \end{center}
