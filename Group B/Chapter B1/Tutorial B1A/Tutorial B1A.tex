...
\begin{document}
            ...
            \begin{center}
                \begin{tikzpicture}[trim axis left, trim axis right]
                    \begin{axis}[
                        ...
                        \fill (-1, -1.5) circle[radius=2.5 pt] node[anchor=north east, fill=white, opacity = 0.6, text opacity=1] {$\bp{-1, -\dfrac32}$};
                    \end{axis}
                \end{tikzpicture}
            \end{center}
            ...
            \begin{center}
                \begin{tikzpicture}[trim axis left, trim axis right]
                    \begin{axis}[
                        ...
                        \fill (2.094, 3.826) circle[radius=2.5 pt] node[anchor=south] {$\bp{\dfrac23 \pi, 3.83}$};

                        \fill (4.189, 2.457) circle[radius=2.5 pt] node[anchor=north] {$\bp{\dfrac43 \pi, 2.46}$};
                    \end{axis}
                \end{tikzpicture}
            \end{center}
            ...
            \begin{center}
                \begin{tikzpicture}[trim axis left, trim axis right]
                    \begin{axis}[
                        ...
                        \fill (1, 1/e) circle[radius=2.5 pt] node[anchor=south west] {$\bp{1, \dfrac1e}$};
                    \end{axis}
                \end{tikzpicture}
            \end{center}
            ...
            \begin{center}
                \begin{tikzpicture}[trim axis left, trim axis right]
                    \begin{axis}[
                        ...
                        \fill (0.707, 0.429) circle[radius=2.5 pt] node[anchor=west] {$\bp{\dfrac{1}{\sqrt{2}}, \dfrac1{\sqrt2e}}$};

                        \fill (-0.707, -0.429) circle[radius=2.5 pt] node[anchor=east] {$\bp{-\dfrac{1}{\sqrt{2}}, -\dfrac1{\sqrt2e}}$};
                    \end{axis}
                \end{tikzpicture}
            \end{center}
    ...
    \solution
        ...
        \part
            ...
            \boxt{$C$ meets the axes at $(0, -9)$ and $(9, 0)$.}
    ...
    \solution
        ...
        \part
            ...
            For all values that $y$ can take on, there exists a solution to $2x^2 + (3+y)x + 2y = 0$. Hence, $\D \geq 0$.
            ...
            \boxt{$\bc{y \in \R \colon y \leq 1 \lor y \geq 9}$}
    ...
    \solution
        \part
            As $x \to \pm \infty$, $y \to 0$. Hence, $y = 0$ is an asymptote. Observe that $x^2 - 5x + 4 = (x-1)(x-4)$. Hence, $x=1$ and $x=4$ are asymptotes.

            \boxt{Asymptotes: $y = 0$, $x=1$, $x=4$}
        ...
        \part
            ...
            We observe that if $k > 0$, $y=kx$ will intersect with $y = \dfrac{x}{x^2-5x+4}$ at least twice: before $x=1$ and after $x=4$. In order to have only one non-zero root, we must force the intersection point that comes before $x=1$ to be at the origin $(0, 0)$. Hence, $k$ is tangential to $C$ at $(0, 0)$, thus giving $k = \evalder{\der{C}{x}}{x=0}$.

            \[
                \begin{aligned}
                    k &= \evalder{\der{C}{x}}{x=0}\\
                    &= \evalder{\der{}{x}\dfrac{x}{x^2-5x+4}}{x=0} \\
                    &= \evalder{\dfrac{3x^2-10x+4}{(x^2-5x+4)^2}}{x=0} \\
                    &= \dfrac14
                \end{aligned}
            \]
