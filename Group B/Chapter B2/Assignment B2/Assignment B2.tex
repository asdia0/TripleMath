...
\title{Assignment B2\\Graphs and Transformations II}
\author{Eytan Chong}
\date{2024-03-18}
...
\begin{document}
    \problem{}
        ...
        \begin{enumerate}
            \item $y = f(-x)$
            \item $y = 3 - 2f(x)$
            \item $y = 3f(\dfrac{x}2 + 1)$
        \end{enumerate}

        \noindent showing in each case the coordinates of the points corresponding to $A$, $B$ and $C$.
    ...
    \problem{}
        ...
        The curve shown is the graph of $y = f(x)$. The $x$-axis is a tangent at the origin and at $(2, 0)$. The curve has two maximum points at $(-\dfrac34, 3)$ and $(1, 2)$. On two separate diagrams, sketch the graphs of the following equations. Show clearly the shapes of the graphs where they meet the $x$-axis and any asymptotes.
    ...
    \problem{}
        ...
        \begin{itemize}
            ...
            \item $B$: a scaling parallel to the $x$-axis by a factor $\dfrac12$
        \end{itemize}
    ...
    \solution
        \begin{alignat*}{2}
            ...
            &B \colon x \mapsto 2x &&\implies B^{-1} \colon x \mapsto \dfrac12 x\\
        \end{alignat*}

        \begin{center}
            \begin{tikzpicture}
                \node (F) {$y = 4x^2-4x+1$};
                \node[below of=F, yshift=-1cm] (B) {$y = 4\left(\dfrac12 x\right)^2-4\left(\dfrac12 x\right)+1$};
                \node[below of=B, yshift=-1cm] (A) {$y = 4\left(\dfrac12 (x+1)\right)^2-4\left(\dfrac12 (x+1)\right)+1$};
        ...
        \begin{alignat*}{2}
            &&y &= 4\left(\dfrac12 (x+1)\right)^2-4\left(\dfrac12 (x+1)\right)+1\\
            \implies&&y &= (x+1)^2-2(x+1)+1\\
            \implies&&y &= x^2 + 2x + 1 - 2x - 2 + 1\\
            \implies&&y &= x^2
        \end{alignat*}
