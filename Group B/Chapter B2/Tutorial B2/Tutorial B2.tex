...
\begin{document}
    ...
    \solution       
        ...
        \boxt{$y = \dfrac12 (x-2)^3 - 6$}

        When $x=0$, $y = \dfrac12 (-2)^3 - 6 = -10$. When $y = 0$, $x = 2 + \sqrt[3]{12}$.

        \boxt{The curve crosses the $x$-axis at $(2 + \sqrt[3]{12}, 0)$ and the $y$-axis at $(0, -10)$.}
    ...
    \solution
        ...
        \boxt{1. Translate the curve 2 units in the positive $x$-direction.\\
    ...
    \solution
        ...
        \boxt{The original curve has equation $y = \sqrt{x}$.}
    ...
    \solution
        \part
            ...
            \boxt{The axial intercepts of the curve are $(0, 2)$, $(0, -2)$ and $(-1, 0)$.}
        ...
        \part
            \boxt{Scale by a factor of $\dfrac12$ parallel to the $y$-axis.}
