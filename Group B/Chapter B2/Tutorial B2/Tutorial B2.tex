...
\title{Tutorial B2\\Graphs and Transformations II}
\author{Eytan Chong}
\date{2024-02-29}
...
\begin{document}
    \problem{}
        ...
        \begin{enumerate}
            ...
            \item $y=f(x+3)$
            \item $y = 1 - f(x)$
            \item $y = 3f\left(\dfrac{x}2 - 1\right)$
        \end{enumerate}

        \noindent stating, in each case, the coordinates of the points corresponding to $A$, $B$, $C$ and $D$.
            ...
            \begin{center}
                \begin{tikzpicture}[trim axis left, trim axis right]
                    \begin{axis}[
                        ...
                        \fill (1, 0) circle[radius = 2.5pt] node[anchor=north] {$B\left(\tfrac12, 0\right)$};

                        \fill (2,1) circle[radius = 2.5pt] node[anchor=south] {$C(1, 1)$};

                        \fill (3,0) circle[radius = 2.5pt] node[anchor=south west] {$D\left(\tfrac32, 0\right)$};
                    \end{axis}
                \end{tikzpicture}
            \end{center}
            ...
            \begin{center}
                \begin{tikzpicture}[trim axis left, trim axis right]
                    \begin{axis}[
                        ...
                        \addlegendentry{$y = 3f\left(\tfrac{x}{2} - 1\right)$};
    ...
    \problem{}
        ...
        \noindent (Assume constants $a > 0$, $c > 0$ and $b > 1$)
    ...
    \problem{}
        ...
        Sketch on separate diagrams the graphs of the following curves, labelling each curve clearly, indicating the horizontal asymptotes and showing the coordinates of the points corresponding to points $A$, $B$, $C$ and $D$.
        
        \begin{enumerate}
            \item $y = f(x+1)$
            \item $y = f\left(\dfrac{x}2\right)$
            \item $y = 2f(x) - 2$
        \end{enumerate}

        \noindent Find the number of solutions to the equation $f(x) = af(x)$ where $a \geq 2$.
            ...
            \begin{center}
                \begin{tikzpicture}[trim axis left, trim axis right]
                    \begin{axis}[
                        ...
                        \addlegendentry{$y = f\left(\tfrac{x}2\right)$};
    ...
    \solution       
        \begin{center}
            \begin{tikzpicture}
                \node (F) {$y = x^3$};
                \node[below of=F, yshift=-1cm] (A) {$y = (x-2)^3$};
                \node[below of=A, yshift=-1cm] (B) {$2y = (x-2)^3$};
                \node[below of=B, yshift=-1cm] (C) {$2(y+6) = (x-2)^3$};

                \draw[->] (F) -- node[anchor=west] {$x \mapsto x-2$} (A);
                \draw[->] (A) -- node[anchor=west] {$y \mapsto 2y$} (B);
                \draw[->] (B) -- node[anchor=west] {$y \mapsto y+6$} (C);
            \end{tikzpicture}
        \end{center}
        ...
        \boxt{
            The curve crosses the $x$-axis at $(2 + \sqrt[3]{12}, 0)$ and the $y$-axis at $(0, -10)$.
        }
    ...
    \solution
        ...
        \begin{center}
            \begin{tikzpicture}
                \node (F) {$y = \dfrac1{x^2}$};
                \node[below of=F, yshift=-1cm] (A) {$y = \dfrac1{(x-2)^2}$};
                \node[below of=A, yshift=-1cm] (B) {$y = \dfrac{4}{(x-2)^2}$};
                \node[below of=B, yshift=-1cm] (C) {$y = \dfrac{-4}{(x-2)^2}$};
                \node[below of=C, yshift=-1cm] (D) {$y = 1 + \dfrac{-4}{(x-2)^2}$};

                \draw[->] (F) -- node[anchor=west] {$x \mapsto x-2$} (A);
                \draw[->] (A) -- node[anchor=west] {$y \mapsto \dfrac14 y$} (B);
                \draw[->] (B) -- node[anchor=west] {$y \mapsto -y$} (C);
                \draw[->] (C) -- node[anchor=west] {$y \mapsto y-1$} (D);
            \end{tikzpicture}
        \end{center}

        \boxt{
            1. Translate the curve 2 units in the positive $x$-direction.\\
            2. Stretch the curve with a scale factor of 4 parallel to the $y$-axis.\\
            3. Reflect the curve about the $x$-axis.\\
            4. Translate the curve 1 unit in the positive $y$-direction.
        }          
    ...
    \problem{}
        ...
        \noindent A curve undergoes the transformations $A$, $B$, $C$ and $D$ in succession, and the equation of the resulting curve is $y = 3\sqrt{2-x} + 1$. Determine the equation of the curve before the transformations were effected.

    \solution
        \begin{alignat*}{2}
            &A \colon x \mapsto -x &&\implies A^{-1} \colon x \mapsto -x\\
            &B \colon x \mapsto x-2 &&\implies B^{-1} \colon x \mapsto x+2\\
            &C \colon y \mapsto \dfrac13 y &&\implies C^{-1} \colon y \mapsto 3y\\
        ...
        \boxt{
            The original curve has equation $y = \sqrt{x}$.
        }
    ...
    \problem{}
        A curve $C_1$ is defined by the parametric equations
    ...
    \solution
        \part
            ...
            \boxt{
                The axial intercepts of the curve are $(0, 2)$, $(0, -2)$ and $(-1, 0)$.
            }
        ...
        \part
            \boxt{
                Scale by a factor of $\dfrac12$ parallel to the $y$-axis.
            }
