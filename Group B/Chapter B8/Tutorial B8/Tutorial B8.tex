...
\begin{document}
    ...
    \solution
        ...
        \part
            ...
            \boxt{The solid has a volume of $\pi\left(16\sqrt{3} - \dfrac{45}2\right)$ units$^3$.}
    ...
    \solution
        ...
        \part
            ...
            \boxt{$V = \dfrac{3\pi}{n\left(4^{1/n} - 1\right)}$}
    ...
    \solution
        ...
        \part
            ...
            \boxt{The solid has a volume of $\left(\dfrac{4\pi^2}{3} - \sqrt{3}\pi\right)$ units$^3$.}
    ...
    \solution
        \begin{alignat*}{2}
            ...
            \implies&&r^5\left(\cos^5\t + \sin^5\t\right) &= 5br^4\cos^2\t\sin^2\t\\
        ...
        \end{center}
        \begin{align*}
            A &= \dfrac12 \int_0^{\pi/2} \left(\dfrac{5b\cos^2\t\sin^2\t}{\cos^5\t + \sin^5\t}\right)^2 \d \t\\
            &= \dfrac12 \int_0^{\pi/2} \dfrac{25b^2\cos^4\t\sin^4\t}{\left(\cos^5\t + \sin^5\t\right)^2} \d \t\\
            &= \dfrac{25b^2}2 \int_0^{\pi/2} \dfrac{\cos^4\t\sin^4\t}{\left(\cos^5\t + \sin^5\t\right)^2} \d \t\\
        \end{align*}
        \begin{alignat*}{2}
    ...
    \solution
        ...
        \boxt{The area of $R$ is $\dfrac14 \left(e^\pi + 1\right)$ units$^2$.}
