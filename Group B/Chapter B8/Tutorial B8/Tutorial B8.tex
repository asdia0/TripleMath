...
\begin{document}
    ...
    \solution
        ...
        \boxt{
            The area enclosed is $\dfrac\pi2$ units$^2$.
        }
    ...
    \solution
        ...
        \part
            Note that $x^2 + y^2 = 12 \implies x^2 = 12 - y^2$. Also note that when $x = 0$, $y = \sqrt{12}$.
            \begin{align*}
                \volume &= \pi\int_0^{\sqrt{12}} \left(\left(12 - y^2\right) - y\right) \d y\\
                &= \pi \eval{12 y - \dfrac13 y^3 - \dfrac12 y^2}{0}{\sqrt{12}}\\
                &= \pi \left(16 \sqrt{3} - 6\right)
            \end{align*}

            \boxt{
                The solid has a volume of $\pi\left(16\sqrt3 - 6\right)$ units$^3$.
            }
    ...
    \solution
        ...
        \boxt{
            The area of an ellipse is $\pi ab$ units$^2$.
        }
        ...
        \boxt{
            The volume of an allipse is $\dfrac{4\pi}3 ab^2$ units$^3$.
        }
        ...
        \begin{center}
            \begin{tikzpicture}[trim axis left, trim axis right]
                \begin{axis}[
                    ...
                    \addlegendentry{$r = \tfrac{5b\cos^2\theta\sin^2\theta}{\cos^5\theta + \sin^5\theta}$};
                \end{axis}
            \end{tikzpicture}
        \end{center}
        \begin{align*}
