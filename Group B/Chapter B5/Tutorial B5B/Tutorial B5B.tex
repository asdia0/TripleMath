...
\begin{document}
    ...
    \solution
        \part
            ...
            \begin{alignat*}{2}
                &&2(x+2y)\left(1 + 2y'\right) + 6(x-y)(1 - y') &= 0\\
                &&(x+2y)\left(1 + 2y'\right) + 3(x-y)(1 - y') &= 0\\
                \implies&& x + 2xy' + 2y + 4y\cdot y' + 3x - 3x\cdot y' - 3y + 3y\cdot y' &= 0\\
                \implies&& (-x + 7y)y' + 4x - y &= 0\\
                \implies&& y' &= \dfrac{y-4x}{7y-x}
            \end{alignat*}

        \part
            \subpart
                When the tangent to the curve is parallel to the $x$-axis, $y' = 0$.
    ...
    \solution
        ...
        \part
            ...
            \boxt{When $r = 50$, $\der{r}{t} = \dfrac3{200\pi}$}
        ...
        \part
            ...
            \boxt{The rate of increase of the surface area of the balloon when its radius is 50 cm is 6 cm/s.}
    ...
    \solution
        ...
        Since the normal is parallel to $y =x$, the tangent is perpendicular is perpendicular to $y=x$. Hence, the tangent is parallel to $y = -x$, whence $y' = -1$.
        ...
        Observe that for $-\dfrac12\pi < \t < \dfrac12\pi$, $x=5\sec\t \geq 5$. We thus reject $x = -\dfrac{25}4$. Hence, $x=\dfrac{25}4$, whence $y = -\dfrac{9}{25} \cdot \dfrac{25}4 = -\dfrac{9}4$. The coordinate of the required point is thus $\left(\dfrac{25}4, -\dfrac94\right)$.
        
        \boxt{$\bp{\dfrac{25}4, -\dfrac94}$}
    ...
    \solution
        ...
        \part
            ...
            \boxt{$Q(3p^2, 0)$, $R\left(0, \dfrac3p\right)$}
        ...
        \part
            ...
            \boxt{$y = \pm \left(\dfrac32\right)^{\tfrac32}  \dfrac1{\sqrt{x}}$}
    ...
    \solution
        ...
        Let $A(y)$ be the total area enclosed by the garden, in m$^2$. Observe that $A(y) = xy + \dfrac12 \pi \left(\dfrac{x}2\right)^2 = xy + \dfrac18 \pi x^2$. Also note that $x' = -\dfrac4{2 + 3\pi}$. Now, consider the stationary points of $A(y)$. For stationary points, $A'(y) = 0$.

        \begin{alignat*}{2}
            &&A'(y) &= 0\\
            \implies&&\left(x' y + x\right) + \dfrac18 \pi (2x \cdot x') &= 0\\
        ...
        \boxt{$x = \dfrac{120}{4+5\pi}$, $y = \dfrac{60 + 60\pi}{4 + 5\pi}$}
    ...
    \solution
        \part
            ...
            \boxt{$r = \sqrt[3]{\dfrac{3k}{5\pi}}$, $h = \sqrt[3]{\dfrac{3k}{5\pi}}$}
        ...
        \part
            ...
            Let $f(r) = \pi r^3 - 108r + 240$. Consider the stationary points of $f(r)$. For stationary points, $f'(r) = 0$.            
            \begin{alignat*}{2}
                &&f'(r) &= 0\\
    ...
    \solution
        \part
            ...
            \boxt{$y = \arctan \dfrac3x$}

        \part
            Observe that $\tan (y + \t) = \dfrac9x$. 

            \begin{alignat*}{2}
                &&\tan (y + \t) &= \dfrac9x\\
                \implies&&\dfrac{\tan y + \tan \t}{1 - \tan y \tan \t} &= \dfrac9x\\
                \implies&&\dfrac{\tfrac3x + \tan \t}{1 - \tfrac3x \tan \t} &= \dfrac9x\\
                \implies&&\dfrac{3 + x\tan \t}{x - 3\tan \t} &= \dfrac9x\\
                \implies&&x(3 + x\tan \t) &= 9(x - 3\tan \t)
            \end{alignat*}
            \begin{alignat*}{2}
                \implies&&3x + x^2\tan\t &= 9x - 27 \tan \t\\
                \implies&&x^2\tan\t + 27 \tan \t &= 6x \\
                \implies&&(x^2 + 27)\tan\t&= 6x\\
                \implies&&\tan\t &= \dfrac{6x}{x^2+27}
            \end{alignat*}
            ...
            Using the identity $\tan^2 \t + 1 = \sec^2\t$, we have $\sec^2\t = \left(\dfrac{6x}{x^2+27}\right)^2 + 1$.

            \begin{align*}
                \t' &= \dfrac{-6x^2 + 162}{(x^2+27)^2\left(\left(\dfrac{6x}{x^2+27}\right)^2 + 1\right)}\\
            ...
            \boxt{$\t=\dfrac{\pi}6$ is a maximum value.}
    ...
    \problem{}
        ...
        \begin{enumerate}
            ...
            \item Show that $h = 2\cos^2\t$. The volume of the cone is increasing at a rate of 6 unit$^3$/s when $h = \dfrac32$. Determine the rate of change of $\t$ at this instant, leaving your answer in an exact form.
        \end{enumerate}
    ...
    \solution
        ...
        \part
            ...
            \begin{alignat*}{2}
                &&2r &= 2h' - 2h\cdot h'\\
                \implies&&r &= h' - h\cdot h'\\
                && &= h' (1 - h)\\
                \implies&& h' &= \dfrac{r}{1 - h}
            \end{alignat*}
            ...
            \boxt{The maximum volume of the cone is $\dfrac{32}{81} \pi$ units$^3$.}

        \part
            From the diagram, we see that $\cos\t = \dfrac{h}{\sqrt{r^2 + h^2}}$.

            \begin{alignat*}{2}
                &&\cos\t &= \dfrac{h}{\sqrt{r^2 + h^2}}\\
                \implies&&\cos^2\t &= \dfrac{h^2}{r^2 + h^2}\\
                \implies&&2\cos^2\t &= \dfrac{2h^2}{r^2 + h^2}\\
            ...
            \begin{alignat*}{2}
                &&2\cos^2\t - 1 &= h - 1\\
                \implies&&\cos 2\t &= h-1\\
                \implies&&\cos^2 2\t &= (h-1)^2\\
                \implies&&\sin^2 2\t &= 1-(h-1)^2\\
                \implies&&\sin 2\t &= \pm \sqrt{1-(h-1)^2}
            \end{alignat*}

            Since $0 < \t < \dfrac{\pi}2$, we know $\sin 2\t > 0$. We thus take $\sin 2\t = \sqrt{1 - (h-1)^2}$.
            ...
            \begin{align*}
                ...
                &= \der{\t}h \cdot \der{h}r \cdot \left(\der{V}r\right)^{-1} \cdot \der{V}t\\
            ...
            \begin{align*}
                \left.\der{\t}t\right|_{h = \tfrac32} &= \dfrac3{\pi} \cdot \dfrac1{-2 \sqrt{1 - (\tfrac32-1)^2}} \cdot \dfrac1{\tfrac32(4-3\cdot\tfrac32)}  \cdot 6\\
    ...
    \problem{}
        ...
        \end{center}
         ...
         A hollow cone of semi-vertical angle $45^\circ$ is held with its axis vertical and vertex downwards. At the beginning of an experiment, it is follows with 390 cm$^3$ of liquid. The liquid runs out thorugh a small hole at the vertex at a constant rate of 2 cm$^3$/s. 
    ...
    \solution
        ...
        \boxt{The depth of the liquid is decreasing at a rate of 0.0680 cm/s 3 minutes after the start of the experiment.}
    ...
    \solution
        ...
        \part
            ...
            \boxt{The particle is travelling at a speed of $34.3$ m/s when $x = 10$.}
