...
\title{Assignment B5B\\Applications of Differentation}
\author{Eytan Chong}
\date{2024-04-11}
...
\begin{document}
    \problem{}
        ...
        \noindent The point $P$ on the curve has parameter $t = 2$. The normal at $P$ meets the curve again at the point $Q$.
    ...
    \solution
        ...
        \part
            ...
            \begin{align*}
                ...
                &= \left(-\dfrac3{t^2}\right)\cdot \dfrac13\\
                &= -\dfrac1{t^2}
            \end{align*}

            Hence, the tangent to the curve has gradient $-\dfrac1{t^2}$, whence the normal to the curve has gradient $\dfrac{-1}{-\tfrac1{t^2}} = t^2$. Thus, the normal to the curve at $P$ has gradient $2^2 = 4$. Note that $P$ has coordinates $\left(3 \cdot 2, \dfrac32\right) = \left(6, \dfrac32\right)$. Using the point-slope formula,
    ...
    \solution
        ...
        \boxt{
            $x = \dfrac{100}3$, $y = \dfrac{200}3 \pi$
        }
    ...
    \solution
        Let $A = x$ cm$^2$ be the cross-sectional area of the cylinder. Then $\der{A}{t} = \der{A}{x} \cdot\der{x}{t} = \der{x}{t}$, whence $\left.\der{A}{t}\right|_{x=5} = \left.\der{x}{t}\right|_{x=5} = 0.025$.

        \part
            Let $L = 20x$ cm be the length of the cylinder. Then $\der{L}{t} = \der{L}{x} \cdot \der{x}{t} = 20\cdot \der{x}{t}$. Hence, $\left.\der{L}{t}\right|_{x=5} = \left.\left(20\cdot\der{x}{t}\right)\right|_{x=5} = 20 \cdot 0.025 = 0.5$.

            \boxt{
                The length of the cylinder is increasing at a rate of 0.5 cm/s.
            }

        \part
            Let $V = AL = 20x^2$ cm$^3$ be the volume of the cylinder. Then $\der{V}{t} = \der{V}{x} \cdot \der{x}{t} = 40x \cdot \der{x}{t}$. Hence, $\left.\der{V}{t}\right|_{x=5}= \left.\left(40x\cdot\der{x}{t}\right)\right|_{x=5} = 40\cdot5\cdot0.025 = 5$.

            \boxt{
                The volume of the cylinder is increasing at a rate of 5 cm$^3$/s.
            }

        \part
            Let $R$ cm be the radius of the cylinder. Since $\pi R^2 = A = x$, we have $R = \sqrt{\dfrac{x}\pi}= \dfrac{\sqrt{x}}{\sqrt\pi}$. Hence, $\der{R}{t} = \der{R}{x} \cdot \der{x}{t} = \dfrac{1}{\sqrt\pi} \cdot \dfrac1{2\sqrt{x}} \cdot \der{x}{t}$. Thus, $\left.\der{R}{t}\right|_{x=5} = \left.\left(\dfrac{1}{\sqrt\pi} \cdot \dfrac1{2\sqrt{x}} \cdot \der{x}{t}\right)\right|_{x=5} = \dfrac{1}{\sqrt\pi} \cdot \dfrac1{2\sqrt{5}} \cdot 0.025 = 0.00315 \tosf{3}$.
            
            \boxt{
                The radius of the cylinder is increasing at a rate of 0.00315 cm/s.
            }
    ...
    \solution
        ...
        \begin{alignat*}{2}
            &&2^{-y} \cdot \ln 2 \cdot -y^\prime &= 1\\
            \implies&&x \cdot \ln 2 \cdot -y^\prime &= 1\\
            \implies&&y^\prime &= -\dfrac{1}{x \ln 2}
        \end{alignat*}
        ...
        \boxt{
            The tangent to $C$ at $A$ has equation $y = -\dfrac{x}{a\ln2} + \dfrac{1 - \ln a}{\ln2}$.
        }
        ...
        \boxt{
            $m \in \left(-\dfrac1{e\ln2}, 0\right)$
        }
