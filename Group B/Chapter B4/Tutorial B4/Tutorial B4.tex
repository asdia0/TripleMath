...
\begin{document}
    ...
    \solution
        ...
        \part
            \begin{align*}
                ...
                &= \dfrac{\bp{4-x^2} \cdot 2x - x^2 \cdot \frac12 \cdot -2x }{(4-x^2)^{\frac32}}\\
                &= \dfrac{\bp{4-x^2} \cdot 2x + x^3 }{(4-x^2)^{\frac32}}\\
                &= \dfrac{x \bp{8-x^2}}{(4-x^2)^{\frac32}}
            \end{align*}

            \boxt{$\der{}{x} \dfrac{x^2}{\sqrt{4-x^2}} = \dfrac{x \bp{8-x^2}}{(4-x^2)^{\frac32}}$}
    ...
    \solution
        \part
            \begin{align*}
                \der{}{x} \arccos \dfrac{x}{10} &= -\dfrac1{\sqrt{1-\bp{\frac{x}{10}}^2}} \cdot \dfrac{1}{10}\\
        ...
        \part
            \begin{align*}
                \der{}{x} \arctan \dfrac1{1-x} &= \dfrac1{1+\bp{\frac1{1-x}}^2} \cdot -\dfrac1{(1-x)^2} \cdot -1 \\
                &= \dfrac1{(1-x)^2\bp{1+\bp{\frac1{1-x}}^2}}\\
                &= \dfrac1{(1-x)^2+1}\\
            \end{align*}
    ...
    \solution
        ...
        \part
            ...
            \begin{alignat*}{2}
                ...
                \implies&&y'(\dfrac34 + \dfrac34) &= \dfrac34 \bp{-\dfrac1{\sqrt3}} - \dfrac12\\
