...
\title{Mathematics\\Weighted Assesment 1}
\author{Eytan Chong}
\date{2024-04-25}
...
\begin{document}
    ...
    \solution
            ...
            \begin{center}
                \begin{tikzpicture}[trim axis left, trim axis right]
                    \begin{axis}[
                        ...
                        \draw (2, -12) circle[radius=2.5pt] node[anchor=north] {$\coord2{-12}$};

                        \draw (2, 3) circle[radius=2.5pt] node[anchor=south] {$\coord2{3}$};
                    \end{axis}
                \end{tikzpicture}
            \end{center}
        ...
        \part
            \begin{alignat*}{2}
                ...
                \implies&&\left(t - \dfrac12\right)^2 &= 0\\
                \implies&&t &= \dfrac12
            \end{alignat*}
            When $t = \dfrac12$, we have that $x = \dfrac34$ and $y = \dfrac74$. Thus, $C$ and the line $8y-12x=5$ intersect at $\coord{\dfrac34}{\dfrac74}$.

            \boxt{
                $\coord{\dfrac34}{\dfrac74}$
            }
    ...
    \solution
        \part
            \begin{alignat*}{2}
                ...
                \implies&&\dfrac{4 + \left(x^2 - 2x - 3\right)}{(x-3)(x+1)} &\geq 0\\
            ...
            \end{alignat*}
            \noindent whence $x < 1$ or $x > 3$. Putting everything together, we have
    ...
    \problem{}
        ...
        \noindent The curve $C_2$ has equation
        \begin{equation*}
            \dfrac{(x-a)^2}{1^2} + \dfrac{(y-6)^2}{b^2} = 1
        \end{equation*}
        \noindent where $b > 0$. It is given that $C_1$ and $C_2$ have no points in common for all $a \in \mathbb{R}$.
        \begin{enumerate}
            \setcounter{enumi}{1}
    ...
    \solution
            ...
            \begin{center}
                \begin{tikzpicture}[trim axis left, trim axis right]
                    \begin{axis}[
                        ...
                        \fill (2, 10) circle[radius=2.5pt] node[anchor=west] {$\coord2{10}$};
                        ...
                        \fill (1, 6) circle[radius=2.5pt] node[anchor=west] {$\coord{a}6$};
        ...
        \part
            Observe that $C_2$ describes an ellipse with vertical radius $b$ and horizontal radius 1. Furthermore, the ellipse is centered at $\coord{a}6$. Since $C_1$ and $C_2$ have no points in common for all $a \in \mathbb{R}$, the maximum $y$-value of the ellipse corresponds to the $y$-value of the minimum point $\coord2{10}$ of $C_1$. Similarly, the minimum $y$-value of the ellipse corresponds to the $y$-value of the maximum point $\coord02$ of $C_1$. Thus, $2 < y < 10$, whence $b < \min \{\abs{6-2}, \abs{6-10} \} = 4$. Thus,
        ...
        \part
            ...
            \subpart
                ...
                Note that $\dom f = \ran {\inv f} = [0, 1)$. We thus take the positive root. Further note that $\ran f = \dom {\inv f} = (-\infty, 2]$.

                \boxt{
                    $\inv f : x \mapsto \dfrac{x - 2 + \sqrt{x^2 -12x + 20}}{4}, \, x \in \mathbb{R}, \, x \leq 2$
                }
\end{document}