...
\begin{document}
    ...
    \problem{}
        ...
        \begin{enumerate}
            ...
            \item With your answer in (d) as the initial approximate, use the Newton-Raphson method to obtain $\b$ correct to 3 decimal places. Your process should terminate when you have two sucessive iterates that are equal when rounded to 3 decimal places.
        \end{enumerate}
